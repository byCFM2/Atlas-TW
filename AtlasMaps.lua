...
AtlasMaps = {
	...
	WailingCaverns = {
		...
		Continent = BZ["Kalimdor"],
		{ BLUE.."A) "..L["Entrance"] },
		{ GREY.."1) "..BB["Disciple of Naralex"], NPC, 3678 },
	--	{ GREY..INDENT..L["Mysterious Wailing Caverns Chest"], OBJECT, 180055 },
		...
		{ GREY.."5) "..BB["Deviate Faerie Dragon"].." ("..L["Rare"]..")", NPC, 5912 },
		{ GREY.."6) "..BB["Zandara Windhoof"], NPC, 619681 },
		{ GREY.."7) "..BB["Lord Pythas"], NPC, 3670 },
		{ GREY.."8) "..BB["Skum"], NPC, 3674 },
		{ GREY.."9) "..BB["Vangros"], NPC, 61965 },
		{ GREY.."10) "..BB["Lord Serpentis"].." ("..L["Upper"]..")", NPC, 3673 },
		{ GREY.."11) "..BB["Verdan the Everliving"].." ("..L["Upper"]..")", NPC, 5775 },
		{ GREY.."12) "..BB["Mutanus the Devourer"], NPC, 3654 },
		{ GREY..INDENT..BB["Naralex"], NPC, 3679 },
		{ "" },
	...
	DireMaulEast = {
		...
		PlayerLimit = "5",
		Continent = BZ["Kalimdor"],
		{ ORNG..L["Key"]..": "..L["Brazier of Invocation"].." ("..L["Tier 0.5 Summon"]..")", ITEM, 22057 },
		{ BLUE.."A) "..L["Entrance"] },
		{ BLUE.."B) "..L["Entrance"] },
		{ BLUE.."C) "..L["Entrance"] },
		{ BLUE.."D) "..L["Exit"] },
	...
	BlackrockDepths = {
		...
		{ ORNG..L["Key"]..": "..L["Banner of Provocation"].." ("..L["Tier 0.5 Summon"]..")", ITEM, 21986 },
		{ BLUE.."A) "..L["Entrance"] },
	...
	BlackrockSpireUpper = {
		...
		{ GREY..INDENT..L["Trash Mobs"] },
		{ GREY..INDENT..L["Set: "]..BIS["Ironweave Battlesuit"] },
		{ GREY..INDENT..L["Set: "]..BIS["Dal'Rend's Arms"] },
	...
	ShadowfangKeep = {
		...
		{ GREY.."13) "..BB["Prelate Ironmane"], NPC, 61969 },
		{ "" },
		{ GREY..INDENT..L["Trash Mobs"] }
	},
	Stratholme = {
	...
	TheDeadmines = {
		...
		{ BLUE.."A) "..L["Entrance"] },
		{ BLUE.."B) "..L["Exit"] },
		{ GREY.."1) "..BB["Jared Voss"], NPC, -1},
		{ GREY.."2) "..BB["Rhahk'Zor"], NPC, 644 },
		{ GREY.."3) "..BB["Miner Johnson"].." ("..L["Rare"]..")", NPC, 3586 },
		{ GREY.."4) "..BB["Sneed"], NPC, 643 },
		{ GREY..INDENT..L["Sneed's Shredder"], NPC, 642 },
		{ GREY.."5) "..BB["Gilnid"], NPC, 1763 },
		{ GREY.."6) "..BB["Masterpiece Harvester"], NPC, -1},
		{ GREY.."7) "..BB["Mr. Smite"], NPC, 646 },
		{ GREY.."8) "..BB["Cookie"], NPC, 645 },
		{ GREY.."9) "..BB["Captain Greenskin"], NPC, 647 },
		{ GREY.."10) "..BB["Edwin VanCleef"], NPC, 639 },
		{ "" },
		{ GREY..INDENT..L["Trash Mobs"] },
...
-- Turtle WOW
	TheCrescentGrove = {
		ZoneName = { BZ["The Crescent Grove"], 3333 },
		Acronym = "CG",
		Location = { BZ["Ashenvale"], 331 },
		LevelRange = "32-38",
		MinLevel = "32",
		...
		Continent = BZ["Kalimdor"],
		{ BLUE.."A) "..L["Entrance"] },
		{ INDENT..GREY.."a) "..L["Kalanar's Strongbox"], OBJECT, 2010860 },
		{ GREY.."1) "..BB["Grovetender Engryss"], NPC, 92107 },
		{ GREY.."2) "..BB["Keeper Ranathos"],NPC, 92109 },
		{ GREY.."3) "..BB["High Priestess A'lathea"], NPC, 92108 },
		{ GREY.."4) "..BB["Fenektis the Deceiver"], NPC, 92109 },
		{ GREY.."5) "..BB["Master Raxxieth"], NPC, 92110 },
		{ GREY..INDENT..L["Trash Mobs"] },
	},
	KarazhanCrypt = {
		ZoneName = { BZ["Karazhan Crypt"], 3334 },
		Acronym = "KC",
		...
		{ BLUE.."A) "..L["Entrance"] },
		{ GREY.."1) "..BB["Marrowspike"], NPC, 91920 },
		{ GREY.."2) "..BB["Hivaxxis"], NPC, 91929 },
		{ GREY.."3) "..BB["Corpsemuncher"], NPC, 91917 },
		{ GREY.."4) "..BB["Guard Captain Gort"], NPC, 92935 },
		{ GREY.."5) "..BB["Archlich Enkhraz"], NPC, 91916 },
		{ GREY.."6) "..BB["Commander Andreon"], NPC, 91919 },
		{ GREY.."7) "..BB["Alarus"], NPC, 91928 },
		{ GREY.."8) ".."Half-Buried Treasure Chest", OBJECT, 379545 },
		{ GREY..INDENT..L["Trash Mobs"] },
	},
	GilneasCity = {
		...
		{ INDENT..GREY.."a) "..L["Dawnstone Plans"]},
		{ INDENT..GREY.."b) "..L["Manuscript of Hydromancy II"]},
		...
		{ GREY.."7) "..L["Harlow Family Chest"], OBJECT, 2020027 },
		{ GREY.."8) "..BB["Genn Greymane"], NPC, 61418 },
		{ GREY..INDENT..L["Trash Mobs"] },
		{ GREY..INDENT..L["Set: "]..L["Greymane Armor"] },
	},
	HateforgeQuarry = {
		ZoneName = { BZ["Hateforge Quarry"], 3335 },
		Acronym = "HQ",
		Location = { BZ["Burning Steppes"], 46 },
		LevelRange = "52-60",
		MinLevel = "48",
		PlayerLimit = "5",
		Continent = BZ["Eastern Kingdoms"],
		{ BLUE.."A) "..L["Entrance"] },
		{ GREY.."1) "..BB["High Foreman Bargul Blackhammer"], NPC, 60735 },
		{ GREY.."2) "..BB["Engineer Figgles"], NPC, 60736 },
		{ INDENT..GREY.."a) "..L["Hateforge Chemistry Documents"] },
		{ GREY.."3) "..BB["Corrosis"], NPC, 60829 },
		{ GREY.."4) "..BB["Hatereaver Annihilator"], NPC, 60734 },
		{ GREY.."5) "..BB["Hargesh Doomcaller"], NPC, 60737 },
		{ GREY..INDENT..L["Trash Mobs"] },
		{ "" },
		{ GREY..INDENT..L["Set: "]..L["Incendosaur Skin Armor"] },
	},
	StormwindVault = {
		ZoneName = { BZ["Stormwind Vault"], 3336 },
		Acronym = "SV",
		Location = { BZ["Stormwind City"], 1519 },
		LevelRange = "60",
		MinLevel = "58",
		...
		Continent = BZ["Eastern Kingdoms"],
		{ BLUE.."A) "..L["Entrance"] },
		{ GREY.."1) "..BB["Aszosh Grimflame"], NPC, 80853 },
		{ GREY.."2) "..BB["Tham'Grarr"],NPC, 80852 },
		{ GREY.."3) "..BB["Black Bride"], NPC, 80850 },
		{ GREY..INDENT..L["Tome of Arcane Intricacies and Magical Phenomenon IX"]},
	...
	CavernsOfTimeBlackMorass = {
		ZoneName = { BZ["Caverns of Time: Black Morass"], 3335 },
		Acronym = "BM",
	...
	LowerKarazhan = {
		...
		{ GREY..INDENT.."a) "..L["Engraved Golden Bracelet"] },
		{ GREY..INDENT.."b) "..L["Comfortable Pillow"] },
		{ GREY.."2) "..BB["Brood Queen Araxxna"], NPC, 61221 },
		{ GREY.."3) "..BB["Grizikil"], NPC, 61224 },
		{ GREY..INDENT.."c) "..L["Councilman Kyleson"] },
		{ GREY.."4) "..BB["Clawlord Howlfang"], NPC, 61223 },
		{ GREY.."5) "..BB["Lord Blackwald II"], NPC, 61222 },
		{ GREY..INDENT.."d) "..L["Lord Ebonlocke"] },
		{ GREY..INDENT.."e) "..L["Obsidian Rod"] },
		{ GREY..INDENT.."f) "..L["Duke Rothlen"] },
		{ GREY.."6) "..BB["Moroes"], NPC, 61226 },
		{ GREY..INDENT..L["Trash Mobs"] },
		{ GREY..INDENT..L["Lower Karazhan Halls Enchants"] },
	},
	EmeraldSanctum = {
		ZoneName = { BZ["Emerald Sanctum"], 3339 },
		Acronym = "ES",
		Location = { BZ["Hyjal"], 3339 },
		LevelRange = "60",
		MinLevel = "58",
		PlayerLimit = "40",
		Continent = BZ["Kalimdor"],
		...
		{ GREY.."3) "..L["Favor of Erennius (ES Hard Mode)"], OBJECT, 2020042 },
		{ "" },
		{ GREY..INDENT..L["Trash Mobs"] },
	},
	TowerofKarazhan = {
		ZoneName = { BZ["Tower of Karazhan"], 0 },
		Acronym = "K40, KARA40",
		Location = { BZ["Deadwind Pass"], ZONE, 41 },
		LevelRange = "60+",
		MinLevel = "60",
		...
		{ BLUE.."A) "..L["Entrance"] },
		{ BLUE.."B) "..L["Connection"] },
		{ GREY.."1) "..BB["Keeper Gnarlmoon"], NPC, 61939 },
		{ GREY.."2) "..BB["Ley-Watcher Incantagos"], NPC, 61946 },
		{ GREY.."3) "..BB["Anomalus"], NPC, 61951 },
		{ GREY.."4) "..BB["Echo of Medivh"], NPC, 61958 },
		{ GREY.."5) "..BB["King"].." (Chess fight)", NPC, 59812 },
		{ GREY.."6) "..BB["Sanv Tas'dal"], NPC, 59981 },
		{ GREY.."7) "..BB["Rupturan the Broken"], NPC, 59961 },
		{ GREY.."8) "..BB["Kruul"], NPC, 59991 },
		{ GREY.."9) "..BB["Mephistroth"], NPC, 93333 },
		{ "" },
		{ GREY..INDENT..L["Trash Mobs"] },
		{ GREY..INDENT..L["Tower of Karazhan Sets"] },
	},
	StormwroughtRuins = {
		ZoneName = { BZ["Stormwrought Ruins"], 0 },
		Acronym = "SR",
		Location = { BZ["Balor"], ZONE, 0 },
		LevelRange = "35-42",
		MinLevel = "28",
		PlayerLimit = "5",
		Continent = BZ["Eastern Kingdoms"],
	...
	Nerubian = {
		ZoneName = { BB["Nerubian Overseer"], NPC, 18728 },
		Acronym = "Spooder",
		...
		PlayerLimit = "--",
		Continent = BZ["Eastern Kingdoms"],
		{ GREY.."1) "..BB["Nerubian Overseer"], NPC, 18728 },
		{ "" },
		{ "" },
		{ "" },
		{ "" },
	...
	Reaver = {
		ZoneName = { BB["Dark Reaver of Karazhan"], NPC, 80936 },
		Acronym = "Reaver",
		Location = { BZ["Deadwind Pass"], ZONE, 41 },
		LevelRange = "--",
		MinLevel = "--",
		PlayerLimit = "--",
		Continent = BZ["Eastern Kingdoms"],
		{ GREY.."1) "..BB["Dark Reaver of Karazhan"], NPC, 80936 },
	},
	CowKing = {
		ZoneName = { BB["Moo"], NPC, 91799 },
		Acronym = "CowKing",
		Location = { BZ["Moomoo Grove"], ZONE, -1 },
		LevelRange = "60+",
		MinLevel = "--",
		PlayerLimit = "20+",
		Continent = BZ["Eastern Kingdoms"],
		{ GREY.."1) "..BB["Moo"], NPC, 91799 },
	},
	Concavius = {
		ZoneName = { "Concavius Voidwalker", NPC, 92213 },
		Acronym = "Concavius",
		...
		PlayerLimit = "20+",
		Continent = BZ["Kalimdor"],
		{ GREY.."1) "..BB["Concavius"], NPC, 92213 },
	},
	Ostarius = {
		ZoneName = { BB["Ostarius"], NPC, 80935 },
		Acronym = "Ostarius",
		Location = { BZ["Tanaris"], ZONE, 440 },
		LevelRange = "60+",
		MinLevel = "--",
		PlayerLimit = "40+",
		Continent = BZ["Kalimdor"],
		{ GREY.."1) "..BB["Ostarius"], NPC, 80935 },
	},
	Clackora = {
		ZoneName = { BB["Cla'ckora"], NPC, 59963 },
		Acronym = "Clackora",
		Location = { BZ["Azshara"], ZONE, 16 },
		LevelRange = "60+",
		MinLevel = "--",
		PlayerLimit = "40+",
		Continent = BZ["Eastern Kingdoms"],
		{ GREY.."1) "..BB["Cla'ckora"], NPC, 59963 },
	},
	RareMobs = {
		ZoneName = { "Rare Mobs", 0 },
		Location = { "Various locations", ZONE, 16 },
		LevelRange = "17-60+",
		{ GREY.."1) ".."Shade Mage".._RED.." 0.4k (17L) "..WHIT..BZ["Tirisfal Glades"]..ORNG.." [15, 68]", NPC, 61499 },
		{ GREY.."2) ".."Graypaw Alpha".._RED.." 0.7k (18L) "..WHIT..BZ["Tirisfal Glades"]..ORNG.." [27, 58]", NPC, 91990 },
		{ GREY.."3) ".."Earthcaller Rezengal".._RED.." 0.4k (18L) "..WHIT..BZ["Stonetalon Mountains"]..ORNG.." [74, 79]", NPC, 61504 },
		{ GREY.."4) ".."Blazespark".._RED.." 0.8k (24L) "..WHIT..BZ["Stonetalon Mountains"]..ORNG.." [21, 29]", NPC, 61503 },
		{ GREY.."5) ".."Witch Doctor Tan'zo".._RED.." 2k (35L) "..WHIT..BZ["Arathi Highlands"]..ORNG.." [44, 13]", NPC, 61502 },
		{ GREY.."6) ".."Dawnhowl".._RED.." 2k (40L) "..WHIT..BZ["Gilneas"]..ORNG.." [43, 23]", NPC, 61554 },
		{ GREY.."7) ".."Widow of the Woods".._RED.." 6k (40L) "..WHIT..BZ["Gilneas"]..ORNG.." [30, 50]", NPC, 61553 },
		{ GREY.."8) ".."Maltimor's Prototype".._RED.." 6k (43L) "..WHIT..BZ["Gilneas"]..ORNG.." [48, 57]", NPC, 61551 },
		{ GREY.."9) ".."Bonecruncher".._RED.." 2k (44L) "..WHIT..BZ["Gilneas"]..ORNG.." [54, 56]", NPC, 61555 },
		{ GREY.."10) ".."Duskskitterer".._RED.." 2k (44L) "..WHIT..BZ["Gilneas"]..ORNG.." [46, 78]", NPC, 61552 },
		{ GREY.."11) ".."Baron Perenolde".._RED.." 3k (45L) "..WHIT..BZ["Gilneas"]..ORNG.." [67, 80]", NPC, 61550 },
		{ GREY.."12) ".."Kin'Tozo".._RED.." 20k (45L) "..WHIT..BZ["Stranglethorn Vale"]..ORNG.." [27, 55]", NPC, 80269 },
		{ GREY.."13) ".."M-0L1Y".._RED.." 3k (47L) "..WHIT..BZ["Icepoint Rock"]..ORNG.." [54, 40]", NPC, 61498 },
		{ GREY.."14) ".."Grug'thok the Seer".._RED.." 15k (47L) "..WHIT..BZ["Feralas"]..ORNG.." [58, 71]", NPC, 49005 },
		{ GREY.."15) ".."Explorer Ashbeard".._RED.." 16k (49L) "..WHIT..BZ["Searing Gorge"]..ORNG.." [71, 18]", NPC, 49011 },
		{ GREY.."16) ".."Jal'akar".._RED.." 18k (50L) "..WHIT..BZ["The Hinterlands"]..ORNG.." [53, 34]", NPC, 49010 },
		{ GREY.."17) ".."Ripjaw".._RED.." 9k (51L) "..WHIT..BZ["Lapidis Isle"]..ORNG.." [55, 21]", NPC, 61515 },
		{ GREY.."18) ".."Ruk'thok the Pyromancer".._RED.." 3k (51L) "..WHIT..BZ["Lapidis Isle"]..ORNG.." [43, 29]", NPC, 61517 },
		{ GREY.."19) ".."Embereye".._RED.." 4k (51L) "..WHIT..BZ["Gillijim's Isle"]..ORNG.." [67, 69]", NPC, 61516 },
		{ GREY.."20) ".."Xalvic Blackclaw".._RED.." 19k (53L) "..WHIT..BZ["Felwood"]..ORNG.." [53, 29]", NPC, 49003 },
		{ GREY.."21) ".."Firstborn of Arugal".._RED.." 10k (55L) "..WHIT..BZ["Gilneas"]..ORNG.." [40, 37]", NPC, 61558 },
		{ GREY.."22) ".."Margon the Mighty".._RED.." 25k (55L) "..WHIT..BZ["Lapidis Isle"]..ORNG.." [30, 41]", NPC, 91839 },
		{ GREY.."23) ".."The Wandering Knight".._RED.." 22k (55L) "..WHIT..BZ["Western Plaguelands"]..ORNG.." [64, 74]", NPC, 49007 },
		{ GREY.."24) ".."Letashaz".._RED.." 25k (55L) "..WHIT..BZ["Gillijim's Isle"]..ORNG.." [29, 89]", NPC, 92163 },
		{ GREY.."25) ".."Aquitus".._RED.." 7k (56L) "..WHIT..BZ["Gillijim's Isle"]..ORNG.." [27, 70]", NPC, 61518 },
		{ GREY.."26) ".."Stoneshell".._RED.." 4k (56L) "..WHIT..BZ["Tel'Abim"]..ORNG.." [40, 47]", NPC, 61501 },
		{ GREY.."27) ".."Tarangos".._RED.." 23k (56L) "..WHIT..BZ["Azshara"]..ORNG.." [42, 80]", NPC, 49001 },
		{ GREY.."28) ".."Zareth Terrorblade".._RED.." 23k (57L) "..WHIT..BZ["Blasted Lands"]..ORNG.." [55, 59]", NPC, 49009 },
		{ GREY.."29) ".."Highvale Silverback".._RED.." 4k (58L) "..WHIT..BZ["Tel'Abim"]..ORNG.." [57, 48]", NPC, 61500 },
		{ GREY.."30) ".."Mallon The Moontouched".._RED.." 27k (58L) "..WHIT..BZ["Winterspring"]..ORNG.." [57, 61]", NPC, 49004 },
		{ GREY.."31) ".."Professor Lysander".._RED.." 9k (59L) "..WHIT..BZ["Western Plaguelands"]..ORNG.." [12, 50]", NPC, 61853 },
		{ GREY.."32) ".."Blademaster Kargron".._RED.." 28k (59L) "..WHIT..BZ["Burning Steppes"]..ORNG.." [45, 32]", NPC, 49002 },
		{ GREY.."33) ".."Azurebeak".._RED.." 20k (60L) "..WHIT..BZ["Hyjal"]..ORNG.." [23, 37]", NPC, 61488 },
		{ GREY.."34) ".."Barkskin Fisher".._RED.." 5k (60L) "..WHIT..BZ["Hyjal"]..ORNG.." [66, 53]", NPC, 61487 },
		{ GREY.."35) ".."Admiral Barean Westwind".._RED.." 141k (60L) "..WHIT..BZ["Eastern Plaguelands"]..ORNG.." [66, 42]", NPC, 60525 },
		{ GREY.."36) ".."Shadeflayer Goliath".._RED.." 17k (61L) "..WHIT..BZ["Hyjal"]..ORNG.." [10, 44]", NPC, 61533 },
		{ GREY.."37) ".."Crusader Larsarius".._RED.." 28k (61L) "..WHIT..BZ["Eastern Plaguelands"]..ORNG.." [47, 60]", NPC, 49008 },
	},
	...
	DLEast = {
		...
		{ BLUE.."C) "..BZ["Blood Ring"].." Arena"..", ".._RED..BZ["Stranglethorn Vale"], ZONE, 19, 33 },
		...
		{ GREY.."10) "..BZ["Hateforge Quarry"]..", ".._RED..BZ["Burning Steppes"], ZONE, 717, 1519 },
		{ GREY.."11) "..BZ["The Stockade"]..", ".._RED..BZ["Stormwind City"], ZONE, 717, 1519 },
		{ GREY..INDENT..BZ["Stormwind Vault"]..", ".._RED..BZ["Stormwind City"], ZONE, 717, 1519 },
		{ GREY.."12) "..BZ["The Deadmines"]..", ".._RED..BZ["Westfall"], ZONE, 1581, 40 },
		{ GREY.."13) "..BZ["Karazhan Crypt"]..", ".._RED..BZ["Deadwind Pass"], ZONE, 1581, 40 },
		{ GREY..INDENT..BZ["Lower Karazhan Halls"]..", ".._RED..BZ["Deadwind Pass"], ZONE, 1581, 40 },
		{ GREY..INDENT..BZ["Tower of Karazhan"]..", ".._RED..BZ["Deadwind Pass"], ZONE, 1581, 40 },
		{ GREY.."14) "..L["Sunken Temple"]..", ".._RED..BZ["Swamp of Sorrows"], ZONE, 1417, 8 },
		{ GREY.."15) "..BZ["Zul'Gurub"]..", ".._RED..BZ["Stranglethorn Vale"], ZONE, 19, 33 },
	...
	DLWest = {
		...
		{ BLUE.."B) ".."Sunnyglade Valley"..", ".._RED..L["Caverns of Time"], ZONE, 3277, 17, 331 },
		{ GREY.."1) "..BZ["Emerald Sanctum"]..", ".._RED..BZ["Hyjal"], ZONE, 719, 331 },
		{ GREY.."2) "..BZ["Blackfathom Deeps"]..", ".._RED..BZ["Ashenvale"], ZONE, 719, 331 },
		{ GREY.."3) "..BZ["The Crescent Grove"]..", ".._RED..BZ["Ashenvale"], ZONE, 719, 331 },
		{ GREY.."4) "..BZ["Ragefire Chasm"]..", ".._RED..BZ["Orgrimmar"], ZONE, 2437, 1637 },
		{ GREY.."5) "..BZ["Wailing Caverns"]..", ".._RED..BZ["The Barrens"], ZONE, 718, 17 },
		{ GREY.."6) "..BZ["Maraudon"]..", ".._RED..BZ["Desolace"], ZONE, 2100, 405 },
		{ GREY.."7) "..BZ["Dire Maul"]..", ".._RED..BZ["Feralas"], ZONE, 2557, 357 },
		{ GREY.."8) "..BZ["Razorfen Kraul"]..", ".._RED..BZ["The Barrens"], ZONE, 491, 17 },
		{ GREY.."9) "..BZ["Razorfen Downs"]..", ".._RED..BZ["The Barrens"], ZONE, 722, 17 },
		{ GREY.."10) "..BZ["Onyxia's Lair"]..", ".._RED..BZ["Dustwallow Marsh"], ZONE, 2159, 15 },
		{ GREY.."11) "..BZ["Zul'Farrak"]..", ".._RED..BZ["Tanaris"], ZONE, 978, 440 },
		{ GREY.."12) "..BZ["Black Morass"]..", ".._RED..L["Caverns of Time"], ZONE, 978, 440 },
		{ GREY.."13) "..BZ["Ruins of Ahn'Qiraj"]..", ".._RED..BZ["Silithus"], ZONE, 3429, 1377 },
	...
	FPAllianceEast = {
		...
		Location = { BZ["Eastern Kingdoms"] },
		{ GREY.."1) ".."Alah'Thalas"..", "..BLUE..BZ["Thalassian Highlands"], ZONE, 33 },
		{ GREY.."2) "..L["Light's Hope Chapel"]..", "..BLUE..BZ["Eastern Plaguelands"], ZONE, 139 },
		{ GREY.."3) "..L["Chillwind Point"]..", "..BLUE..BZ["Western Plaguelands"], ZONE, 28 },
		{ GREY.."4) "..L["Aerie Peak"]..", "..BLUE..BZ["The Hinterlands"], ZONE, 47 },
		{ GREY.."5) ".."Ravenshire"..", "..BLUE..BZ["Gilneas"], ZONE, 33 },
		{ GREY.."6) "..L["Southshore"]..", "..BLUE..BZ["Hillsbrad Foothills"], ZONE, 267 },
		{ GREY.."7) "..L["Refuge Pointe"]..", "..BLUE..BZ["Arathi Highlands"], ZONE, 45 },
		{ GREY.."8) "..L["Menethil Harbor"]..", "..BLUE..BZ["Wetlands"], ZONE, 11 },
		{ GREY.."9) ".."Dun Agrath"..", "..BLUE..BZ["Wetlands"], ZONE, 1 },
		{ GREY.."10) "..BZ["Ironforge"]..", "..BLUE..BZ["Dun Morogh"], ZONE, 1 },
		{ GREY..INDENT.."Ironforge Airfields"..", "..BLUE..BZ["Dun Morogh"], ZONE, 1 },
		{ GREY.."11) "..L["Thelsamar"]..", "..BLUE..BZ["Loch Modan"], ZONE, 38 },
		{ GREY.."12) "..L["Thorium Point"]..", "..BLUE..BZ["Searing Gorge"], ZONE, 51 },
		{ GREY.."13) "..L["Morgan's Vigil"]..", "..BLUE..BZ["Burning Steppes"], ZONE, 46 },
		{ GREY.."14) "..BZ["Stormwind City"]..", "..BLUE..BZ["Elwynn Forest"], ZONE, 12 },
		{ GREY.."15) "..L["Lakeshire"]..", "..BLUE..BZ["Redridge Mountains"], ZONE, 44 },
		{ GREY.."16) "..L["Sentinel Hill"]..", "..BLUE..BZ["Westfall"], ZONE, 40 },
		{ GREY.."17) "..L["Darkshire"]..", "..BLUE..BZ["Duskwood"], ZONE, 10 },
		{ GREY.."18) "..L["Nethergarde Keep"]..", "..BLUE..BZ["Blasted Lands"], ZONE, 4 },
		{ GREY.."19) "..BZ["Booty Bay"]..", "..BLUE..BZ["Stranglethorn Vale"], ZONE, 33 },
		{ GREY.."20) ".."Caelan's Rest"..", "..BLUE..BZ["Lapidis Isle"], ZONE, 33 },
	},
	FPAllianceWest = {
		...
		{ GREY.."6) ".."Nordanaar"..", "..BLUE..BZ["Hyjal"], ZONE, 440 },
		{ GREY.."7) "..L["Stonetalon Peak"]..", "..BLUE..BZ["Stonetalon Mountains"], ZONE, 406 },
		{ GREY.."8) "..L["Astranaar"]..", "..BLUE..BZ["Ashenvale"], ZONE, 331 },
		{ GREY.."9) "..L["Talrendis Point"]..", "..BLUE..BZ["Azshara"], ZONE, 16 },
		{ GREY.."10) "..L["Nijel's Point"]..", "..BLUE..BZ["Desolace"], ZONE, 405 },
		{ GREY.."11) ".."Bael Hardul"..", "..BLUE..BZ["Stonetalon Mountains"], ZONE, 440 },
		{ GREY.."12) "..L["Ratchet"]..", "..BLUE..BZ["The Barrens"], ZONE, 17 },
		{ GREY.."13) "..L["Theramore Isle"]..", "..BLUE..BZ["Dustwallow Marsh"], ZONE, 15 },
		{ GREY.."14) "..L["Feathermoon Stronghold"]..", "..BLUE..BZ["Feralas"], ZONE, 357 },
		{ GREY.."15) "..L["Thalanaar"]..", "..BLUE..BZ["Feralas"], ZONE, 357 },
		{ GREY.."16) "..L["Marshal's Refuge"]..", "..BLUE..BZ["Un'Goro Crater"], ZONE, 490 },
		{ GREY.."17) "..L["Cenarion Hold"]..", "..BLUE..BZ["Silithus"], ZONE, 1377 },
		{ GREY.."18) "..L["Gadgetzan"]..", "..BLUE..BZ["Tanaris"], ZONE, 440 },
		{ GREY.."19) ".."Tel Co. Basecamp"..", "..BLUE..BZ["Tel'Abim"], ZONE, 440 },
	},
	FPHordeEast = {
		...
		{ GREY.."7) ".."Stillward Church"..", ".._RED..BZ["Gilneas"], ZONE, 33 },
		{ GREY.."8) "..L["Thorium Point"]..", ".._RED..BZ["Searing Gorge"], ZONE, 51 },
		{ GREY.."9) "..L["Kargath"]..", ".._RED..BZ["Badlands"], ZONE, 3 },
		{ GREY.."10) "..L["Flame Crest"]..", ".._RED..BZ["Burning Steppes"], ZONE, 46 },
		{ GREY.."11) "..L["Stonard"]..", ".._RED..BZ["Swamp of Sorrows"], ZONE, 8 },
		{ GREY.."12) "..L["Grom'Gol Base Camp"]..", ".._RED..BZ["Stranglethorn Vale"], ZONE, 33 },
		{ GREY.."13) "..L["Booty Bay"]..", ".._RED..BZ["Stranglethorn Vale"], ZONE, 33 },
		{ GREY.."14) ".."Maul'ogg Refuge"..", ".._RED..BZ["Gillijim's Isle"], ZONE, 33 },
	},
	FPHordeWest = {
		...
		{ GREY.."3) ".."Nordanaar"..", ".._RED..BZ["Hyjal"], ZONE, 440 },
		{ GREY.."4) "..L["Bloodvenom Post"]..", ".._RED..BZ["Felwood"], ZONE, 361 },
		{ GREY.."5) "..L["Zoram'gar Outpost"]..", ".._RED..BZ["Ashenvale"], ZONE, 331 },
		{ GREY.."6) "..L["Valormok"]..", ".._RED..BZ["Azshara"], ZONE, 16 },
		{ GREY.."7) "..L["Splintertree Post"]..", ".._RED..BZ["Ashenvale"], ZONE, 331 },
		{ GREY.."8) "..BZ["Orgrimmar"]..", ".._RED..BZ["Durotar"], ZONE, 14 },
		{ GREY.."9) "..L["Sun Rock Retreat"]..", ".._RED..BZ["Stonetalon Mountains"], ZONE, 406 },
		{ GREY.."10) "..L["Crossroads"]..", ".._RED..BZ["The Barrens"], ZONE, 17 },
		{ GREY.."11) "..L["Ratchet"]..", ".._RED..BZ["The Barrens"], ZONE, 17 },
		{ GREY.."12) "..L["Shadowprey Village"]..", ".._RED..BZ["Desolace"], ZONE, 405 },
		{ GREY.."13) "..BZ["Thunder Bluff"]..", ".._RED..BZ["Mulgore"], ZONE, 215 },
		{ GREY.."14) "..L["Camp Taurajo"]..", ".._RED..BZ["The Barrens"], ZONE, 17 },
		{ GREY.."15) "..L["Brackenwall Village"]..", ".._RED..BZ["Dustwallow Marsh"], ZONE, 15 },
		{ GREY.."16) ".."Mudsprocket"..", ".._RED..BZ["Dustwallow Marsh"], ZONE, 440 },
		{ GREY.."17) "..L["Camp Mojache"]..", ".._RED..BZ["Feralas"], ZONE, 357 },
		{ GREY.."18) "..L["Freewind Post"]..", ".._RED..BZ["Thousand Needles"], ZONE, 400 },
		{ GREY.."19) "..L["Marshal's Refuge"]..", ".._RED..BZ["Un'Goro Crater"], ZONE, 490 },
		{ GREY.."20) "..L["Cenarion Hold"]..", ".._RED..BZ["Silithus"], ZONE, 1377 },
		{ GREY.."21) "..L["Gadgetzan"]..", ".._RED..BZ["Tanaris"], ZONE, 440 },
		{ GREY.."22) ".."Tel Co. Basecamp"..", ".._RED..BZ["Tel'Abim"], ZONE, 440 },
	},
	TransportRoutes = {
		ZoneName = { "Transport Routes"},
		Location = { "Azeroth"},
		{ GREY.."1) ".."Rut'Theran Village"..", "..BLUE..BZ["Teldrassil"], ZONE, 141 },
		{ GREY.."2) "..BZ["Auberdine"]..", "..BLUE..BZ["Darkshore"], ZONE, 618 },
		...
		{ GREY.."10) "..BZ["Undercity"]..", ".._RED..BZ["Tirisfal Glades"], ZONE, 17 },
