...
function AtlasLoot_FixText(text)
    ...
    text = gsub(text, "#p18#", BS["Survival"])
    text = gsub(text, "#p19#", BS["Garderning"])
    text = gsub(text, "#p20#", BS["Jewelcrafting"])
    ...
    text = gsub(text, "#m6#", BF["Horde"])
    text = gsub(text, "#m7#", BF["Alliance"])
	...
	text = gsub(text, "#m14#", L["(300)"])
	text = gsub(text, "#m15#", L["(295)"])
	text = gsub(text, "#m16#", L["(275)"])
	text = gsub(text, "#m17#", L["(265)"])
	text = gsub(text, "#m18#", L["(290)"])
	text = gsub(text, "#m19#", L["Set"])
	text = gsub(text, "#m20#", L["(285)"])
	text = gsub(text, "#m21#", L["16 Slot"])
	...
	text = gsub(text, "#m26#", L["(185)"])
	text = gsub(text, "#m27#", L["(160)"])
	text = gsub(text, "#m28#", L["(125)"])
	text = gsub(text, "#m29#", L["(200)"])
	text = gsub(text, "#m30#", L["(1)"])
	text = gsub(text, "#m31#", L["Reagent"])
	text = gsub(text, "#m32#", L["Binds when picked up"])
	text = gsub(text, "#m33#", L["Misc"])
	text = gsub(text, "#m34#", L["Use to purchase rewards"])
	text = gsub(text, "#m35#", L["Fireworks"])
	text = gsub(text, "#m36#", L["Used to summon boss"])
	text = gsub(text, "#m37#", L["24 Slot"])
	text = gsub(text, "#m38#", L["Coin"])
	text = gsub(text, "#m39#", L["Bijou"])
	text = gsub(text, "#m40#", L["Doll"])
	text = gsub(text, "#m41#", L["(250)"])
	text = gsub(text, "#m42#", L["Bag"])
	text = gsub(text, "#m43#", L["pickpocketed"])
	text = gsub(text, "#m44#", L["vendor"])
	text = gsub(text, "#m45#", L["Lunar Festival Fireworks Pack"])
	text = gsub(text, "#m46#", L["Gently Shaken Gift"])
	text = gsub(text, "#m47#", L["Lucky Red Envelope"])
	text = gsub(text, "#m48#", L["Smokywood Pastures Special Gift"])
    ...
    text = gsub(text, "#x7#", BB["Captain Greenskin"])
    ...
    text = gsub(text, "#x92#", BB["Baron Charr"])
    text = gsub(text, "#x93#", BB["Avalanchion"])
    ...
    text = gsub(text, "#x105#", BB["Marshal Magnus Greystone"])
    text = gsub(text, "#x106#", BB["Genn Greymane"])
    text = gsub(text, "#x107#", BB["High Foreman Bargul Blackhammer"])
	...
	text = gsub(text, "#craftbm2#", BIS["Towerforge Battlegear"])
	text = gsub(text, "#craftbm3#", BIS["Hateforge Armor"])
	text = gsub(text, "#craftbp3#", BIS["Steel Plate"])
	text = gsub(text, "#craftbp4#", BIS["Dreamsteel Armor"])
	text = gsub(text, "#craftbp5#", BIS["Rune-Etched Armor"])

	-- Tailoring Crafted Sets
	text = gsub(text, "#craftt1#", BIS["Augerer's Attire"])
	text = gsub(text, "#craftt2#", BIS["Shadoweave"])
	text = gsub(text, "#craftt3#", BIS["Diviner's Garments"])
	text = gsub(text, "#craftt4#", BIS["Pillager's Garb"])
	text = gsub(text, "#craftt7#", BIS["Mooncloth Regalia"])
	text = gsub(text, "#craftt5#", BIS["Bloodvine Garb"])
	text = gsub(text, "#craftt8#", BIS["Flarecore Regalia"])
	text = gsub(text, "#craftt6#", BIS["Dreamthread Regalia"])
    ...
    text = gsub(text, "#craftlwl7#", BIS["Grifter's Armor"])
    text = gsub(text, "#craftlwl8#", BIS["Primalist's Trappings"])
    text = gsub(text, "#craftlwl9#", BIS["Dreamhide Battlegarb"])
    text = gsub(text, "#craftlw20#", BIS["Convergence of the Elements"])
    ...
    text = gsub(text, "#oth_s25#", BIS["Greymane Armor"])
    text = gsub(text, "#oth_s26#", BIS["Incendosaur Skin Armor"])
