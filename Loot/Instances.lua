...
AtlasLoot_Data = {
	...
	ArgentDawn = {
		...
		{ id = 18182, "INV_Misc_Gem_Variety_02", "=q2=Chromatic Mantle of the Dawn", "=ds=#s3# #e11#" },
	},
	BroodOfNozdormu = {
		{},
		{ name = L["Path of the Conqueror"], icon = "INV_Jewelry_Ring_40" },
		{ 21201, disc = BF["Neutral"] },
		{ 21202, disc = BF["Friendly"] },
		{ 21203, disc = BF["Honored"] },
		{ 21204, disc = BF["Revered"] },
		{ 21205, disc = BF["Exalted"] },
		{},
		{ name = L["Path of the Invoker"], icon = "INV_Jewelry_Ring_40" },
		{ 21206, disc = BF["Neutral"] },
		{ 21207, disc = BF["Friendly"] },
		{ 21208, disc = BF["Honored"] },
		{ 21209, disc = BF["Revered"] },
		{ 21210, disc = BF["Exalted"] },
		{},
		{ name = L["Path of the Protector"], icon = "INV_Jewelry_Ring_40" },
		{ 21196, disc = BF["Neutral"] },
		{ 21197, disc = BF["Friendly"] },
		{ 21198, disc = BF["Honored"] },
		{ 21199, disc = BF["Revered"] },
		{ 21200, disc = BF["Exalted"] },
	},
	-- old
