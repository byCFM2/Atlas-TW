...
AtlasTW.InstanceData.LowerKarazhan = {
    ...
    Bosses = {
        ...
        },
        {
            id = "LKHTrash",
            name = L["Trash Mobs"],
            defaults = { dropRate = 0.15 },
            loot = {
                {id=51326, dropRate=0.3, container={61666}},
                {},
                {id=61254, dropRate=0.15},
                {id=61288, dropRate=0.15},
                {id=61280, dropRate=0.15},
                {id=61290, dropRate=0.15},
                {},
                {id=61295, dropRate=0.15},
                {id=61452, dropRate=0.15},
                {},
                {id=92002, dropRate=0.32, disc=L["Book"]..", "..BF["Alliance"]},
                {id=92004, dropRate=0.32, disc=L["Book"]..", "..BF["Horde"]},
                {},
                {},
                {},
                {id=8547, dropRate=0.03,container={8546}},
                {id=61177, dropRate=0.03,container={61181}},
                {id=61178, dropRate=0.03,container={61182}},
                {id=61180, dropRate=0.03},
            }
        },
        {
            id = "LKHEnchants",
