...
AtlasTW.MenuData.Factions = {
	...
	{ name = BF["Wintersaber Trainers"],  icon = "Interface\\Icons\\Ability_Mount_PinkTiger",         	   lootpage = "WintersaberTrainers",      Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Wildhammer Clan"],       icon = "Interface\\Icons\\Ability_Hunter_EagleEye",        	   lootpage = "WildhammerClan",        Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["The League of Arathor"], icon = "Interface\\Icons\\INV_Jewelry_Amulet_07",           	   lootpage = "ArathorDefilers",   Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Stormpike Guard"],       icon = "Interface\\Icons\\INV_Jewelry_StormPikeTrinket_01",  	   lootpage = "StormpikeFrostwolf",        Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BZ["Dalaran"],               icon = "Interface\\Icons\\Spell_Holy_MagicalSentry",        	   lootpage = "Dalaran",           Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Silvermoon Remnant"],    icon = "Interface\\Icons\\inv_misc_tournaments_symbol_bloodelf", lootpage = "SilvermoonRemnant",         	   Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Ironforge"],             icon = "Interface\\Icons\\Ability_Racial_Avatar",            	   lootpage = "Ironforge",         Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Darnassus"],             icon = "Interface\\Icons\\Ability_Racial_ShadowMeld",        	   lootpage = "Darnassus",         Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Stormwind"],             icon = "Interface\\Icons\\INV_BannerPVP_02",                     lootpage = "Stormwind",         Extra = Colors.BLUE2..BF["Alliance"] },
	{ name = BF["Gnomeregan Exiles"],     icon = "Interface\\Icons\\INV_Gizmo_02",                         lootpage = "GnomereganExiles",  Extra = Colors.BLUE2..BF["Alliance"] },
	...
	{ name = BF["Frostwolf Clan"],        icon = "Interface\\Icons\\INV_Jewelry_FrostwolfTrinket_01",      lootpage = "StormpikeFrostwolf",        Extra = Colors.RED..BF["Horde"] },
	{ name = BF["Darkspear Trolls"],      icon = "Interface\\Icons\\Racial_Troll_Berserk",                 lootpage = "DarkspearTrolls",   Extra = Colors.RED..BF["Horde"] },
	{ name = BF["Revantusk Trolls"],      icon = "Interface\\Icons\\INV_Misc_Head_Troll_01",               lootpage = "RevantuskTrolls",         Extra = Colors.RED..BF["Horde"] },
	{ name = BF["Durotar Labor Union"],   icon = "Interface\\Icons\\INV_Misc_Coin_01",                     lootpage = "DurotarLaborUnion", Extra = Colors.RED..BF["Horde"] },
	{ name = BF["Undercity"],             icon = "Interface\\Icons\\Spell_Shadow_RaiseDead",               lootpage = "Undercity",         Extra = Colors.RED..BF["Horde"] },
	{ name = BF["Orgrimmar"],             icon = "Interface\\Icons\\INV_BannerPVP_01",                     lootpage = "Orgrimmar",         Extra = Colors.RED..BF["Horde"] },
	{ name = BF["Thunder Bluff"],         icon = "Interface\\Icons\\INV_Misc_Foot_Centaur",                lootpage = "ThunderBluff",      Extra = Colors.RED..BF["Horde"] },
}
