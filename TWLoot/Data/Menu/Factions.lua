...
AtlasTW.MenuData.Factions = {
	...
	{ name = LF["Stormwind"],             icon = "Interface\\Icons\\INV_BannerPVP_02",                     lootpage = "Stormwind",         Extra = Colors.BLUE2..LF["Alliance"] }, --*15
	...
	{ name = LF["Draenei Exiles"],        icon = "Interface\\Icons\\INV_Offhand_Draenei_A_02",             lootpage = "DraeneiExiles",     Extra = LZ["Swamp of Sorrows"] }, --1.18.1
	...
	{ name = LZ["Thunder Bluff"],         icon = "Interface\\Icons\\INV_Misc_Foot_Centaur",                lootpage = "ThunderBluff",      Extra = Colors.RED..LF["Horde"] }, --*15
