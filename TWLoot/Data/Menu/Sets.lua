...
AtlasTW.MenuData.Sets = {
    { name = L["Pre 60 Sets"],                  icon = "Interface\\Icons\\INV_Sword_43",                 lootpage = "AtlasTWLootPRE60SetMenu" },
    ...
    { name = LZ["Timbermaw Hold"].." "..L["Sets"],  icon = "Interface\\Icons\\INV_Chest_Plate01",        lootpage = "TimbermawHoldSets" },
    ...
    { name = L["Tier 3 Sets"],                  icon = "Interface\\Icons\\INV_Chest_Plate02",            lootpage = "AtlasTWLootT3SetMenu" },
    {},
    { name = L["World Blues"],                  icon = "Interface\\Icons\\INV_Box_01",                   lootpage = "AtlasTWLootWorldBluesMenu" },
...
--- @return nil
--- @usage AtlasTWLootSetMenu()
---
function AtlasTWLootSetMenu()
...
--- @return nil
--- @usage AtlasTWLootWorldBluesMenu()
---
function AtlasTWLootWorldBluesMenu()
...
local function createClassSetMenu(class, color, icon)
    local menuData = {
        ...
        { name = color .. class .." ".. L["Tier 1 Sets"],            icon = icon, lootpage = "T1" .. class },
        ...
        { name = color .. class .." ".. LMD["Tower of Karazhan Sets"], icon = icon, lootpage = "T35" .. class },
    }
    return menuData
end
...
--- @return nil
--- @usage AtlasTWLootPriestSetMenu()
---
function AtlasTWLootPriestSetMenu()
...
--- @return nil
--- @usage AtlasTWLootMageSetMenu()
---
function AtlasTWLootMageSetMenu()
...
--- @return nil
--- @usage AtlasTWLootWarlockSetMenu()
---
function AtlasTWLootWarlockSetMenu()
...
--- @return nil
--- @usage AtlasTWLootRogueSetMenu()
---
function AtlasTWLootRogueSetMenu()
...
--- @return nil
--- @usage AtlasTWLootDruidSetMenu()
---
function AtlasTWLootDruidSetMenu()
...
--- @return nil
--- @usage AtlasTWLootHunterSetMenu()
---
function AtlasTWLootHunterSetMenu()
...
--- @return nil
--- @usage AtlasTWLootShamanSetMenu()
---
function AtlasTWLootShamanSetMenu()
...
--- @return nil
--- @usage AtlasTWLootPaladinSetMenu()
---
function AtlasTWLootPaladinSetMenu()
...
--- @return nil
--- @usage AtlasTWLootWarriorSetMenu()
---
function AtlasTWLootWarriorSetMenu()
...
AtlasTW.MenuData.Pre60Sets = {
    ...
    { name = LIS["Sacred Windhorn Attire"],       extra = "Windhorn Canyon",       icon = "Interface\\Icons\\INV_Shoulder_07",              lootpage = "SacredWindhorn" },
    { name = LIS["Dragonmaw Battlegarb"],         extra = "Dragonmaw Retreat",     icon = "Interface\\Icons\\INV_misc_bone_taurenskull_01", lootpage = "DragonmawBattlegarb" },
    { name = LIS["Chain of the Scarlet Crusade"], extra = "Scarlet Monastery",     icon = "Interface\\Icons\\INV_Gauntlets_19",             lootpage = "Scarlet" },
    { name = LIS["Stormreaver Attire"],           extra = "Stormwrought Ruins",    icon = "Interface\\Icons\\INV_Gauntlets_09",             lootpage = "Stormreaver" },
    { name = LIS["Greymane Armor"],               extra = "Gilneas City",          icon = "Interface\\Icons\\inv_helmet_02",                lootpage = "GreymaneArmor" },
    { name = LIS["Incendosaur Skin Armor"],       extra = "Hateforge Quarry",      icon = "Interface\\Icons\\INV_Shoulder_23",              lootpage = "IncendosaurSkinArmor" },
    ...
    { name = LIS["Arms of Thaurissan"],           Extra = L["Various Locations"],  icon = "Interface\\Icons\\spell_fire_flametounge",       lootpage = "ArmsofThaurissan" }, --MoltenCore and BRD
    {},
...
--- @return nil
--- @usage AtlasTWLootPRE60SetMenu()
---
function AtlasTWLootPRE60SetMenu()
...
AtlasTW.MenuData.ZGSet[23] = { name = L["Zul'Gurub Rings"], icon = "Interface\\Icons\\INV_Jewelry_Ring_46", lootpage =
"ZGRings" }
AtlasTW.MenuData.ZGSet[24] = { name = LIS["Primal Blessing"], icon = "Interface\\Icons\\INV_Weapon_Hand_01", lootpage =
"PrimalBlessing" }
AtlasTW.MenuData.ZGSet[25] = { name = LIS["The Twin Blades of Hakkari"], icon = "Interface\\Icons\\INV_Sword_55", lootpage =
"HakkariBlades" }
...
--- @return nil
--- @usage AtlasTWLootZGSetMenu()
---
function AtlasTWLootZGSetMenu()
...
--- @return nil
--- @usage AtlasTWLootAQ40SetMenu()
---
function AtlasTWLootAQ40SetMenu()
...
--- @return nil
--- @usage AtlasTWLootAQ20SetMenu()
---
function AtlasTWLootAQ20SetMenu()
...
--- @return nil
--- @usage AtlasTWLootT0SetMenu()
---
function AtlasTWLootT0SetMenu()
...
--- @return nil
--- @usage AtlasTWLootT1SetMenu()
---
function AtlasTWLootT1SetMenu()
...
--- @return nil
--- @usage AtlasTWLootT2SetMenu()
---
function AtlasTWLootT2SetMenu()
...
--- @return nil
--- @usage AtlasTWLootT3SetMenu()
---
function AtlasTWLootT3SetMenu()
