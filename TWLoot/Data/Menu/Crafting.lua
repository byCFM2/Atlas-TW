...
function AtlasTWLoot_AlchemyMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Alchemy"], AtlasTW.MenuData.Alchemy, L["Crafting"],
...
function AtlasTWLoot_SmithingMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Blacksmithing"], AtlasTW.MenuData.Smithing, L["Crafting"],
...
function AtlasTWLoot_EnchantingMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Enchanting"], AtlasTW.MenuData.Enchanting, L["Crafting"],
...
function AtlasTWLoot_EngineeringMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Engineering"], AtlasTW.MenuData.Engineering, L["Crafting"],
...
function AtlasTWLoot_LeatherworkingMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Leatherworking"], AtlasTW.MenuData.Leatherworking, L["Crafting"],
...
function AtlasTWLoot_TailoringMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Tailoring"], AtlasTW.MenuData.Tailoring, L["Crafting"],
...
function AtlasTWLoot_JewelcraftingMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Jewelcrafting"], AtlasTW.MenuData.Jewelcrafting, L["Crafting"],
...
function AtlasTWLoot_CookingMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Cooking"], AtlasTW.MenuData.Cooking, L["Crafting"],
...
function AtlasTWLoot_FirstAidMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["First Aid"], AtlasTW.MenuData.FirstAid, L["Crafting"],
...
function AtlasTWLoot_SkinningMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Skinning"], AtlasTW.MenuData.Skinning, L["Crafting"],
...
function AtlasTWLoot_FishingMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Fishing"], AtlasTW.MenuData.Fishing, L["Crafting"],
...
function AtlasTWLoot_HerbalismMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Herbalism"], AtlasTW.MenuData.Herbalism, L["Crafting"],
...
function AtlasTWLoot_SurvivalMenu()
    AtlasTW.LootBrowserUI.PrepMenu(LS["Survival"], AtlasTW.MenuData.Survival, L["Crafting"],
