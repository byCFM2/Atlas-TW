...
AtlasTWZoneSubstitutions = {
    ["The Temple of Atal'Hakkar"] = "Templo Submerso"
}
...
AtlasTW.Localization:RegisterNamespace("UI", "ptBR", {
    ...
    -- Instance Locations
    --************************************************
    ["Showing all instances_1"] = "Mostrando todas as instâncias_1",
    ["Showing all instances_2"] = "Mostrando todas as instâncias_2",
