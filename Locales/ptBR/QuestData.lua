...
kQuestInstanceData.TheDeadmines.Alliance[4] = {
    ...
    Note = "A missão prévia pode ser obtida de Gnoarn (Dun Morogh - Fábrica da Reclamação de Gnomeregan " ..
        yellow .. "24.5,30.4" .. white .. ").\nA Detonadora de Sneed dropa o Sprecklesprocket " .. yellow ..
        "[3]" .. white .. ".",
...
kQuestInstanceData.TheDeadmines.Alliance[6] = {
    ...
    Note = red ..
        "Apenas Paladino" .. white ..
        ": Para ver a nota clique em " .. yellow .. "[Informações de O Teste da Justiça]" .. white .. ".",
...
kQuestInstanceData.TheDeadmines.Alliance[9] = {
    ...
    Location = "Maltimor Ladogarda (Cerro Oeste - ao norte da Pedreira Costa Dourada " .. yellow ..
        "31.3,37.6" .. white .. ")",
...
kQuestInstanceData.RagefireChasm.Horde[3] = {
    ...
    Note = "Você encontra Mauren Temível Totem em " ..
        yellow .. "[1]" ..
        white .. ". Depois de pegar a mochila, você deve levá-la de volta para Rahauro em Penhasco do Trovão",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "A Câmara Oculta está em " ..
        ...
        "[3]" ..
        white ..
        " e o Medalhão de Gni'kiv do Baú de Baelog " ..
        yellow ..
        "[1]" ..
        white ..
...
kQuestInstanceData.BlackrockDepths.Alliance[4] = {
    ...
    Note = "Você pega a missão prévia de Elomara Cervaforte (Barreira do Inferno - Fortaleza de Nethergarde " ..
        ...
        "61,18" ..
        white ..
        ").\nVocê pega a receita de um dos guardas que aparecem se você destruir a cerveja " .. yellow .. "[15]" ..
        white .. ".",
...
kQuestInstanceData.BlackrockDepths.Horde[7] = {
    ...
    Note = "Você encontra os anões perto de Bael'gar " ..
        ...
        "5,47" ..
        white ..
        ").\nA missão seguinte começa com Lexlort (Ermos - Kargath " ..
        yellow ..
        "5,47" ..
        white ..
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "Você pega a missão prévia de Coração Trovejante (Ermos - Kargath " ..
        ...
        "[3]" ..
        white ..
        ". A chave para abrir a prisão dropa de Suprema Interrogadora Gerstahn " ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[8] = {
    ...
    Note = "Você encontra Senhor da Guerra Voone em " ..
        ...
        "[9]" ..
        white ..
        ", Grão-lorde Omokk em " .. yellow .. "[5]" .. white .. " e Lorde Supremo Wyrmthalak em " ..
        yellow .. "[19]" .. white .. ".",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "Você pega a Gema de Spirestone de Grão-lorde Omokk em " ..
        ...
        "[9]" ..
        white ..
        " e a Gema de Bloodaxe de Lorde Supremo Wyrmthalak em " ..
        yellow ..
        "[19]" ..
        white ..
...
kQuestInstanceData.BlackrockSpireLower.Horde[10] = {
    ...
    Note = "Missão prévia de Onyxia.\nVocê encontra Grão-lorde Omokk em " ..
        ...
        "[5]" ..
        white ..
        ", Senhor da Guerra Voone em " ..
        yellow ..
        "[9]" ..
        white ..
        " e Lorde Supremo Wyrmthalak em " ..
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[3] = {
    ...
    Folgequest = "Coleta de Ovos -> Leonid Bartalomeu -> O Gambito do Amanhecer (" .. yellow .. "Scholomance" ..
        white .. ")",
}
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[12] = {
    ...
    Location = "Parnabus <Mago Errante> (Gilneas " ..
        yellow .. "[22.9,74.4]" .. white ..
        ", muito ao sul da Cidade de Gilneas, oeste do rio. dentro de uma casa solitária).",
    Note =
...
kQuestInstanceData.BlackrockSpireUpper.Horde[5] = {
    ...
    Location = "Umbramante Vivian Latumba (Ermos - Kargath " .. yellow .. "2,47" .. white .. ")",
    Note = "Você pega a missão prévia de Boticária Zilda na Cidade Baixa - O Apotecário (" ..
        yellow .. "50,68" .. white .. ").\n\nA Tabuleta de Pedra Sombria está em " .. yellow .. "[3]" .. white ..
        " em um baú.",
...
kQuestInstanceData.BlackrockSpireUpper.Horde[8] = {
    ...
    Note = "Última parte da missão prévia de Onyxia. Você encontra General Drakkisath em " .. yellow .. "[9]" ..
        white .. ".",
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillin está em Gládio Cruel " ..
        ...
        "[1]" ..
        white ..
        ". Ele corre quando você fala com ele, mas para e luta em " ..
...
kQuestInstanceData.DireMaulEast.Alliance[2] = {
    ...
    Note = "Letendris está em Gládio Cruel " ..
        ...
        " em " ..
        yellow .. "[3]" .. white ..
        ". A missão prévia vem de Mensageiro Desçomalho em Altaforja. Ele percorre toda a cidade.",
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "Você encontra Aliz, a Metamorfa nos " ..
        ...
        "[5]" ..
        white ..
        ". A relíquia está em Silithus em " .. yellow .. "62,54" .. white ..
        ". A missão prévia vem de Ravina Saturna também.",
...
kQuestInstanceData.DireMaulWest.Alliance[2] = {
    ...
    Note = "Os Pilões estão marcados como " ..
        blue ..
        "[B]" ..
        white .. ". Immol'thar está em " .. yellow .. "[6]" .. white ..
...
kQuestInstanceData.DireMaulWest.Alliance[5] = {
    ...
    Note = red ..
        "Apenas Druida" .. white .. ": Você entrega o livro para Erudito Javon na " .. yellow .. "Biblioteca 1'" ..
        white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[6] = {
    ...
    Note = red ..
        "Apenas Caçador" .. white .. ": Você entrega o livro para Erudita Mykos na " .. yellow .. "Biblioteca 1'" ..
        white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[7] = {
    ...
    Note = red ..
        "Apenas Mago" .. white .. ": Você entrega o livro para Erudito Kildrath na " .. yellow .. "Biblioteca 1'" ..
        white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[8] = {
    ...
    Note = red ..
        "Apenas Paladino" .. white .. ": Você entrega o livro para Erudita Mykos na " .. yellow ..
        "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[9] = {
    ...
    Note = red ..
        "Apenas Sacerdote" .. white .. ": Você entrega o livro para Erudito Javon na " .. yellow ..
        "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[10] = {
    ...
    Note = red ..
        "Apenas Ladino" .. white .. ": Você entrega o livro para Erudito Kildrath na " .. yellow ..
        "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[13] = {
    ...
    Note = red ..
        "Apenas Guerreiro" .. white ..
        ": Você entrega o livro para Erudito Kildrath na " .. yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note =
        ...
        yellow ..
        "[5]" .. white .. ". Celebras está em " .. yellow .. "[7]" ..
...
kQuestInstanceData.Maraudon.Alliance[8] = {
    ...
    Note = "O Fantasma de Zaetar aparece após matar Princesa Theradras " ..
        yellow ..
        "[11]" ..
        white .. ". Você encontra Guardião Remulos em (Clareira da Lua - Santuário de Remulos " ..
        yellow .. "36,41" .. white .. ").",
...
kQuestInstanceData.Maraudon.Alliance[11] = {
    ...
    Note = red ..
        "Apenas Joalheria." ..
        white .. " Sequência de missões para especialização em Gemologista.\nSoterrador está em " ..
        yellow .. "[8]" .. white .. ".",
...
kQuestInstanceData.MoltenCore.Alliance[2] = {
    ...
    Location = "Duque Hidráxis (Azshara " .. yellow .. "79,73" .. white .. ")",
    Note = "Lúcifron está em " ..
        yellow ..
        "[2]" .. white .. ", Sulfuron está em " .. yellow .. "[8]" ..
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[1] = {
    ...
    Note =
        ...
        white ..
        ", Herodes em " ..
        yellow .. "SM: Armaria [1]" .. white .. " e Mestre de Matilha Lobato em " .. yellow ..
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[3] = {
    ...
    Note = red ..
        "Apenas Mago" ..
        white .. ": Você pode encontrar o livro no último corredor que leva ao Arcanista Doan (" ..
        yellow .. "[2]" .. white .. ").",
...
kQuestInstanceData.ScarletMonasteryCathedral.Alliance[2] = {
    ...
    Location = "Paladino da Vigia Janathos (Pântano das Mágoas - Fortaleza Sorrowguard " .. yellow .. "2,51" ..
        white .. ")",
    Note =
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Location = "Weldon Barov (Terras Pestilentas Ocidentais - Acampamento de Ventogelado " .. yellow ..
        "43,83" .. white .. ")",
    Note = "Você pode encontrar O Título de Caer Darrow em " ..
        yellow ..
        "[12]" ..
        white ..
        ", O Título de Brill em " ..
        yellow ..
        "[7]" ..
        white ..
        ", O Título de Moinho Tarren em " ..
...
kQuestInstanceData.Scholomance.Alliance[9] = {
    ...
    Note = red .. "Apenas Bruxo" .. white .. ": Você encontra o laboratório de alquimia em " .. yellow ..
        "[7]" .. white .. ".",
...
kQuestInstanceData.ShadowfangKeep.Horde[1] = {
    ...
    Note = "Você encontra Sicário Admeto em " ..
        yellow ..
        "[1]" .. white .. ". Sicário Vicente está no lado direito quando você entra no pátio em " ..
        yellow .. "[2]" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Note = "Você pega a missão prévia de Magistrado Marduque (Terras Pestilentas Ocidentais - Caer Darrow " ..
        ...
        "70,73" ..
        white ..
        "). Você encontra a placa perto de " ..
        yellow .. "[19]" .. white .. ". Veja também: " .. yellow .. "[O Lich, Ras Friomúrmuro]" .. white ..
        " em Scolomântia.",
...
kQuestInstanceData.Stratholme.Alliance[8] = {
    ...
    Note =
        ...
        yellow .. "[19]" ..
        white .. ". Depois de matar o Barão você deve falar com Aurius novamente para pegar as Recompensas.",
    Rewards = {
        Text = "Recompensa: Escolha um",
...
kQuestInstanceData.Stratholme.Alliance[21] = {
    ...
    Note = "Segunda Pena de Medivh no chão no lugar onde Ancião Murmulonge (Festival Lunar) " ..
        ...
        "[Cidade Baixa]" ..
        white ..
        " atrás do trono da entrada.\nTerceira Pena de Medivh " ..
        yellow ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[3] = {
    ...
    Note = red ..
        ...
        yellow .. "[1] Biblioteca" .. white .. "). Fragmento de Obsidiana Perfeito dropa de " .. yellow .. "[3]" ..
        white .. ".",
...
kQuestInstanceData.TheSunkenTemple.Alliance[13] = {
    ...
    Note = red ..
        ...
        ": Morphaz está em " ..
        yellow ..
        "[5]" .. white .. ". Greta Musgo no Casco está em Selva Maleva - Santuário Esmeralda (" ..
        yellow .. "51,82" .. white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Note = "Tecelão " ..
        ...
        "[4]" ..
        white ..
        ". A barreira para o Profeta desaparecerá após limpar 6 sacadas " ..
        blue ..
        "[C]" ..
        white ..
...
kQuestInstanceData.TheTempleofAhnQiraj.Alliance[1] = {
    ...
    Note = "Celestrasz (Templo de Ahn'qiraj " .. yellow ..
...
kQuestInstanceData.ZulFarrak.Alliance[1] = {
    ...
    Location = "Tádius Sombraustera (A Barreira do Inferno - Fortaleza de Nethergarde " .. yellow .. "66,19" ..
        white .. ")",
    Note = "A Sequência de Missões começa com Mestre de Grifos Garra-de-acha (Terras Agrestes - Fortaleza Martelo Feroz " ..
        yellow ..
        "9,44" ..
        white ..
        ").\nNekrum aparece em " .. yellow .. "[4]" .. white ..
        " com a multidão final que você luta para o evento do Templo.",
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Note = "Você pega a missão prévia de Gaxim Deuxabu (Cordilheira das Torres de Pedra " ..
        ...
        yellow ..
        "[3] no Mapa de Entrada" ..
        white ..
        ". O 3005-B está em " ..
        yellow .. "[3]" .. white .. ", o 3005-C em " ..
        yellow .. "[5]" .. white .. " e o 3005-D está em " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[5] = {
    ...
    Note = "Os suprimentos podem ser encontrados na Mina Dentegelo em (Vale Alterac - Sul " .. yellow ..
        "[6]" .. white .. ").",
}
...
kQuestInstanceData.HateforgeQuarry.Horde[5] = {
    ...
    Note = "Mate Engenheiro Figgles " .. yellow .. "[2]" ..
        white .. " na Pedreira Forja do Ódio para Worg Senhora Katalla.",
...
kQuestInstanceData.GilneasCity.Alliance[6] = {
    ...
    Note =
        ...
        yellow ..
        "58.4,67.8" ..
        white .. ")\nA Coroa Greymane dropa de Genn Greymane " .. yellow .. "[8]" ..
        white .. ", último chefe no topo da torre.",
    Prequest =
...
kQuestInstanceData.GilneasCity.Horde[6] = {
    ...
    Note =
        ...
        yellow .. "[8]" .. white .. "\nVocê receberá a recompensa ao terminar a próxima missão.",
    Prequest = "Através da Magia Maior -> O Cetro Ravenwood -> Os poderes além" .. yellow ..
        "[Currais Ázegos]" .. white .. ".",
...
kQuestInstanceData.LowerKarazhan.Alliance[4] = {
    ...
    Attain = 55,
    Location = "O Cozinheiro perto de (" .. yellow .. "[Salões Inferiores de Karazhan - e]" .. white .. ")",
    Note = "Entregue o Vinho Espectral para Conselheiro Kyleson " .. yellow .. "[Karazhan - c]" .. white ..
        " em Karazhan.",
...
kQuestInstanceData.LowerKarazhan.Alliance[8] = {
    ...
    Note = "Entregue a missão para Duque Rothlen " ..
        yellow .. "[Karazhan - f]" .. white ..
        " na varanda ao lado de Senhor das Garras Howlfang " .. yellow .. "[4]" .. white .. ".",
...
kQuestInstanceData.LowerKarazhan.Horde[18] = createInheritedQuest(
    kQuestInstanceData.LowerKarazhan.Alliance[18],
    {
        ...
        Aim =
        "Colete sangue de worgen para Magatha Grimtotem. Ela exige amostras de sangue de Karazhan, Gilneas City e Shadowfang Keep.",
        Location = "Magatha Temível Totem (Penhasco do Trovão - O Elevado dos Anciãos " .. yellow .. "70,31" ..
            white .. ").",
    }
)
...
kQuestInstanceData.TowerofKarazhan.Alliance[1] = {
    ...
    Location = "Anelace, a Clarividente (Trilha do Vento Morto - Sepultura de Morgan " .. yellow ..
        "41.2,79.2" .. white .. ")",
...
kQuestInstanceData.DragonmawRetreat.Alliance[1] = {
    ...
    Note = "Pedestal perto de " ..
        ...
        "[5]" ..
        white ..
        "\n'Fragmento de Algoron' dropa de " .. yellow ..
...
kQuestInstanceData.DragonmawRetreat.Alliance[6] = {
    ...
    Location = "Carta de Korlag Cantofúnebre (Retiro Presa do Dragão - Zuluhed o Insano " .. yellow .. "[10]" ..
        white .. ")",
...
kQuestInstanceData.StormwroughtRuins.Alliance[9] = {
    ...
    Location = "Espada de Brinquedo Gravada (Restos dos Inocentes - Santuário de Sangue " .. yellow .. "[12]" ..
        white .. ")",
