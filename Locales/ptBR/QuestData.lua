...
kQuestInstanceData.RazorfenKraul.Horde[4] = {
    ...
    Location = "Auld Agulha de Pedra (Thunderbluff "..yellow.."36,59"..white..")",
...
kQuestInstanceData.RazorfenKraul.Horde[6] = {
    ...
    Level = 30,
    Attain = 20,
    Aim = "Destrua a encarnação viva da corrupção natural nas profundezas de Razorfen Kraul e traga o Coração de Espinhos Corrompido para Kym Wildmane em Thunderbluff.",
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[3] = {
    ...
    Location = "Sábio Devoto da Verdade (Thunderbluff "..yellow.."34,47"..white..")",
