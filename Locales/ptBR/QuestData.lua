...
kQuestInstanceData.WailingCaverns.Horde[8] = {
    ...
    Note = red .. "Apenas MAGO." .. white .. " A sequência de missões começa com Ureda <Treinador de Mago> (Orgrimmar) com a missão 'Dominando o Arcano'.\nMadeira Tocada pela Lua você consegue de " .. yellow .. "trash" .. white .. ", um Cristal da Serpente de Lorde Serpentis <Senhor da Presa>" .. yellow .. "[7]" .. white .. ", e uma Essência Mutável de Lorde Pítias <Senhor da Presa> " ..
        yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "A Câmara Oculta está em " .. yellow .. "[4]" .. white .. ". Para abrir a Câmara Oculta você precisa O Eixo de Tsol de Revelosh " .. yellow .. "[3]" .. white .. " e o Medalhão de Gni'kiv do Baú de Baelog " .. yellow .. "[1]" .. white ..
        ". Combine esses dois itens para formar o Cajado de Prehistória. O Cajado é usado na Sala de Mapas entre " .. yellow .. "[3] e [4]" .. white .. " para invocar Ferronaya. Depois de matá-la, corra para dentro da sala de onde ela veio para obter crédito da missão.",
...
kQuestInstanceData.Uldaman.Alliance[11] = {
    ...
    Note = "As gemas estão em " .. yellow .. "[1]" .. white .. " em uma Urna Conspícua, " .. yellow .. "[8]" .. white .. " do Esconderijo Forjassombra, e " .. yellow .. "[9]" .. white ..
...
kQuestInstanceData.Uldaman.Horde[6] = {
    ...
    Note = "As gemas estão em " .. yellow .. "[1]" .. white .. " em uma Urna Conspícua, " .. yellow .. "[8]" .. white .. " do Esconderijo Forjassombra, e " .. yellow .. "[9]" .. white ..
        " de Grimlok. Note que ao abrir o Esconderijo Forjassombra, algumas criaturas surgirão e atacarão você. A Fonte de Poder do Colar Quebrado dropa de Arkhaedas " .. yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[11] = {
    ...
    Location = "Marechal Vilasboas (Abismo Rocha Negra " .. yellow .. "[4]" .. white .. ")",
    Note = "Isto faz parte da sequência de missões de sintonia com Onyxia. Marechal Vilasboas está em " .. yellow .. "[4]" .. white .. "..\nA missão é mais fácil se você limpar o Ringue da Lei (" .. yellow .. "[6]" .. white .. ") e o caminho até a entrada antes de iniciar o evento. Você encontra Oficial Maxwell em Estepes Ardentes - Vigília de Morgan (" ..
        yellow .. "84,68" .. white .. ")",
...
kQuestInstanceData.BlackrockDepths.Horde[7] = {
    ...
    Note = "Você encontra os anões perto de Bael'gar " .. yellow .. "[11]" .. white .. ". Você encontra Senhor da Guerra Trincador em Kargath no topo da torre (Ermos, " .. yellow .. "5,47" .. white .. ").\nA missão seguinte começa com Lexlort (Ermos - Kargath " .. yellow .. "5,47" ..
        white .. "). Você encontra Grark Lorkrub nas Estepes Ardentes (" .. yellow .. "38,35" .. white .. "). Você deve reduzir sua vida abaixo de 50% para amarrá-lo e iniciar uma missão de Escolta.",
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "Você pega a missão prévia de Coração Trovejante (Ermos - Kargath " .. yellow .. "3,48" .. white .. ").\nVocê encontra Comandante Gor'shak em " .. yellow .. "[3]" .. white .. ". A chave para abrir a prisão dropa de Suprema Interrogadora Gerstahn " ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[6] = {
    ...
    Note = "Para pegar Mojo de Warosh você deve evocar e matar Urok Uivo-da-ruína " .. yellow .. "[15]" .. white .. ". Para sua Evocação você precisa de uma Lança e Cabeça do Grão-lorde Omokk " .. yellow .. "[5]" .. white .. ". A Lança está em " .. yellow .. "[3]" ..
        white .. ". Durante a Evocação algumas ondas de ogros aparecem antes de Urok Uivo-da-ruína atacá-lo. Você pode usar a Lança durante a luta para danificar os ogros.",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[8] = {
    ...
    Note = "Você encontra Senhor da Guerra Voone em " .. yellow .. "[9]" .. white .. ", Grão-lorde Omokk em " .. yellow .. "[5]" .. white .. " e Lorde Supremo Wyrmthalak em " ..
        yellow .. "[19]" .. white .. ".",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "Você pega a Gema de Spirestone de Grão-lorde Omokk em " .. yellow .. "[5]" .. white .. ", a Gema de Smolderthorn de Senhor da Guerra Voone em " .. yellow .. "[9]" .. white .. " e a Gema de Bloodaxe de Lorde Supremo Wyrmthalak em " .. yellow .. "[19]" ..
        white .. ". O Selo de Ascensão Sem Adornos pode dropar de quase todos os inimigos no Pico da Rocha Negra Inferior. Você pega a Chave para o Pico da Rocha Negra Superior se completar esta sequência de missões.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[10] = {
    ...
    Note = "Missão prévia de Onyxia.\nVocê encontra Grão-lorde Omokk em " .. yellow .. "[5]" .. white .. ", Senhor da Guerra Voone em " .. yellow .. "[9]" .. white .. " e Lorde Supremo Wyrmthalak em " ..
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillin está em Gládio Cruel " .. yellow .. "Leste" .. white .. " em " .. yellow .. "[1]" .. white .. ". Ele corre quando você fala com ele, mas para e luta em " ..
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "Você encontra Aliz, a Metamorfa nos " .. yellow .. "Leste" .. white .. " de Gládio Cruel em " .. yellow .. "[5]" .. white ..
        ". A relíquia está em Silithus em " .. yellow .. "62,54" .. white .. ". A missão prévia vem de Ravina Saturna também.",
...
kQuestInstanceData.DireMaulWest.Alliance[2] = {
    ...
    Note = "Os Pilões estão marcados como " .. blue .. "[B]" .. white .. ". Immol'thar está em " .. yellow .. "[6]" .. white ..
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note = "Você encontra Cavindra no início da parte laranja antes de entrar na instância.\nVocê pega o Cajado de Celebrian de Tóxxico em " .. yellow .. "[2]" .. white .. ", o Diamante de Celebrian de Lorde Torpelíngua em " .. yellow .. "[5]" .. white .. ". Celebras está em " .. yellow .. "[7]" ..
...
kQuestInstanceData.MoltenCore.Alliance[3] = {
    ...
    Note = "Parte da sequência de missões Thunderfury, Lâmina Bendita do Buscador dos Ventos. Começa após obter a Braçadeira esquerda ou direita do Busca-ventos de Garr em " .. yellow .. "[4]" .. white .. " ou Barão Geddon em " .. yellow .. "[6]" .. white .. ". Então fale com Grão-lorde Dimitriano para iniciar a sequência. Essência do Senhor do Fogo dropa de Ragnaros em " .. yellow .. "[10]" ..
        white .. ". Após entregar esta parte, Príncipe Trovejardus é invocado e você deve matá-lo. Ele é um chefe de raide de 40 jogadores.",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[1] = {
    ...
    Note = "Esta sequência de missões começa com Irmão Crowley com a missão 'Irmão Anton' em Ventobravo - Catedral da Luz (" .. yellow .. "42,24" .. white .. ").\nVocê pode encontrar Alta-inquisidora Cristalba e Comandante Escarlate Mograine em " .. yellow .. "SM: Catedral [2]" .. white .. ", Herodes em " ..
        yellow .. "SM: Armaria [1]" .. white .. " e Mestre de Matilha Lobato em " .. yellow .. "SM: Biblioteca [1]" .. white .. ".",
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[2] = {
    ...
    Location = "Varimatras (Cidade Baixa - Bairro Real " .. yellow .. "56,92" .. white .. ")",
    Note = "Você pode encontrar Alta-inquisidora Cristalba e Comandante Escarlate Mograine em " .. yellow .. "SM: Catedral [2]" .. white .. ", Herodes em " .. yellow .. "SM: Armaria [1]" .. white .. " e Mestre de Matilha Lobato em " .. yellow ..
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Note = "Você pode encontrar O Título de Caer Darrow em " .. yellow .. "[12]" .. white .. ", O Título de Brill em " .. yellow .. "[7]" .. white .. ", O Título de Moinho Tarren em " ..
...
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Location = "Leonid Bartolomeu, o Venerado (Terras Pestilentas Orientais - Capilla Esperanza de la Luz " .. yellow .. "80,58" .. white .. ")",
    Note = "Você pega a missão prévia de Magistrado Marduque (Terras Pestilentas Ocidentais - Caer Darrow " .. yellow .. "70,73" .. white .. "). Você encontra a placa perto de " ..
        yellow .. "[19]" .. white .. ". Veja também: " .. yellow .. "[O Lich, Ras Friomúrmuro]" .. white .. " em Scolomântia.",
...
kQuestInstanceData.Stratholme.Alliance[21] = {
    ...
    Note = "Segunda Pena de Medivh no chão no lugar onde Ancião Murmulonge (Festival Lunar) " .. yellow .. "[5]" .. white .. " está.\nPrimeira Pena de Medivh " .. yellow .. "[Cidade Baixa]" .. white .. " atrás do trono da entrada.\nTerceira Pena de Medivh " .. yellow .. "[Montanhas de Alterac]" ..
        white .. " no final do primeiro penhasco (oeste) " .. yellow .. "[30.8,87.4]" .. white .. ".\nQuarta Pena de Medivh " .. yellow ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "Saco de Veneno de Venoxis dropa de Alto sacerdote Venoxis em " .. yellow .. "Zul'gurub" .. white .. ". Saco de Veneno de Korinnaxx dropa nas " .. yellow ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[4] = {
    ...
    Location = "Massa de Tentáculos Contorcidos (Bastion de Presamadeira - Peroth'arn" .. yellow .. "[10]" .. white .. ")",
    Note = red .. "Apenas Bruxos!" .. white .. " Entregar em: Lâmina de Prata Enterrada na Areia (Ruínas de Ahn'Qiraj " .. yellow .. "? " .. white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[7] = {
    ...
    Note = "Você encontra a Fonte da Essência ao lado de onde Vulto de Erânicos está em " .. yellow .. "[6]" .. white .. ".\n" .. red .. "Não" .. white .. " venda ou jogue fora o pingente de recompensa Essência Encadeada de Eranikus. Você precisará dele para a próxima missão em Itharius (Pântano das Mágoas - Caverna de Itharius " ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Note = "Tecelão " .. yellow .. "[6]" .. white .. " 1 de 4 dragões dropa Fragmento do Sonhador, aparecerá após matar Jammal'an, o Profeta " .. yellow .. "[4]" .. white .. ". A barreira para o Profeta desaparecerá após limpar 6 sacadas " .. blue .. "[C]" ..
...
kQuestInstanceData.ZulGurub.Alliance[4] = {
    ...
    Aim = "Dirk Thunderwood, do Castelo Cenariano, quer que você traga para ele o Saco de Veneno de Venoxis e o Saco de Veneno de Kurinnaxx.",
    Location = "Adaga Fortelenho (Silithus - Forte Cenariano " .. yellow .. "52,39" .. white .. ")",
    Note = "Saco de Veneno de Venoxis dropa de Alto sacerdote Venoxis em " .. yellow .. "Zul'gurub" .. white .. " em " .. yellow .. "[2]" .. white .. ". Saco de Veneno de Korinnaxx dropa nas " ..
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Note = "Você pega a missão prévia de Gaxim Deuxabu (Cordilheira das Torres de Pedra " .. yellow .. "59,67" .. white .. "). A missão prévia é apenas uma missão de apontamento e não é necessária para pegar esta missão.\nO cartão branco é um drop aleatório. Você encontra o primeiro terminal ao lado da entrada dos fundos antes de entrar na instância em " .. yellow .. "[3] no Mapa de Entrada" .. white .. ". O 3005-B está em " ..
        yellow .. "[3]" .. white .. ", o 3005-C em " .. yellow .. "[5]" .. white .. " e o 3005-D está em " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.FourDragons.Alliance[2] = {
    ...
    Note = "'Lamento de Ysera' é obtido de 'Favor de Erennius' (Solnius no modo difícil) (Santuário Esmeralda " .. yellow .. "[2]" .. white .. ").",
}
...
kQuestInstanceData.FourDragons.Alliance[6] = {
    ...
    Note = red .. "Apenas para bruxos!" .. white .. " 'Coração de Dragão Tocada pelo Pesadelo' é obtido dos Quatro Dragões.",
...
kQuestInstanceData.Reaver = {
    Story = "O Ceifador Sombrio assombra as brumas do Passo da Morte, um coletor espectral de relíquias pagas com sangue. Ele foi transformado de um ladrão comum em um fantasma imortal, destinado a colher almas e tesouros para um mestre que há muito partiu.",
...
kQuestInstanceData.Reaver.Alliance[1] = {
    ...
    Level = 60,
    Attain = 60,
    Aim = "Encontre um uso para o Ritual da Ressurreição. Os seres atemporais mencionados podem muito bem ser os poderosos dragões que percorrem Azeroth.",
    Location = "O Apito de Montaria de Lord Blackwald II dropa de (Salões Inferiores de Karazhan - Lord Blackwald II " .. yellow .. "[5] " .. white .. ")",
...
kQuestInstanceData.Nerubian.Alliance[1] = {
    ...
    Location = "O 'Chamado do Lorde da Cripta' dropa de 'Anub'Rekhan' em (Naxxramas - Ala das Aranhas " .. yellow .. "[1]" .. white .. ".",
    Note = "Entregue a missão a 'Tirion Fordring' nas Terras Pestilentas Orientais " .. yellow .. "[6, 44]" .. white .. ". 'Cruz Sagrada' dropa de elites Escarlates nas Terras Pestilentas Ocidentais e Orientais.",
}
...
kQuestInstanceData.Azuregos.Alliance[3] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Encontre um uso para o rito de ressurreição. As criaturas imortais mencionadas podem muito bem ser os poderosos dragões que percorrem Azeroth.",
    Location = "O rito de ressurreição é obtido em (Núcleo Derretido - Senescal Executus " .. yellow .. "[9]" .. white .. ")",
    Note = "Entregar a missão para 'Espírito de Azuregos' em Azshara " .. yellow .. "[56, 83]" .. white .. ". 'Essência de Dragão Azul' é obtida de dragões azuis de elite e filhotes em Azshara, Hibérnia e Costa Murmurlunar.",
}
for i = 1, 3 do
...
kQuestInstanceData.LordKazzak.Alliance[1] = { --TODO translate
    ...
    Location = "O Cristal de Fenda Retorcida é obtido em (Núcleo Derretido - Senescal Executus " .. yellow .. "[9]" .. white .. ")",
    Note = "Entregue a missão para 'Daio, o Decrépito' nas Terras Devastadas " .. yellow .. "[34, 50]" .. white .. ". 'Sangue Demoníaco Imbuído com Éter' é obtido de demônios de elite nas Terras Devastadas, Hibérnia e Hyjal.",
}
...
kQuestInstanceData.EmeraldSanctum.Alliance[4] = {
    ...
    Level = 60,
    Attain = 60,
    Aim = "Derrote Solnius e reúna Thil’phoral com o fragmento que ele possui na Vinha de Aln dentro do Santuário Esmeralda.",
    Location = "Altar das Profundezas (Azshara " .. yellow .. "[89, 56]" .. white .. ").",
    Note = red .. "Apenas para bruxos!" .. white .. " A missão prévia começa com 'Massa de Tentáculos Retorcidos', obtida em (Bastilha Presamadeira " .. yellow .. "[10]" .. white .. "). 'Solnius' está em " .. yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.TowerofKarazhan.Alliance[1] = {
    ...
    Note = "Cajado de Obsidiana " .. yellow .. "Salões Inferiores de Karazhan [e]." .. white .. " Resíduo Cósmico dropa de " .. yellow .. "[3]." .. white .. "\nA missão prévia A Ligação de Xanthar começa com Hanvar, o Justo (Trilha do Vento Morto - Sepultura de Morgan " .. yellow .. "40.9, 79.3" ..
        white .. "), missão prévia Vinho para Kyleson começa com O Cozinheiro " .. yellow .. "(Salões Inferiores de Karazhan [e])",
...
kQuestInstanceData.StormwroughtRuins.Alliance[1] = {
    ...
    Note = "'Chave do Castelo Forjatrovoada' é uma recompensa da cadeia de missões que começa em Drak’thul (Balor " .. yellow .. "55, 19" .. white .. ") e desbloqueia o acesso ao chefe 6+. \n'Coroa de Balor' dropa de 'Duque Balor IV' " .. yellow .. "[4]",
    Rewards = {
        Text = "Recompensa: Escolha um",
...
kQuestInstanceData.StormwroughtRuins.Horde[9] = {
    ...
    Note = "A pré-missão começa em 'Magus Ordínio Olharvazio' (Contraforte de Eira dos Montes - Moinho Tarren " .. yellow .. "62, 21" .. white .. ")",
...
kQuestInstanceData.TimbermawHold.Alliance[4] = { --TODO translate
    ...
    Location = "Narkogg, o Sombrio (Azshara - Gorja de Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "'Coração de Nemasra' cai de 'Nemasra' na Cratera Un'Goro (" .. yellow .. "35, 25" .. white .. "), 'Língua de Grammon' de 'Grammon, o Atemporal' em Feralas (" .. yellow .. "28, 95" .. white .. "), 'Frasco de Purificação' do 'Senhor das Marés Rrurgaz' (Pântano Vadeador - " ..
        yellow .. "76, 20" .. white .. ")",
