...
kQuestInstanceData.WailingCaverns.Horde[8] = {
    ...
    Note = red .. "SOLO Mago." .. white .. " La cadena de misiones comienza con Ureda <Instructora de magos> (Orgrimmar) con la misión 'Dominando lo Arcano'.\nLa Madera tocada por la luna la obtienes de " .. yellow .. "enemigos comunes" .. white .. ", un Cristal de la Serpiente de Lord Serpentis <Señor del Colmillo>" .. yellow .. "[7]" .. white .. ", y una Esencia Siempre Cambiante de Lord Pythas <Señor del Colmillo> " ..
        yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "La Cámara Oculta está en " .. yellow .. "[4]" .. white .. ". Para abrir la Cámara Oculta necesitas El Eje de Tsol de Revelosh " .. yellow .. "[3]" .. white .. " y el Medallón de Gni'kiv del Cofre de Baelog " .. yellow .. "[1]" .. white ..
        ". Combina estos dos objetos para formar el Báculo de Prehistoria. El Báculo se usa en la Sala de Mapas entre " .. yellow .. "[3] y [4]" .. white .. " para invocar a Hierraya. Después de matarla, corre dentro de la habitación de donde salió para obtener crédito de la misión.",
...
kQuestInstanceData.Uldaman.Alliance[11] = {
    ...
    Note = "Las gemas están en " .. yellow .. "[1]" .. white .. " en una Urna Llamativa, " .. yellow .. "[8]" .. white .. " del Alijo de Forjatiniebla, y " .. yellow .. "[9]" .. white ..
...
kQuestInstanceData.Uldaman.Horde[6] = {
    ...
    Note = "Las gemas están en " .. yellow .. "[1]" .. white .. " en una Urna Llamativa, " .. yellow .. "[8]" .. white .. " del Alijo de Forjatiniebla, y " .. yellow .. "[9]" .. white ..
        " de Grimlok. Ten en cuenta que al abrir el Alijo de Forjatiniebla, aparecerán algunos enemigos y te atacarán. La Fuente de Energía de Collar Fragmentado cae de Archaedas " .. yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[11] = {
    ...
    Location = "Mariscal Windsor (Profundidades de Roca Negra " .. yellow .. "[4]" .. white .. ")",
    Note = "Esto es parte de la cadena de misiones de sintonización de Onyxia. El Mariscal Windsor está en " .. yellow .. "[4]" .. white .. ".\nLa misión es más fácil si limpias el Anillo de la Ley (" .. yellow .. "[6]" .. white .. ") y el camino a la entrada antes de comenzar el evento. Encuentras al Mariscal Maxwell en Las Estepas Ardientes - Vigilancia de Morgan (" ..
        yellow .. "84,68" .. white .. ")",
...
kQuestInstanceData.BlackrockDepths.Horde[7] = {
    ...
    Note = "Encuentras a los enanos cerca de Bael'Gar " .. yellow .. "[11]" .. white .. ". Encuentras al Señor de la Guerra Dientegore en Kargath en la cima de la torre (Tierras Inhóspitas, " .. yellow .. "5,47" .. white .. ").\n La misión siguiente comienza con Lexlort (Tierras Inhóspitas - Kargath " .. yellow .. "5,47" ..
        white .. "). Encuentras a Grark Lorkrub en Las Estepas Ardientes (" .. yellow .. "38,35" .. white .. "). Tienes que reducir su vida por debajo del 50% para atarlo e iniciar una misión de Escolta.",
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "Obtienes la misión anterior de Corazón Atronador (Tierras Inhóspitas - Kargath " .. yellow .. "3,48" .. white .. ").\nEncuentras al Comandante Gor'Shak en " .. yellow .. "[3]" .. white .. ". La llave para abrir la prisión cae de la Alta Interrogadora Gerstahn " ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[6] = {
    ...
    Note = "Para obtener el Mojo de Warosh tienes que invocar y matar a Urok Aullapocalipsis " .. yellow .. "[15]" .. white .. ". Para su Invocación necesitas una Lanza y al Alto Señor Cabeza de Omokk " .. yellow .. "[5]" .. white .. ". La Lanza está en " .. yellow .. "[3]" ..
        white .. ". Durante la Invocación aparecen algunas oleadas de ogros antes de que Urok Aullapocalipsis te ataque. Puedes usar la Lanza durante la pelea para dañar a los ogros.",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "Obtienes la Gema de Piedra de Aguja del Alto Señor Omokk en " .. yellow .. "[5]" .. white .. ", la Gema de Espino de Brasa del Maestro de Guerra Voone en " .. yellow .. "[9]" .. white .. " y la Gema de Hacha de Sangre del Señor Supremo Vermiothalak en " .. yellow .. "[19]" ..
        white .. ". El Sello sin Adornar de Ascensión puede caer de casi todos los enemigos en la Cumbre de Roca Negra Inferior. Obtienes la Llave para la Cumbre de Roca Negra Superior si completas esta cadena de misiones.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[10] = {
    ...
    Note = "Misión anterior de Onyxia.\nEncuentras al Alto Señor Omokk en " .. yellow .. "[5]" .. white .. ", al Maestro de Guerra Voone en " .. yellow .. "[9]" .. white .. " y al Señor Supremo Vermiothalak en " ..
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillín está en La Masacre " .. yellow .. "Este" .. white .. " en " .. yellow .. "[1]" .. white .. ". Corre cuando hablas con él, pero se detiene y lucha en " ..
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "Encuentras a Alliz el Formacampos en la parte " .. yellow .. "Este" .. white .. " de La Masacre en " .. yellow .. "[5]" .. white .. ". La reliquia está en Silithus en " ..
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note = "Encuentras a Cavindra al principio de la parte naranja antes de entrar a la instancia.\nObtienes la Vara de Celebras de Noxxion en " .. yellow .. "[2]" .. white .. ", el Diamante de Celebras del Señor Lenguavil en " .. yellow .. "[5]" .. white .. ". Celebras está en " .. yellow ..
...
kQuestInstanceData.Maraudon.Horde[10] = { --TODO translate
    ...
    Level = 47,
    Attain = 41,
    Aim = "Limpia las aguas corruptoras y su fuente dentro de Maraudon y regresa con Ohona Riverbend en el Círculo de la Tierra en las Tierras Devastadas.",
    Location = "Ohona Riverbend (Tierras Devastadas - El Círculo de la Tierra " .. yellow .. "[52, 70]" .. white .. ").",
    Note = "'Noxxion' está en " .. yellow .. "[2]" .. white .. ", 'Lord Lenguavil' está en " .. yellow .. "[5]" .. white .. ".",
    Rewards = {
        Text = "Recompensa: Elige uno",
...
kQuestInstanceData.MoltenCore.Alliance[3] = {
    ...
    Note = "Parte de la cadena de misiones de Furia de Trueno, Hoja Bendita del Buscavientos. Comienza después de obtener las Ataduras del Hijo del Viento izquierda o derecha de Garr en " .. yellow .. "[4]" .. white .. " o del Barón Geddon en " .. yellow .. "[6]" .. white .. ". Luego habla con el Alto Señor Demitrian para comenzar la cadena de misiones. La Esencia del Señor del Fuego cae de Ragnaros en " .. yellow .. "[10]" ..
        white .. ". Después de entregar esta parte, el Príncipe Thunderaan es invocado y debes matarlo. Es un jefe de banda de 40 jugadores.",
...
kQuestInstanceData.RazorfenKraul.Horde[6] = {
    ...
    Level = 30,
    Attain = 20,
    Aim = "Destruye la encarnación viva de la corrupción natural dentro de las profundidades de Razorfen Kraul y lleva el Corazón de Espinas Corrompido a Kym Wildmane en Cima del Trueno.",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[1] = {
    ...
    Note = "Esta línea de misiones comienza en Hermano Cuerviz con la misión 'Hermano Anton' en Ventormenta - Catedral de la Luz (" .. yellow .. "42,24" .. white .. ").Puedes encontrar a la Alta Inquisidora Melenablanca y al Comandante Escarlata Mograine en " .. yellow .. "MS: Catedral [2]" .. white .. ", a Herod en " ..
        yellow .. "MS: Armería [1]" .. white .. " y al Maestro de Canes Loksey en " .. yellow .. "MS: Biblioteca [1]" .. white .. ".",
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[2] = {
    ...
    Location = "Varimathras (Entrañas - Barrio Real " .. yellow .. "56,92" .. white .. ")",
    Note = "Puedes encontrar a la Alta Inquisidora Melenablanca y al Comandante Escarlata Mograine en " .. yellow .. "MS: Catedral [2]" .. white .. ", a Herod en " .. yellow .. "MS: Armería [1]" .. white .. " y al Maestro de Canes Loksey en " ..
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Note = "Puedes encontrar La Escritura de Castel Darrow en " .. yellow .. "[12]" .. white .. ", La Escritura de Claros de Tirisfal en " .. yellow .. "[7]" .. white .. ", La Escritura de Molino Tarren en " ..
...
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Location = "Leonid Barthalomew el Venerado (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz " .. yellow .. "80,58" .. white .. ")",
    Note = "Obtienes la misión anterior del Magistrado Marduke (Tierras de la Peste del Oeste - Castel Darrow " .. yellow .. "70,73" .. white .. "). Encuentras el cartel cerca de " .. yellow .. "[19]" .. white .. ". Ver también: " .. yellow .. "[El Liche, Ras Levescarcha]" ..
...
kQuestInstanceData.Stratholme.Alliance[21] = {
    ...
    Note = "La Segunda Pluma de Medivh está en el suelo en el lugar donde está el Ancestro Levesusurro (Festival Lunar) " .. yellow .. "[5]" .. white .. ".\nLa Primera Pluma de Medivh está en " .. yellow .. "[Entrañas]" .. white .. " detrás del trono de la entrada.\nLa Tercera Pluma de Medivh está en " .. yellow .. "[Montañas de Alterac]" ..
        white .. " al final del primer acantilado (occidental) " .. yellow .. "[30.8,87.4]" .. white .. ".\nLa Cuarta Pluma de Medivh está en " ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "El Saco de Veneno de Venoxis cae del Sumo Sacerdote Venoxis en " .. yellow .. "Zul'Gurub" .. white .. ". El Saco de Veneno de Kurinnaxx cae en las " ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[7] = {
    ...
    Note = "Encuentras la Fuente de la Esencia junto a donde está Sombra de Eranikus en " .. yellow .. "[6]" .. white .. ".\n" .. red .. "No" .. white .. " vendas ni tires el abalorio de recompensa Esencia Encadenada de Eranikus. Lo necesitarás para la siguiente misión en Itharius (Pantano de las Penas - Cueva de Itharius " ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Note = "Telar " .. yellow .. "[6]" .. white .. " uno de los 4 dragones suelta Fragmento del Durmiente, aparecerá tras matar a Jammal'an el Profeta " .. yellow .. "[4]" .. white .. ". La barrera al Profeta desaparecerá tras limpiar los 6 balcones " .. blue .. "[C]" ..
...
kQuestInstanceData.ZulGurub.Alliance[4] = {
    ...
    Aim = "Dirk Truenomad en el Bastión Cenarion quiere que le traigas el Saco de Veneno de Venoxis y el Saco de Veneno de Kurinnaxx.",
    Location = "Puñal Truenedera (Silithus - Bastión Cenarion " .. yellow .. "52,39" .. white .. ")",
    Note = "Saco de Veneno de Venoxis se obtiene de Sumo sacerdote Venoxis en " .. yellow .. "Zul'Gurub" .. white .. " en " .. yellow .. "[2]" .. white .. ". Saco de Veneno de Kurinnaxx se obtiene en las " ..
    yellow .. "Ruinas de Ahn'Qiraj" .. white .. " en " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Recompensa: Elige uno",
        { id = 22378 }, --Ravenholdt Slicer One-Hand, Sword
...
kQuestInstanceData.ZulGurub.Alliance[5] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Infiltra Zul’Gurub y regresa con los Colmillos del Sumo Sacerdote Jam’wahli a Insom’ni en la Isla Kazon, cerca de la Isla de Gillijim.",
    Location = "Insom'ni (Isla de Gillijim - Isla Kazon " .. yellow .. "56,16" .. white .. ")",
    Note = "La prequest comienza en Nathok (Azshara " .. yellow .. "39, 20" .. white .. "). 'Sumo Sacerdote Jam'wahli' (Zul'Gurub - " .. yellow .. "0, 0" .. white .. ") suelta los 'Colmillos de Jam’wahli'.",
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Note = "Obtienes la misión previa de Gaxim Herrumbrosa (Sierra Espolón " .. yellow .. "59,67" .. white .. "). La misión previa es solo una misión indicadora y no es necesaria para obtener esta misión.\nLa tarjeta blanca es un botín aleatorio. Encuentras el primer terminal junto a la entrada trasera antes de entrar a la instancia en " .. yellow .. "[3] en el Mapa de Entrada" .. white .. ". La 3005-B está en " ..
        yellow .. "[3]" .. white .. ", la 3005-C en " .. yellow .. "[5]" .. white .. " y la 3005-D está en " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.TowerofKarazhan.Alliance[1] = {
    ...
    Note = "Vara de Obsidiana " .. yellow .. "Salas Inferiores de Karazhan [e]." .. white .. " Residuo Cósmico se obtiene de " .. yellow .. "[3]." .. white .. "\nLa misión previa La Vinculación de Xanthar comienza en Hanvar el Justo (Paso de Viento Muerto - Tumba de Morgan " .. yellow .. "40.9, 79.3" ..
        white .. "), la misión previa Vino para Kyleson comienza en El Cocinero " .. yellow .. "(Salas Inferiores de Karazhan [e])",
...
kQuestInstanceData.StormwroughtRuins.Alliance[1] = {
    ...
    Note = "'Llave del Castillo Forjatormenta' es una recompensa de la cadena de misiones que comienza en Drak’thul (Balor " .. yellow .. "55, 19" .. white .. ") y desbloquea el acceso al jefe 6+.\n'Corona de Balor' se obtiene del 'Duque Balor IV' " .. yellow .. "[4]",
    Rewards = {
        Text = "Recompensa: Elige uno",
...
kQuestInstanceData.WindhornCanyon.Alliance[1] = { --TODO translate
    ...
    Level = 27,
    Attain = 20,
    Aim = "Recoge 8 Reliquias de Cuerno de Viento para Tarwegg Polvoriente dentro del Cañón Cuerno de Viento y regresa con él a Forjaz.",
...
kQuestInstanceData.WindhornCanyon.Horde[1] = { --TODO translate
    ...
    Level = 27,
    Attain = 20,
    Aim = "Viaja al Cañón Cuerno de Viento y recupera 8 Reliquias de Cuerno de Viento para Sagh en el Refugio de Sagh en Las Mil Agujas.",
...
kQuestInstanceData.WindhornCanyon.Horde[2] = { --TODO translate
    ...
    Level = 28,
    Attain = 24,
    Aim = "Mata al Profeta Cuerno de Tormenta, el líder de los Tótem de la Muerte dentro del Cañón Cuerno de Viento, y regresa con Cairne Pezuña Sangrienta en Cima del Trueno.",
    Location = "Cairne Pezuña Sangrienta (Cima del Trueno " .. yellow .. "60, 52" .. white .. ")",
    Note = "La pre-misión comienza en 'Brave Moonhorn' (Las Mil Agujas - El Gran Ascensor " .. yellow .. "32, 22" .. white .. "). 'Profeta Cuerno de Tormenta' está en " .. yellow .. "[6]" .. white .. ".",
    Prequest = "Mensaje al Puesto Libre -> Pacificar al Centauro -> Espionaje de los Tótem Siniestros -> Rumores del Tótem de la Muerte -> Información para Cairne",
    Rewards = {
        Text = "Recompensa: Elige uno",
...
kQuestInstanceData.WindhornCanyon.Horde[3] = { --TODO translate
    ...
    Level = 26,
    Attain = 20,
    Aim = "Desterrar al líder elemental dentro del Cañón Cuerno de Viento y regresar con Shovu en el Círculo de la Tierra en las Montañas de la Espina del Dragón.",
    Location = "Shovu (Montañas de la Espina del Dragón - Círculo de la Tierra " .. yellow .. "47, 72" .. white .. ")",
    Note = red .. "¡Solo chamanes! " .. white .. "La pre-misión comienza en 'Piedra de Cresta Viento', que cae de 'Razorgust' en las Montañas de la Espina del Dragón (" .. yellow .. "30, 19" .. white .. "). 'Embajador Vortalus' está en " .. yellow .. "[3]" .. white .. ".",
...
kQuestInstanceData.FrostmaneHollow.Alliance[4] = { --TODO translate
    ...
    Level = 16,
    Attain = 10,
    Aim = "Entra en la Guarida de los Colmillos de Escarcha en Dun Morogh y consigue una piel de leopardo impecable para Shandlar Thethis en Alah'thalas en las Tierras de la Corona de Hielo. Puedes encontrar la entrada a la Guarida de los Colmillos de Escarcha cerca de los Campos de Aviación de Forjaz.",
...
kQuestInstanceData.FrostmaneHollow.Alliance[5] = { --TODO translate
    ...
    Level = 16,
    Attain = 8,
    Aim = "Mata al Maestro de Batalla Ubukaz en lo profundo de la Guarida de los Colmillos de Escarcha para el Montañero Barba de Granito en el Aeródromo de Forjaz en Dun Morogh.",
...
kQuestInstanceData.TimbermawHold.Alliance[1] = { --TODO translate
    ...
    Level = 60,
    Attain = 50,
    Aim = "Entra en el Bastión Fauces de Madera y recupera el draenethyst corrupto. Llévalos al Maestro de Grietas Ral’pekta en la Aldea de Moro’gai de la Costa Susurrante de la Luna si tienes éxito.",
    Location = "Maestro de Grietas Ral’pekta (Costa Susurrante de la Luna - Aldea de Moro’gai " .. yellow .. "65, 63" .. white .. ")",
    Note = "La pre-misión comienza en '' (" .. yellow .. "0, 0" .. white .. "). 'Selenaxx Foulheart' está en " .. yellow .. "[7]" .. white .. ".",
...
kQuestInstanceData.TimbermawHold.Alliance[2] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Presenta a Narkogg el Oscuro en las Fauces de Ursoc en Azshara una prueba de haber matado a Karrsh el Centinela en el Bastión Fauces de Madera.",
...
kQuestInstanceData.TimbermawHold.Alliance[3] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Reúne tótems Faucesmarchitas de los chamanes Faucesmarchitas dentro del Bastión Fauces de Madera y tráelos a Narkogg el Oscuro en las Fauces de Ursoc en Azshara.",
    Location = "Narkogg el Oscuro (Azshara - Fauces de Ursoc " .. yellow .. "39, 21" .. white .. ")",
...
kQuestInstanceData.TimbermawHold.Alliance[4] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Narkogg el Oscuro en las Fauces de Ursoc en Azshara necesita materiales específicos para el ungüento de purificación. Tráeselos.",
    Location = "Narkogg el Oscuro (Azshara - Fauces de Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "El 'Corazón de Nemasra' cae de 'Nemasra' en el Cráter de Un'Goro (" .. yellow .. "35, 25" .. white .. "), la 'Lengua de Grammon' de 'Grammon el Eterno' Feralas (" .. yellow .. "28, 95" .. white .. "), el 'Vial de purificación' del 'Señor de las mareas Rrurgaz' (Marjal Revolcafango - " ..
        yellow .. "76, 20" .. white .. ")",
...
kQuestInstanceData.TimbermawHold.Alliance[7] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Mata a Ursol en el Bastión Fauces de Madera. Informa después a Narkogg el Oscuro en las Fauces de Ursoc en Azshara.",
    Location = "Narkogg el Oscuro (Azshara - Fauces de Ursoc " .. yellow .. "39, 21" .. white .. ")",
...
kQuestInstanceData.TimbermawHold.Alliance[9] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Entra en el Bastión Fauces de Madera y destruye a Peroth'arn. ¡Regresa con Narkogg el Oscuro en las Fauces de Ursoc en Azshara después de haber limpiado la corrupción que asola Kalimdor!",
    Location = "Gorn Tuerto (Túneles Fauces de Madera " .. yellow .. "30, 64" .. white .. ")",
    Note = "La pre-misión comienza en Nathok (Azshara - Fauces de Ursoc " .. yellow .. "39, 20" .. white .. "). 'Peroth'arn' está en " .. yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.TimbermawHold.Horde[11] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Vence a Loktanag el Vil dentro del Bastión Fauces de Madera y regresa con Muln Furia de Tierra en el Anillo de la Tierra en las Sierra Espolón.",
