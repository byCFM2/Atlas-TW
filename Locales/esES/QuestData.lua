...
kQuestInstanceData.WailingCaverns.Horde[6] = {
    ...
    Note = "La cadena de misiones comienza con Hamuul Runetotem (Cima del Trueno - Cima del Ancestro " ..
        ...
        "78,28" ..
        white ..
        ")\nLos 4 druidas sueltan las gemas " ..
...
kQuestInstanceData.WailingCaverns.Horde[8] = {
    ...
    Note = red ..
        ...
        yellow ..
        "[7]" .. white .. ", y una Esencia Siempre Cambiante de Lord Pythas <Señor del Colmillo> " ..
        yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "La Cámara Oculta está en " ..
        ...
        "[3]" ..
        white ..
        " y el Medallón de Gni'kiv del Cofre de Baelog " ..
        yellow ..
        "[1]" ..
        white ..
...
kQuestInstanceData.BlackrockDepths.Alliance[4] = {
    ...
    Note = "Obtienes la misión anterior de Enohar Cebatruenos (Las Tierras Devastadas - Bastión Nethergarde " ..
        ...
        "61,18" ..
        white ..
        ").\nConsigues la receta de uno de los guardias que aparecen si destruyes la cerveza " .. yellow ..
        "[15]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Horde[4] = {
    ...
    Note = "Obtienes la misión anterior de la Boticaria Zinge en Entrañas - El Apothecarium (" ..
        ...
        "50,68" ..
        white ..
        ").\nObtienes la receta de uno de los guardias que aparecen si destruyes la cerveza " .. yellow .. "[15]" ..
        white .. ".",
...
kQuestInstanceData.BlackrockDepths.Horde[7] = {
    ...
    Note = "Encuentras a los enanos cerca de Bael'Gar " ..
        ...
        "5,47" ..
        white ..
        ").\n La misión siguiente comienza con Lexlort (Tierras Inhóspitas - Kargath " ..
        yellow ..
        "5,47" ..
        white ..
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "Obtienes la misión anterior de Corazón Atronador (Tierras Inhóspitas - Kargath " ..
        ...
        "[3]" ..
        white ..
        ". La llave para abrir la prisión cae de la Alta Interrogadora Gerstahn " ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[7] = {
    ...
    Note = "Encuentras las Pertenencias de Bijou en el camino a Madre Telabrasada en " ..
        yellow ..
        "[13]" .. white .. ".\nMaxwell está en (Las Estepas Ardientes - Vigilancia de Morgan " ..
        yellow .. "84,58" .. white .. ").",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[8] = {
    ...
    Note = "Encuentras al Maestro de Guerra Voone en " ..
        yellow ..
        "[9]" ..
        white ..
        ", al Alto Señor Omokk en " ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "Obtienes la Gema de Piedra de Aguja del Alto Señor Omokk en " ..
        ...
        "[9]" ..
        white ..
        " y la Gema de Hacha de Sangre del Señor Supremo Vermiothalak en " ..
        yellow ..
        "[19]" ..
        white ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[10] = {
    ...
    Note = "El Mariscal Maxwell está en Las Estepas Ardientes - Vigilancia de Morgan; (" .. yellow ..
        "84,58" .. white .. ").",
...
kQuestInstanceData.BlackrockSpireLower.Horde[10] = {
    ...
    Note = "Misión anterior de Onyxia.\nEncuentras al Alto Señor Omokk en " ..
        ...
        "[5]" ..
        white ..
        ", al Maestro de Guerra Voone en " ..
        yellow ..
        "[9]" ..
        white ..
        " y al Señor Supremo Vermiothalak en " ..
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[3] = {
    ...
    Folgequest = "Recolección de Huevos -> Leonid Barthalomew -> Gambito del Alba (" .. yellow ..
        "Scholomance" .. white .. ")",
}
...
kQuestInstanceData.BlackrockSpireUpper.Horde[5] = {
    ...
    Location = "Maga Oscura Vivian Lagrave (Tierras Inhóspitas - Kargath " .. yellow .. "2,47" .. white .. ")",
    Note = "Obtienes la misión anterior de la Boticaria Zinge en Entrañas - El Apothecarium (" ..
        yellow .. "50,68" .. white .. ").\n\nThe Tablilla de Rocanegra está en " .. yellow .. "[3]" .. white ..
        " en un cofre.",
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillín está en La Masacre " ..
        ...
        "[1]" ..
        white ..
        ". Corre cuando hablas con él, pero se detiene y lucha en " ..
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "Encuentras a Alliz el Formacampos en la parte " ..
        ...
        "[5]" ..
        white ..
        ". La reliquia está en Silithus en " ..
...
kQuestInstanceData.DireMaulWest.Alliance[2] = {
    ...
    Note = "Los Pilones están marcados como " ..
        blue ..
        "[B]" ..
        white .. ". Immol'thar está en " .. yellow ..
...
kQuestInstanceData.DireMaulWest.Alliance[5] = {
    ...
    Note = red ..
        "Solo Druida" .. white .. ": Entregas el libro al Tradicionalista Javon en la " ..
        yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[6] = {
    ...
    Note = red ..
        "Solo Cazador" .. white .. ": Entregas el libro al Tradicionalista Mykos en la " ..
        yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[7] = {
    ...
    Note = red ..
        "Solo Mago" .. white .. ": Entregas el libro al Tradicionalista Kildrath en la " ..
        yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[8] = {
    ...
    Note = red ..
        "Solo Paladín" .. white .. ": Entregas el libro al Tradicionalista Mykos en la " ..
        yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[9] = {
    ...
    Note = red ..
        "Solo Sacerdote" .. white ..
        ": Entregas el libro al Tradicionalista Javon en la " .. yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[10] = {
    ...
    Note = red ..
        "Solo Pícaro" .. white ..
        ": Entregas el libro al Tradicionalista Kildrath en la " .. yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[11] = {
    ...
    Note = red ..
        "Solo Chamán" .. white .. ": Entregas el libro al Tradicionalista Javon en la " ..
        yellow .. "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[12] = {
    ...
    Note = red ..
        "Solo Brujo" .. white .. ": Entregas el libro al Tradicionalista Mykos en la " .. yellow ..
        "Biblioteca 1'" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.DireMaulWest.Alliance[20] = {
    ...
    Note = "Misiones anteriores de los Salones Inferiores de Karazhan. Las Gemas Arcanizadas caen de " .. yellow ..
        "[6].",
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note =
        ...
        yellow ..
        "[5]" .. white .. ". Celebras está en " .. yellow ..
...
kQuestInstanceData.Maraudon.Alliance[11] = {
    ...
    Location = "Thegren <Artisan Gemologist> (Tierras Inhóspitas - Ruinas de Corthan " .. yellow ..
        "[29, 27]" .. white .. ").",
    Note = red ..
        "Solo Joyería." ..
        white .. " Cadena de misiones para la especialización de Gemólogo.\nDerrumblo está en " .. yellow ..
        "[8]" .. white .. ".",
...
kQuestInstanceData.MoltenCore.Alliance[2] = {
    ...
    Location = "Duque Hydraxis (Azshara " .. yellow .. "79,73" .. white .. ")",
    Note = "Lucifrón está en " ..
        yellow ..
        "[2]" .. white .. ", Sulfuron está en " .. yellow .. "[8]" ..
...
kQuestInstanceData.MoltenCore.Alliance[5] = {
    ...
    Note = "Se entrega a Vartrus el Ancestro en (Frondavil - Bosques Árbol de Hierro " .. yellow .. "49,24" ..
        white .. ").",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[1] = {
    ...
    Note =
        ...
        white ..
        ", a Herod en " ..
        yellow .. "MS: Armería [1]" .. white .. " y al Maestro de Canes Loksey en " ..
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Note = "Puedes encontrar La Escritura de Castel Darrow en " ..
        ...
        "[7]" ..
        white ..
        ", La Escritura de Molino Tarren en " ..
...
kQuestInstanceData.ShadowfangKeep.Horde[1] = {
    ...
    Note = "Encuentras al Mortacechador Adamant en " ..
        yellow ..
        "[1]" ..
        white .. ". El Mortacechador Vincent está en el lado derecho cuando entras al patio en " .. yellow ..
        "[2]" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.ShadowfangKeep.Horde[2] = {
    ...
    Note = "Encuentras el libro en " .. yellow .. "[8]" .. white ..
        " en el lado izquierdo cuando entras a la habitación.",
    Rewards = {
        Text = "Recompensa: Elige uno",
...
kQuestInstanceData.Stratholme.Alliance[4] = {
    ...
    Location = "Smokey LaRue (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz " ..
        yellow .. "80,58" .. white .. ")",
    Note = "Encuentras la tienda de humo cerca de " .. yellow ..
        "[1]" .. white .. ". Fras Siabi aparece cuando abres la caja.",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.Stratholme.Alliance[16] = {
    ...
    Note = red .. "Solo Herrería" .. white ..
        ": El Armero Guardia Negra es invocado cerca de " .. yellow .. "[15]" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.Stratholme.Alliance[17] = {
    ...
    Note = red .. "Solo Herrería" .. white .. ": El Forjamartillos Carmesí es invocado en " .. yellow ..
        "[8]" .. white .. ".",
    Rewards = {
        Text = "Recompensa: ",
...
kQuestInstanceData.Stratholme.Alliance[21] = {
    ...
    Note = "La Segunda Pluma de Medivh está en el suelo en el lugar donde está el Ancestro Levesusurro (Festival Lunar) " ..
        ...
        "[Entrañas]" ..
        white ..
        " detrás del trono de la entrada.\nLa Tercera Pluma de Medivh está en " ..
        yellow ..
        "[Montañas de Alterac]" ..
        white ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "El Saco de Veneno de Venoxis cae del Sumo Sacerdote Venoxis en " ..
        ...
        "Zul'Gurub" ..
        white ..
        ". El Saco de Veneno de Kurinnaxx cae en las " ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[3] = {
    ...
    Note = red ..
        ...
        yellow .. "[1] Biblioteca" .. white .. "). El Fragmento de Obsidiana Perfecto cae de " .. yellow .. "[3]" ..
        white .. ".",
...
kQuestInstanceData.TheSunkenTemple.Alliance[2] = {
    ...
    Note = "La misión previa 'Muigin y Larion' comienza en Muigin (Cráter de Un'Goro - Refugio de Marshal " ..
        yellow .. "42,9" ..
        white .. "). Obtienes la Bruma de los Acechadores profundos, Gusanos del lodo o Cienos en el Templo.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[13] = {
    ...
    Note = red ..
        ...
        ": Morphaz está en " ..
        yellow ..
        "[5]" .. white .. ". Greta Cuerno de Musgo está en Frondavil - Santuario Esmeralda (" .. yellow ..
        "51,82" .. white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[14] = {
    ...
    Note = red ..
        ...
        yellow ..
        "[5]" .. white .. ". Lord Jorach Ravenholdt está en Montañas de Alterac - Ravenholdt (" ..
        yellow .. "86,79" .. white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Note = "Telar " ..
        ...
        "[4]" ..
        white ..
        ". La barrera al Profeta desaparecerá tras limpiar los 6 balcones " ..
        blue ..
        "[C]" ..
        white ..
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[12] = {
    ...
    Attain = 51,
    Aim = "null",
    Location = "Comandante de Jinetes de Carneros Pico Tormenta (Valle de Alterac - North " .. yellow ..
        "[6]" .. white .. ")",
...
kQuestInstanceData.BGArathiBasin.Horde[1] = {
    ...
    Aim =
    "Asalta la mina, el aserradero, la herrería y la granja, luego regresa con el Mariscal de Campo Oslight en Refugio de la Zaga.",
    Location = "Maestro de la Muerte Duire (Tierras Altas de Arathi - Caída de Martillo " .. yellow ..
        "74,35" .. white .. ")",
...
kQuestInstanceData.HateforgeQuarry.Alliance[2] = {
    ...
    Location = "Morgrim Pica de Fuego (Las Estepas Ardientes - Paso de Roca Negra " .. yellow .. "75.6,68.3" ..
        white .. ").",
    Note =
...
kQuestInstanceData.GilneasCity.Alliance[3] = {
    ...
    Location = "Barón Caliban Línea Plateada (Gilneas - Villa Cuervo (main building) " .. yellow ..
        "58.4,67.8" .. white .. ")",
    Note =
...
kQuestInstanceData.GilneasCity.Alliance[6] = {
    ...
    Note =
        ...
        "58.4,67.8" ..
        white ..
        ")\nLa Corona Cringrís se obtiene de Genn Cringrís " .. yellow ..
        "[8]" .. white .. ", último jefe en la cima de la torre.",
    Prequest =
...
kQuestInstanceData.GilneasCity.Alliance[8] = {
    ...
    Note = red ..
        ...
        yellow ..
        "60,24" ..
        white .. "). \nDustivan Capucha Negra " .. yellow .. "[4]" .. white ..
        " suelta la Gargantilla de Citrino Deslustrada",
...
kQuestInstanceData.LowerKarazhan.Alliance[8] = {
    ...
    Note = "Entrega la misión a Duque Rothlen " ..
        yellow ..
        "[Karazhan - f]" .. white .. " en el balcón junto a Señor de las Garras Colmilloullador " ..
        yellow .. "[4]" .. white .. ".",
...
kQuestInstanceData.StormwroughtRuins.Horde[7] = {
    ...
    Location = "Vidente Lejano Mothang (Territorios Sombríos - Puesto de Cuchilla Rota " .. yellow ..
        "59, 29" .. white .. ")",
    Note =
...
kQuestInstanceData.TimbermawHold.Alliance[4] = { --TODO translate
    ...
    Location = "Narkogg el Oscuro (Azshara - Fauces de Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "El 'Corazón de Nemasra' cae de 'Nemasra' en el Cráter de Un'Goro (" .. yellow .. "35, 25" .. white .. "), la 'Lengua de Grammon' de 'Grammon el Eterno' Feralas (" .. yellow .. "28, 95" .. white ..
     "), el 'Vial de purificación' del 'Señor de las mareas Rrurgaz' (Marjal Revolcafango - " .. yellow .. "76, 20" .. white .. ")",
