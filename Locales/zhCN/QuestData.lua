...
kQuestInstanceData.RagefireChasm.Horde[4] = {
    ...
    Note = "你可以在 " .. yellow .. "[4]" .. white .. " 找到 巴札兰，在 " .. yellow ..
        "[3]" .. white .. " 找到 祈求者耶戈什。任务线开始于 奥格瑞玛 的大酋长 萨尔。",
    Prequest = "隐藏的敌人",
    Folgequest = "隐藏的敌人",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.BlackrockDepths.Alliance[10] = {
    ...
    Note = "这是奥妮克希亚钥匙任务线的一部分。温德索尔元帅位于 " ..
        yellow .. "[4]" .. white .. ".\n你在 " .. yellow ..
...
kQuestInstanceData.BlackrockDepths.Alliance[14] = {
    ...
    Location = "国王麦格尼·铜须 (铁炉堡 " .. yellow .. "39,55" .. white .. ")",
    Note = "铁炉堡公主茉艾拉·铜须位于 " .. yellow .. "[21]" ..
        white .. ". 在战斗中她可能会治疗达格兰。尽量打断她，但要快，因为她不能死，否则你无法完成任务！与她交谈后，你必须回到麦格尼·铜须那里。",
    Prequest = "糟糕的消息",
    Folgequest = "语出惊人的公主",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "前置任务来自 桑德哈特 (荒芜之地 - 卡加斯 " ..
        yellow ..
        "3,48" ..
        white ..
        ").\n你在 " ..
        yellow .. "[3]" .. white .. " 找到 指挥官哥沙克。打开监狱的钥匙 掉落自 审讯官格斯塔恩 " .. yellow .. "[5]" .. white ..
        ". 如果你与他交谈并开始下一个任务，敌人会出现。",
    Prequest = "不和谐的烈焰",
    Folgequest = "出了什么事？",
}
kQuestInstanceData.BlackrockDepths.Horde[14] = {
    ...
    Note = "在与 卡兰·巨锤 和 萨尔 交谈后，你获得此任务。\n你在 " .. yellow .. "[21]" ..
        white .. " 找到 达格兰·索瑞森大帝。公主会治疗达格兰，但你不能杀死她以完成任务！尽量打断她的治疗法术。",
...
kQuestInstanceData.BlackwingLair.Alliance[6] = {
    ...
    Note = "奈法利安 " ..
        yellow ..
        "[9]" .. white .. " 掉落 '沃根多尔的烧毁副本'。\n任务线开始于稀有掉落的传说物品 '艾露恩的镰刀'，掉落自首领 布莱克沃尔德勋爵二世，位于 " .. yellow .. "[卡拉赞]" ..
        white .. ".",
    Prequest = "女神的镰刀",
...
kQuestInstanceData.BlackfathomDeeps.Alliance[4] = {
    ...
    Note = "梦游者克尔里斯位于 " ..
        yellow ..
        "[8]" .. white .. "。你在 达纳苏斯 - 工匠区 (" .. yellow .. "55,24" .. white ..
...
kQuestInstanceData.BlackfathomDeeps.Alliance[6] = {
    ...
    Note = red ..
        ...
        white ..
        ": 你从 " ..
        yellow .. "[黑暗深渊]" .. white .. " 的 暮光之锤 侍僧那里获得 3 个 索兰鲁克碎片。你从 " ..
        yellow .. "[影牙城堡]" .. white .. " 的 影牙 黑暗灵魂那里获得 索兰鲁克宝珠的大碎片。",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.BlackfathomDeeps.Horde[4] = {
    ...
    Note = "梦游者克尔里斯位于 " ..
        yellow ..
        "[8]" .. white .. "。你在 雷霆崖 - 长者高地 (" .. yellow ..
        "70,33" .. white .. ") 找到 巴珊娜·符文图腾。\n\n注意！如果你点燃克尔里斯领主旁边的火焰，敌人会出现并攻击你。",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[1] = {
    ...
    Note = "你在 " .. yellow .. "[7]" .. white .. " 和 " ..
        yellow .. "[9]" .. white .. " 附近找到石板。\n奖励属于 '面对叶基亚'。你在 勘查员铁靴 附近找到 叶基亚。",
    Prequest = "失落的摩沙鲁石板",
    Folgequest = "面对叶基亚",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[6] = {
    ...
    Note = "为了获得 瓦罗什的魔精，你必须召唤并杀死 乌洛克 " ..
        yellow ..
        "[15]" ..
        white ..
        "。为了召唤他，你需要一根长矛和 欧莫克大王 的头颅 " ..
        yellow ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[14] = {
    ...
    Note = "锻造任务。务必在 " ..
        yellow .. "[11]" .. white .. " 的 人类遗骸 附近拾取 未淬火的板甲护手。交给 玛雷弗斯·暗锤 (冬泉谷 - 永望镇 " ..
        yellow .. "61,39" .. white .. ")。列出的奖励是后续任务的。",
    Folgequest = "炽热板甲护手",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[1] = {
    ...
    Note = "你在竞技场后的房间 " ..
        yellow .. "[7]" .. white .. " 找到 奥比。她站在一个突出的岩石上。\n哈尔琳 在 冬泉谷 (" .. yellow .. "54,51" .. white ..
        ")。使用洞穴尽头的传送门标志到达她那里。",
    Folgequest = "蓝龙之怒",
}
...
kQuestInstanceData.BlackrockSpireUpper.Horde[5] = {
    ...
    Location = "暗法师薇薇安·拉格雷 (荒芜之地 - 卡加斯 " .. yellow .. "2,47" .. white .. ")",
    Note = "你从 幽暗城 - 炼金房 (" .. yellow ..
        "50,68" .. white .. ") 的 药剂师金格 那里获得前置任务。\n\n黑暗石板 在 " .. yellow .. "[3]" .. white .. " 的一个箱子里。",
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "普希林 在 厄运之槌 " ..
        ...
        "东" ..
        white ..
        " 的 " .. yellow .. "[1]" .. white .. "。他会在你与他交谈时逃跑，但在以下地点会停下来战斗：" .. yellow ..
...
kQuestInstanceData.DireMaulEast.Alliance[2] = {
    ...
    Note = "蕾瑟塔蒂丝 在 厄运之槌 " .. yellow .. "东" .. white .. " 的 " .. yellow .. "[3]" .. white ..
        "。前置任务来自 铁炉堡 的 信使落锤。他在整个城市巡逻。",
    Prequest = "羽月要塞",
    Rewards = {
        Text = "奖励：",
...
kQuestInstanceData.DireMaulEast.Horde[2] = {
    ...
    Note = "蕾瑟塔蒂丝 在 厄运之槌 " .. yellow .. "东" .. white .. " 的 " .. yellow ..
        "[3]" .. white .. "。前置任务来自 奥格瑞玛 的 公告员高拉克。他在整个城市巡逻。",
    Prequest = "莫沙彻营地",
...
kQuestInstanceData.DireMaulNorth.Alliance[4] = {
    ...
    Note = "王子 在 厄运之槌 " ..
        yellow .. "西" .. white .. " 的 " .. yellow .. "[7]" .. white ..
        "。护手在他附近的一个箱子里。你只能在完成“戈多克贡品”之后，并且拥有“戈多克大王”增益效果时才能接受此任务。",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.DireMaulWest.Alliance[17] = {
    ...
    Note = red .. "战士或圣骑士任务。" ..
        white .. " 交给 博学者莱德罗斯 (厄运之槌 - 西 或 北 " .. yellow .. "[1] 图书馆" .. white .. ")。完成此任务可以开始 奎尔塞拉 的任务。",
    Folgequest = "铸造奎尔塞拉",
}
...
kQuestInstanceData.MoltenCore.Alliance[3] = {
    ...
    Note = "雷霆之怒，逐风者的祝福之剑 任务链的一部分。在从 " ..
        ...
        "[6]" ..
        white ..
        " 的 迦顿男爵 处获得左侧或右侧 逐风者禁锢镣铐 后开始。然后与 大领主德米提恩 交谈开始任务链。火焰之王的精华 从 " ..
...
kQuestInstanceData.OnyxiasLair.Alliance[2] = {
    ...
    Attain = 60,
    Aim = "把8章《龙语傻瓜教程》的章节用魔法书封面合起来，然后把完整的《龙语傻瓜教程：第二卷》交给塔纳利斯的纳瑞安。",
    Location = "纳瑞安 (塔纳利斯 " .. yellow .. "65, 18" .. white .. ")" .. "龙语傻瓜教程 (掉落自 奥妮克希亚 " .. yellow .. "[3]" ..
        white .. ")",
...
kQuestInstanceData.OnyxiasLair.Horde[3] = createInheritedQuest(
    kQuestInstanceData.OnyxiasLair.Alliance[3],
    {
        ...
        Note = "萨尔 位于 (奥格瑞玛 - 精灵谷 " ..
            yellow .. "31, 37" .. white .. ")。团队中只有一个人可以拾取此物品，任务只能完成一次。\n列出的奖励是后续任务的。",
        Folgequest = "万众敬仰",
    }
)
...
kQuestInstanceData.ShadowfangKeep.Alliance[2] = {
    ...
    Note = red ..
        ...
        white ..
        ": 你从 " ..
        yellow .. "[黑暗深渊]" .. white .. " 的 黑暗深渊侍僧 那里获得 3块 索兰鲁克碎片。你从 " ..
        yellow .. "[影牙城堡]" .. white .. " 的 影牙黑暗之魂 那里获得 索兰鲁克宝珠的大碎片。",
    Rewards = {
        Text = "奖励：任选其一",
        { id = 6898 },  --Orb of Soran'ruk Held In Off-hand
        { id = 15109 }, --Staff of Soran'ruk Staff
...
kQuestInstanceData.Stratholme.Alliance[6] = {
    ...
    Note = "你从 提里奥·弗丁 (西瘟疫之地 " .. yellow .. "7,43" .. white .. ") 那里获得前置任务。你可以在 " .. yellow .. "[10]" ..
        white .. " 附近找到这幅画。",
    Prequest = "救赎 -> 爱与家庭",
    Folgequest = "寻找麦兰达",
}
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Note = "你从 马杜克镇长 (西瘟疫之地 - 凯尔达隆 " ..
        yellow ..
        "70,73" ..
        white .. ") 那里获得前置任务。你可以在 " .. yellow .. "[19]" .. white .. " 附近找到标志。另见: 通灵学院 中的 " ..
...
kQuestInstanceData.Stratholme.Alliance[19] = {
    ...
    Note = "灰烬使者战袍 掉落自 大十字军战士达索汉 " ..
        yellow .. "[11]" .. white .. ", 亚历山德罗斯的披风 掉落自 瑞文戴尔男爵" ..
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "温诺希斯的毒囊 掉落自 High priest Venoxis in " ..
        yellow .. "祖尔格拉布" .. white ..
...
kQuestInstanceData.TheStockade.Alliance[7] = {
    ...
    Note = "你可以在副本入口对面房间的 密封的公文箱 " ..
        ...
        "[1]" ..
        white ..
        " 中找到 马丁·柯林斯的信息。\n任务链开始于 高级指挥官莱西 (湿地 - 鹰守堡 " .. yellow ..
        "36.4,67.3" .. white .. " 帐篷下) 的任务 '揭开谜团'\n完成任务链的最后一个任务后你将获得奖励。",
    Prequest = "罗比的报告",
    Folgequest = "调查柯林斯",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.TheSunkenTemple.Alliance[2] = {
    ...
    Note = "前置任务 '穆尔金和拉瑞安' 开始于 穆尔金 (安戈洛环形山 - 马绍尔营地 " .. yellow ..
        "42,9" .. white .. ")。你可以从神庙中的 深渊潜伏者, 黑暗蠕虫 或 软泥怪 身上获得阿塔莱之雾。",
...
kQuestInstanceData.TheSunkenTemple.Alliance[5] = {
    ...
    Note = "任务线开始于同一个NPC的 '尖啸者的灵魂' (见 " ..
        ...
        ")。\n你必须在 " ..
        yellow .. "[3]" .. white ..
        " 使用卵来开始事件。一旦开始，敌人就会出现并攻击你。其中一些会掉落哈卡之血。用这些血你可以熄灭圆圈周围的火炬。之后 哈卡的化身 会出现。杀死他并拾取 '哈卡精华'，用它来填满卵。",
...
kQuestInstanceData.TheSunkenTemple.Alliance[7] = {
    ...
    Note = "你可以在 伊兰尼库斯的阴影 所在的 " ..
        ...
        "不要" ..
        white ..
        "  出售或扔掉奖励饰品 被禁锢的伊兰尼库斯精华。你在 伊萨里奥斯 (悲伤沼泽 - 伊萨里奥斯洞穴 " ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[13] = {
    ...
    Location = "奥汀克 (艾萨拉 " .. yellow .. "42,43" .. white .. ")",
    Note = red ..
        "仅限牧师" .. white .. ": 摩弗拉斯 位于 " .. yellow .. "[5]" ..
        white .. "。 格雷塔·苔蹄 位于 费伍德森林 - 翡翠圣地 (" .. yellow .. "51,82" .. white .. ")。",
...
kQuestInstanceData.TheSunkenTemple.Alliance[14] = {
    ...
    Note = red ..
        "仅限盗贼" ..
        white ..
        ": 碧蓝钥匙 掉落自 摩弗拉斯，位于 " .. yellow .. "[5]" .. white .. "。 乔拉齐·拉文霍德公爵 位于 奥特兰克山脉 - 拉文霍德 (" ..
        yellow .. "86,79" .. white .. ")。",
    Prequest = "简单的要求 -> 密文碎片",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.ZulFarrak.Alliance[3] = {
    ...
    Note = "前置任务开始于 克拉兹克 (荆棘谷 - 藏宝海湾 " .. yellow ..
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Note = "前置任务来自 加克希姆·尘链 (石爪山脉 " ..
        ...
        white ..
        "。 3005-B 位于 " ..
        yellow .. "[3]" .. white .. "， 3005-C 位于 " .. yellow .. "[5]" .. white .. " ， 3005-D 位于 " ..
        yellow .. "[6]" .. white .. "。",
    Prequest = "卡斯派普的任务",
    Rewards = {
        Text = "奖励：",
...
kQuestInstanceData.Gnomeregan.Horde[7] = {
    ...
    Note = "前置任务 '马尔科维奇教授' 开始于 技术员斯帕兹奥(杜隆塔尔 - 怒水港 " .. yellow .. "57.4,25.8" .. white ..
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[3] = {
    ...
    Location = "勘察员塔雷·石镐 (奥特兰克山脉 " .. yellow .. "41,80" .. white .. ") 和\n(奥特兰克山谷 - 北 " .. yellow .. "[B]" .. white ..
        ")",
    Note = "德雷克塔尔 在 (奥特兰克山谷 - 南 " .. yellow .. "[B]" ..
        white .. ")。实际上不需要杀死他来完成任务。只需要你的一方以任何方式赢得战场。\n交还此任务后，再次与NPC交谈以获得奖励。",
    Folgequest = "雷矛英雄",
    Rewards = {
        Text = "奖励：任选其一",
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[3] = {
    ...
    Note = "范达尔·雷矛 在 (奥特兰克山谷 - 北 " .. yellow .. "[B]" ..
        white .. ")。实际上不需要杀死他来完成任务。只需要你的一方以任何方式赢得战场。\n交还此任务后，再次与NPC交谈以获得奖励。",
    Folgequest = "霜狼英雄",
...
kQuestInstanceData.HateforgeQuarry.Alliance[3] = {
    ...
    Note = "任务线开始于 拉德根·深焰，任务 '获得奥瓦克的信任' (燃烧平原 - 黑石小径 " .. yellow ..
...
kQuestInstanceData.HateforgeQuarry.Horde[6] = {
    ...
    Note = "杀死 最后的首领 哈格什末日召唤者 " ..
        yellow .. "[5]" .. white .. "。\n任务线开始于 瓦尔盖克议员 (燃烧平原 - 卡方要塞 " .. yellow .. "90.0,22.7" ..
        white .. " 燃烧平原东北角)，任务 '新与旧之一'。",
...
kQuestInstanceData.GilneasCity.Alliance[8] = {
    ...
    Note = red ..
        "(珠宝加工：仅限金匠)" ..
        white ..
        " 前置任务来自 梅瓦·托格维尤 (铁炉堡 - 探险者大厅 " .. yellow .. "60,24" .. white ..
...
kQuestInstanceData.GilneasCity.Horde[2] = {
    ...
    Location = "乔舒·埃博米尔 (吉尔尼斯 - 埃博米尔农场 " .. yellow ..
        "[49.5,31.1]" .. white .. ")。进入吉尔尼斯大门后，沿着左侧（东侧）的山脉走，在有风车的田野里你会找到乔舒·埃博米尔。",
...
kQuestInstanceData.LowerKarazhan.Alliance[15] = {
    ...
    Note = red ..
        "法师，牧师，术士，仅德鲁伊" .. white .. ":\n任务线开始于传说物品 '艾露恩的镰刀'，掉落自布莱克沃尔德勋爵二世 " .. yellow .. "[5]" .. white ..
        " (低几率)。\n传说饰品任务线。",
    Folgequest = "女神的镰刀",
}
...
kQuestInstanceData.TowerofKarazhan.Alliance[6] = {
    ...
    Note = red .. "仅德鲁伊" .. white .. ": 博学者莱德罗斯 (厄运之槌 - 西 或 北 " .. yellow ..
...
kQuestInstanceData.TowerofKarazhan.Alliance[7] = {
    ...
    Note = "《沃根多尔：鲜血维度的神话》 (入口附近) 包含任务物品。\n" .. white .. "[女神的镰刀] 前置任务开始于艾露恩的镰刀，掉落自布莱克伍德公爵二世 " ..
        yellow .. "(下层卡拉赞大厅 [5]).",
    Prequest = "女神的镰刀",
    Folgequest = "女神的镰刀",
}
