...
AtlasTW.Localization:RegisterNamespace("Bosses", "enUS", {
    ...
    ["Duhng"] = true,
    ["Mudduk"] = true,
    ["Derak Nightfall"] = true,
    ["Alegorn"] = true,
    ["Pyall Silentstride"] = true,
    ["Zamja"] = true,
    ["Eunice Burch"] = true,
    ["Shandrina"] = true,
    ["Wulan"] = true,
    ...
    ["Kalvan Fencer"] = true,
    ["Jarkal Mossmeld"] = true,
    ["The Artificer"] = true,
    ["Gulmire Fartower"] = true,
    ["Mayva Togview"] = true,
    -- Survival (TW custom)
    ["Rufus Hardwick"] = true,
    ...
    ["Faruza"] = true,
    ["Flora Silverwind"] = true,
    ["Mishiki"] = true,
    ["Aranae Venomblood"] = true,
    ["Cylania Rootstalker"] = true,
    ["Brant Jasperbloom"] = true,
    ["Malorne Bladeleaf"] = true,
    ["Angrun"] = true,
