...
local loc = GetLocale()
if loc == "esES" or loc == "ptBR" or loc == "deDE" or loc == "zhCN" then return end
...
kQuestInstanceData.TheDeadmines.Alliance[1] = {
    ...
    Note =
    "You can get the Red Silk Bandanas from miners in the Deadmines or the in the town where the instance is located. The quest becomes available after you complete the The Defias Brotherhood questline up to the part where you have to kill Edwin VanCleef.",
...
kQuestInstanceData.TheDeadmines.Alliance[2] = {
    ...
    Note = "The cards drop off undead mobs outside the instance in the area near " ..
        yellow .. "[3]" .. white .. " on the Entrance map.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.TheDeadmines.Alliance[3] = {
    ...
    Location = "Wilder Thistlenettle (Stormwind - Dwarven District " .. yellow .. "65,21" .. white .. ")",
    Note = "Foreman Thistlenettle is found outside the instance in the undead area at " ..
        yellow .. "[3]" .. white .. " on the Entrance map.",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.TheDeadmines.Alliance[4] = {
    ...
    Note = "The prequest can be obtained from Gnoarn (Dun Morogh - Gnomeregan Reclamation Facility " ..
        yellow ..
...
kQuestInstanceData.TheDeadmines.Alliance[5] = {
    ...
    Note = "You start this Questline at Gryan Stoutmantle (Westfall - Sentinel Hill " ..
        yellow ..
        "56,47" ..
        white ..
        ").\nEdwin VanCleef is the last boss of The Deadmines. You can find him at the top of his ship " ..
        yellow .. "[6]" .. white .. ".",
    Prequest = "The Defias Brotherhood",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.TheDeadmines.Alliance[6] = {
    ...
    Note = red ..
        "Paladin only" .. white ..
        ": To see the note click on " .. yellow .. "[The Test of Righteousness Information]" .. white .. ".",
...
kQuestInstanceData.TheDeadmines.Alliance[8] = {
    ...
    Note = "You start this Questline on the northwest island in Westfall; Red book on the ground " ..
...
kQuestInstanceData.TheDeadmines.Horde[2] = {
    ...
    Aim = "End Cookie, bring Grayson's Pendant",
    Location = "Captain Grayson (Westfall - Lighthouse " .. yellow .. "30,86" .. white .. ")",
    Note = "You start this Quest line on the northwest island in Westfall; Red book on the ground " ..
        yellow .. "26.1,16.5" .. white .. ").\n",
    Prequest = "Food for Sailing Thoughts?",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.TheDeadmines.Horde[3] = {
    ...
    Note = "You start this Questline at Nargal Deatheye (Crossroads " ..
        yellow ..
        "51.2,29.1" ..
        white ..
        ").\nThis quest " ..
        red ..
        "JUST TELEPORTS you to WESTFALL" ..
        white ..
        ". You can either finish this quest and get the reward after completing questline or use it as westfall teleport retaking the quest.",
...
kQuestInstanceData.WailingCaverns.Alliance[2] = {
    ...
    Note =
        "You get the bottle right before you go into the instance by killing Mad Magglish. When you first enter the cave make an immediate right to find him at the end of the passage. He is stealthed by the wall at " ..
        yellow .. "[2] on the Entrance Map" .. white .. ".",
}
...
kQuestInstanceData.WailingCaverns.Alliance[4] = {
    ...
    Note =
    "Ebru is in a hidden cave above the cave entrance. Easiest way to him seems to be to run up the hill outside and behind the entrance and drop down the slight ledge above the cave entrance.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.WailingCaverns.Horde[3] = {
    ...
    Note =
        "Apothecary Zamah is in a cave under the Spirit Rise.  You get the prequest from Apothecary Helbrim (Barrens - Crossroads " ..
        yellow ..
        "51,30" ..
        white ..
        ").\nYou get the Serpentbloom inside the cave in front of the instance and inside the instance. Players with Herbalism can see the plants on their minimap.",
...
kQuestInstanceData.WailingCaverns.Horde[6] = {
    ...
    Note = "The Questline starts at Hamuul Runetotem (Thunder Bluff - Elder Rise " ..
        yellow ..
        "78,28" ..
        white ..
        ")\nThe 4 druids drop the gems " ..
        yellow .. "[2]" .. white .. ", " .. yellow ..
...
kQuestInstanceData.WailingCaverns.Horde[8] = {
    ...
    Level = 18,
    Attain = 14,
    Aim = "Bring Chok'Garok 5 pieces of Moontouched Wood" ..
        yellow .. "trash" .. white .. ", a Crystal of the Serpent, and an Everchanging Essence from Wailing Caverns.",
    Location = "Chok'Garok <Stonemaul Clan> (on a bank of Southfury River in the Barrens " ..
        yellow .. "62.4,10.8" .. white .. ")",
    Note = red ..
        "Mage ONLY." ..
        white ..
        " The Questline starts at Ureda <Mage Trainer> (Orgrimar) with quest 'Mastering the Arcane'.\nMoontouched Wood you get from " ..
        yellow ..
        "trash" ..
        white ..
        ", a Crystal of the Serpent from Lord Serpentis <Fanglord>" ..
        yellow .. "[7]" .. white .. ", and an Everchanging Essence from Lord Pythas <Fanglord> " .. yellow ..
        "[5]" .. white .. ".",
...
kQuestInstanceData.RagefireChasm.Horde[3] = {
    ...
    Location = "Rahauro (Thunder Bluff - Elder Rise " .. yellow .. "70,29" .. white .. ")",
    Note = "You find Maur Grimtotem at " ..
        yellow .. "[1]" .. white .. ". After getting the satchel you must bring it back to Rahauro in Thunder Bluff",
...
kQuestInstanceData.RagefireChasm.Horde[4] = {
    ...
    Note = "You find Bazzalan at  " ..
        yellow ..
        "[4]" .. white .. " and Jergosh at " ..
        yellow .. "[3]" .. white .. ". The questline starts at Warchief Thrall in Orgrimmar.",
...
kQuestInstanceData.Uldaman.Alliance[1] = {
    ...
    Note = "The Prequest starts at the Crumpled Map (Badlands " ..
        yellow ..
        "53,33" ..
        white ..
        ").\nYou find Hammertoe Grez before you enter the instance, at " .. yellow .. "[1]" .. white ..
        " on the Entrance map.",
...
kQuestInstanceData.Uldaman.Alliance[5] = {
    ...
    Note = "The Prequest starts at Prospector Stormpike (Ironforge - Hall of Explorers " ..
...
kQuestInstanceData.Uldaman.Alliance[6] = {
    ...
    Note =
        "The tablet is north of the caves, at the east end of a tunnel, before the instance. On the Entrance map, it's at " ..
        yellow .. "[3]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "The Hidden Chamber is at " ..
        yellow ..
        "[4]" ..
        white ..
        ". To open the Hidden Chamber you need The Shaft of Tsol from Revelosh " ..
        yellow ..
        "[3]" ..
        white ..
        " and the Gni'kiv Medallion from Baelog's Chest " ..
        yellow ..
        "[1]" ..
        white ..
        ". Combine these two items to form Staff of Prehistoria. The Staff is used in the Map Room between " ..
        yellow ..
        "[3] and [4]" ..
        white .. " to summon Ironaya. After killing her, run inside the room she came from to get quest credit.",
...
kQuestInstanceData.Uldaman.Alliance[11] = {
    ...
    Note = "The gems are at " ..
        ...
        "[8]" ..
        white ..
        " from the Shadowforge Cache, and " ..
        yellow ..
        "[9]" ..
        white ..
        " off Grimlok. Note that when openning the Shadowforge Cache, a few mobs will spawn an aggro you.\nUse Talvash's Scrying Bowl to turn the quest in and get the followup.",
...
kQuestInstanceData.Uldaman.Alliance[14] = {
    ...
    Note =
        "You find the treasure before you enter the instance. It is in the north of the caves, at the southeast end of the first tunnel. On the entrance map, it's at " ..
        yellow .. "[4]" .. white .. ".",
}
kQuestInstanceData.Uldaman.Alliance[15] = {
    ...
    Attain = 40,
    Aim =
    "Speak with stone watcher and learn what ancient lore it keeps. Once you have learned what lore it has to offer, activate the Discs of Norgannon. -> Take the miniature version of the Discs of Norgannon to the Explorers' League in Ironforge.",
    Location = "The Discs of Norgannon (Uldaman " .. yellow .. "[11]" .. white .. ")",
    Note =
        "After you receive the quest, speak to the stone watcher to the left of the discs.  Then use the platinum discs again to recieve miniature discs, which you'll have to take to High Explorer Magellas in Ironforge - Hall of Explorers (" ..
        yellow .. "69,18" .. white .. "). The followup starts another NPC who is nearby.",
...
kQuestInstanceData.Uldaman.Alliance[16] = {
    ...
    Note = red ..
        "Mage only" .. white .. ": The Obsidian Power Source drops from the Obsidian Sentinel at " ..
        yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Alliance[17] = { --1.18
    ...
    Location = "Torble Sparksprocket (The Barrens " ..
        yellow .. "48.6,83" .. white .. " gnome with purple goggles under the tent, next to the dwarf)",
    Note = "Intact Power Core " ..
        yellow ..
        "[11]" ..
        white ..
        ", in the room with platinum disc behind the last boss in the chest behind the right pillar.\nQuestline starts in Southern Barrens -> Bael Modan -> a little north from the path to Bael'dun Keep under the tent. First quest can be attain at lvl 18, last at lvl 53",
...
kQuestInstanceData.Uldaman.Horde[6] = {
    ...
    Note = "The gems are at " ..
        ...
        "[9]" ..
        white ..
        " off Grimlok. Note that when openning the Shadowforge Cache, a few mobs will spawn an aggro you. The Shattered Necklace Power Source drops from Archaedas " ..
        yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Horde[7] = {
    ...
    Note =
    "You get the Prequest from Jarkal Mossmeld, too.\nThe caps are scattered throughout the instance. Herbalists can see them on their minimap if Track Herbs is on and they have the quest.",
    Prequest = "Badlands Reagent Run",
...
kQuestInstanceData.Uldaman.Horde[8] = {
    ...
    Note =
        "You find the treasure before you enter the instance. It is at the end of the south tunnel. On the entrance map, it's at " ..
        yellow .. "[5]" .. white .. ".",
}
kQuestInstanceData.Uldaman.Horde[9] = createInheritedQuest(
    ...
    {
        Aim =
        "Speak with stone watcher and learn what ancient lore it keeps. Once you have learned what lore it has to offer, activate the Discs of Norgannon. -> Take the miniature version of the Discs of Norgannon to the one of the sages in Thunder Bluff.",
        Note =
            "After you receive the quest, speak to the stone watcher to the left of the discs.  Then use the platinum discs again to recieve miniature discs, which you'll have to take to Sage Truthseeker in Thunder Bluff (" ..
            yellow .. "34,46" .. white .. "). The followup starts another NPC who is nearby.",
    }
)
...
kQuestInstanceData.BlackrockDepths.Alliance[1] = {
    ...
    Note =
        "Franclorn is in the middle of the blackrock, above his grave. You have to be dead to see him! Talk 2 times with him to start the quest.\nFineous Darkvire is at " ..
        yellow .. "[9]" .. white .. ". You find the Shrine next to the arena " .. yellow .. "[7]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[2] = {
    ...
    Note = "You get the prequest from Yorba Screwspigot (Tanaris - Steamwheedle Port " ..
...
kQuestInstanceData.BlackrockDepths.Alliance[3] = {
    ...
    Note =
        "You get the Giant Silver Veins from Giants in Azshara. Gromsblood can be most easily acquired from either an herbalist or at the Auction House. Lastly, the vial can be filled at the Go-Lakka crater (Un'Goro Crater " ..
        yellow ..
...
kQuestInstanceData.BlackrockDepths.Alliance[4] = {
    ...
    Note = "You get the prequest from Enohar Thunderbrew (Blasted Lands - Nethergarde Keep " ..
        yellow ..
        "61,18" ..
        white ..
        ").\nYou get the recipe from one of the guards who appear if you destroy the ale " ..
        yellow .. "[15]" .. white ..
        ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[6] = {
    ...
    Note = "You find the Heart at " ..
        yellow ..
        "[8]" ..
        white ..
        " in a safe. You get the key for the safe from Warder Stillgiss. He appears after opening all small safes.",
}
...
kQuestInstanceData.BlackrockDepths.Alliance[8] = {
    ...
    Note =
        "This is part of the Onyxia attunement questline. It starts at Helendis Riverhorn (Burning Steppes - Morgan's Vigil " ..
        yellow ..
        "85,68" ..
        white ..
        ").\nMarshal Windsor is at " ..
        yellow .. "[4]" .. white .. ". You have to come back to Maxwell after completing this quest.",
...
kQuestInstanceData.BlackrockDepths.Alliance[9] = {
    ...
    Note = "This is part of the Onyxia attunement questline. Marshal Windsor is at " ..
        yellow .. "[4]" .. white .. ". Best chance for drops seems to be the Dark Iron mobs around the Quarry.",
...
kQuestInstanceData.BlackrockDepths.Alliance[10] = {
    ...
    Note = "This is part of the Onyxia attunement questline. Marshal Windsor is at " ..
        ...
        "[4]" ..
        white ..
        ".\nYou find Golem Lord Argelmach at " ..
        yellow .. "[14]" .. white .. ", General Angerforge at " .. yellow .. "[13]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[11] = {
    ...
    Note = "This is part of the Onyxia attunement questline. Marshal Windsor is at " ..
        ...
        "[4]" ..
        white ..
        ".\nThe quest is easier if you clean the Ring of Law (" ..
        yellow ..
        "[6]" ..
        white ..
        ") and the path to the entrance before you start the event. You find Marshal Maxwell at Burning Steppes - Morgan's Vigil (" ..
        yellow .. "84,68" .. white .. ")",
...
kQuestInstanceData.BlackrockDepths.Alliance[12] = {
    ...
    Level = 58,
    Attain = 52,
    Aim = "Travel to Blackrock Depths and slay Bael'Gar. " ..
        yellow .. "[11]" .. white .. " Return the Encased Fiery Essence to Cyrus Therepentous.",
    Location = "Cyrus Therepentous (Burning Steppes " .. yellow .. "94,31" .. white .. ")",
    Note = "The questline starts at Kalaran Windblade (Searing Gorge " ..
...
kQuestInstanceData.BlackrockDepths.Alliance[13] = {
    ...
    Note = "The prequest starts at Royal Historian Archesonus (Ironforge " ..
        yellow .. "38,55" .. white .. "). Kharan Mighthammer is at " .. yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[14] = {
    ...
    Location = "King Magni Bronzebeard (Ironforge " .. yellow .. "39,55" .. white .. ")",
    Note = "Princess Moira Bronzebeard is at " ..
        yellow ..
        "[21]" ..
        white ..
        ". During the fight she might heal Dagran. Try to interrupt her as often as possible, but hurry as she must not die or you can't complete the quest! After talking to her you have to return to Magni Bronzebeard.",
...
kQuestInstanceData.BlackrockDepths.Alliance[15] = {
    ...
    Note =
        "After completing this quest, you can use the stone next to Lothos Riftwaker to enter the Molten Core.\nYou find the Core Fragment near " ..
        yellow .. "[23]" .. white .. ", very close to the Molten Core portal.",
}
kQuestInstanceData.BlackrockDepths.Alliance[16] = {
    ...
    Note =
    "Followup quest is different for each class. Entire questline starts with quest 'An Earnest Proposition' from Deliana Ironforge Kings room behid The Bank",
...
kQuestInstanceData.BlackrockDepths.Alliance[17] = {
    ...
    Note = red ..
        "Only Miners with skill 230 or higher can get this quest to learn Smelt Dark Iron." ..
        white ..
        " Materials for the Chalice: 2 [Star Ruby], 20 [Gold Bar], 10 [Truesilver Bar]. Afterwards, if you have [Dark Iron Ore] you can take it to The Black Forge at " ..
        yellow .. "[22]" .. white .. " and Smelt it.",
}
kQuestInstanceData.BlackrockDepths.Alliance[18] = {
    ...
    Note = "Questline starts at Bixxle Screwfuse (Tel'Abim " ..
        yellow ..
        "52,34" ..
        white ..
        "). Drop from Darneg Darkbeard. Rewards from Operation Final Repairs(Necks) quest and the final quest - The Dark Iron Desecrator(Gun).",
    Prequest = "Operation Screwfuse 1000 -> Operation FIX Screwfuse 1000",
    Folgequest =
    "Operation Help Jabbey 2 -> Operation Return to Screwfuse -> Operation Final Repairs ->Secrets of the Dark Iron Desecrator -> The Dark Iron Desecrator",
    Rewards = {
...
kQuestInstanceData.BlackrockDepths.Alliance[19] = {
    ...
    Level = 60,
    Attain = 55,
    Aim = "I need a Magma Condensor from within Blackrock Depths, you can find it near the Golem Laboratory " ..
        yellow .. "[25]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[20] = {
    ...
    Location = "Orvak Sternrock (after Redridge Mountains - Burning Steppes pass " ..
        yellow .. "76,68" .. white .. ", west from alliance camp)",
...
kQuestInstanceData.BlackrockDepths.Alliance[21] = {
    ...
    Level = 55,
    Attain = 45,
    Aim = "Find, and collect an Arcane Golem Core from Golem Lord Argelmach " ..
        yellow .. "[14]" ..
        white .. " in Blackrock Depths and return to Radgan Deepblaze at Blackrock Pass in Burning Steppes.",
    Location = " Radgan Deepblaze (after Redridge Mountains - Burning Steppes pass " ..
        yellow .. "76,68" .. white .. ", west from alliance camp)",
    Note = "This questline starts at Radgan Deepblaze next to Orvak Sternrock with quest 'Gaining Orvak's Trust'",
    Prequest =
    "Gaining Orvak's Trust -> Hearing Orvak's Story -> The Sternrock Stash -> Discovering Golem Secrets -> To Purchase Secret Information",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.BlackrockDepths.Alliance[23] = {
    ...
    Note = red ..
        "AVAILABLE ONLY while Winter Veil Holiday Event is active!" ..
        white ..
        "Those dastardly Dark Irons stole it, no doubt hidden away in their tavern " ..
        yellow .. "[15]" .. white .. " deep within the Blackrock Depths.",
}
for i = 1, 3 do
...
kQuestInstanceData.BlackrockDepths.Horde[4] = {
    ...
    Note = "You get the prequest from Apothecary Zinge in Undercity - The Apothecarium (" ..
        yellow ..
        "50,68" ..
        white ..
        ").\nYou get the recipe from one of the guards who appear if you destroy the ale " ..
    ...
    Rewards = {
        Text = "Reward: 1 and 2 and 3 or 4",
        { id = 3928, quantity = 5 }, --Superior Healing Potion Potion
        { id = 6149, quantity = 5 }, --Greater Mana Potion Potion
        { id = 11964 },              --Swiftstrike Cudgel Main Hand, Mace
        { id = 12000 },              --Limb Cleaver Two-Hand, Axe
...
kQuestInstanceData.BlackrockDepths.Horde[6] = {
    ...
    Attain = 48,
    Aim =
    "Venture to Blackrock Depths and destroy the vile aggressors! Warlord Goretooth wants you to kill 15 Anvilrage Guardsmen, 10 Anvilrage Wardens and 5 Anvilrage Footmen. Return to him once your task is complete.",
    Location = "Sign Post (Badlands - Kargath " .. yellow .. "3,47" .. white .. ")",
    Note =
        "You find the dwarves in the first part of Blackrock Depths.\nYou find Warlord Goretooth in Kargath at the top of the tower (Badlands, " ..
        yellow .. "5,47" .. white .. ").",
...
kQuestInstanceData.BlackrockDepths.Horde[7] = {
    ...
    Attain = 50,
    Aim =
    "Venture to Blackrock Depths and destroy the vile aggressors! Warlord Goretooth wants you to kill 10 Anvilrage Medics, 10 Anvilrage Soldiers and 10 Anvilrage Officers. Return to him once your task is complete.",
    Location = "Sign Post (Badlands - Kargath " .. yellow .. "3,47" .. white .. ")",
    Note = "You find the dwarves near Bael'Gar " ..
        yellow ..
        "[11]" ..
        white ..
        ". You find Warlord Goretooth in Kargath at the top of the tower (Badlands, " ..
        ...
        "5,47" ..
        white ..
        ").\n The followup quest starts at Lexlort (Badlands - Kargath " ..
        yellow ..
        "5,47" ..
        white ..
        "). You find Grark Lorkrub in the Burning Steppes (" ..
        yellow .. "38,35" .. white .. "). You have to reduce his life below 50% to bind him and start a Escort quest.",
...
kQuestInstanceData.BlackrockDepths.Horde[9] = {
    ...
    Note = "You get the prequest from Hierophant Theodora Mulvadania (Badlands - Kargath " ..
...
kQuestInstanceData.BlackrockDepths.Horde[12] = {
    ...
    Location = "Shadowmage Vivian Lagrave (Badlands - Kargath " .. yellow .. "2,47" .. white .. ")",
    Note = "You get the prequest from Thunderheart (Badlands - Kargath " ..
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "You get the prequest from Thunderheart (Badlands - Kargath " ..
        ...
        "3,48" ..
        white ..
        ").\nYou find Commander Gor'shak at " ..
        yellow ..
        "[3]" ..
        white ..
        ". The key to open the prison drops from High Interrogator Gerstahn " ..
        yellow .. "[5]" .. white .. ". If you talk to him and start the next Quest enemys appears.",
    Prequest = "Disharmony of Flame",
...
kQuestInstanceData.BlackrockDepths.Horde[14] = {
    ...
    Note =
        "After talking a with Kharan Mighthammer and Thrall you get this quest.\nYou find Emperor Dagran Thaurissan at " ..
        yellow ..
        "[21]" ..
        white ..
        ". The Princess heals Dagran but you must not kill her to complete the quest! Try to interrupt her healing spells. (Rewards are for The Princess Saved?)",
...
kQuestInstanceData.BlackwingLair.Alliance[1] = {
    ...
    Note = "Only one person can loot the Shard. Anachronos (Tanaris - Caverns of Time " .. yellow .. "65,49" ..
        white .. ")",
...
kQuestInstanceData.BlackwingLair.Alliance[2] = {
    ...
    Note = "Highlord Bolvar Fordragon is at (Stormwind City - Stormwind Keep " ..
        yellow ..
        "78,20" ..
        white ..
        "). The follow up sends you to Field Marshal Afrasiabi (Stormwind - Valley of Heroes " ..
        yellow .. "67,72" .. white .. ") for the reward.",
...
kQuestInstanceData.BlackwingLair.Alliance[4] = {
    ...
    Note = "Chapter can be looted by multiple people. Draconic for Dummies (looted from a table " ..
        green .. "[2']" .. white .. ")",
    Prequest = "Decoy!",
    Folgequest =
    "The Good News and The Bad News (Must complete Stewvul, Ex-B.F.F. and Never Ask Me About My Business quest chains)",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.BlackwingLair.Alliance[5] = {
    ...
    Note =
        "Prequest - Lord Ebonlocke (Lower Karazhan Halls). Book 'Treatise on Magical Locks and Keys' is in the last boss room " ..
        yellow .. "[9]" .. white .. ", next to the throne. Reward from the next quest.",
...
kQuestInstanceData.BlackwingLair.Alliance[6] = {
    ...
    Location = "Arch Druid Dreamwind (Hyjal - Nordanaar " .. yellow .. "84.8,29.3" ..
        white .. " top floor of the big tree)",
    Note = "Nefarian " ..
        yellow ..
        "[9]" ..
        white ..
        " drops 'Burnt Copy of Vorgendor'.\nQuestline starts with rare drop legendary item 'The Scythe of Elune' from boss Lord Blackwald II in " ..
...
kQuestInstanceData.BlackwingLair.Horde[2] = {
    ...
    Location = "Head of Nefarian (drops from Nefarian " .. yellow .. "[9]" .. white .. ")",
    Note = "The follow up sends you to High Overlord Saurfang (Orgrimmar - Valley of Strength " ..
        yellow .. "51,76" .. white .. ") for the reward.",
    Folgequest = "The Lord of Blackrock",
...
kQuestInstanceData.BlackfathomDeeps.Alliance[2] = {
    ...
    Note = "You get it from Argos Nightwhisper at (Stormwind - The Park " ..
...
kQuestInstanceData.BlackfathomDeeps.Alliance[4] = {
    ...
    Note = "Twilight Lord Kelris is at " ..
        yellow ..
        "[8]" ..
        white ..
        ". You find Dawnwatcher Selgorm in Darnassus - Craftsmen's Terrace (" ..
        yellow ..
        "55,24" ..
...
kQuestInstanceData.BlackfathomDeeps.Alliance[6] = {
    ...
    Note = red ..
        "Warlock only" ..
        white ..
        ": You get the 3 Soran'ruk Fragments from Twilight Accolytes in " ..
        yellow ..
        "[Blackfathom Deeps]" ..
        white ..
        ". You get the Large Soran'ruk Fragment in " .. yellow .. "[Shadowfang Keep]" .. white ..
        " from Shadowfang Darksouls.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.BlackfathomDeeps.Horde[1] = {
    ...
    Note = "You get the prequest Trouble in the Deeps from Tsunaman (Stonetalon Mountains - Sun Rock Retreat " ..
        yellow .. "47,64" .. white .. "). The crystals can be found in the tunnels before the instance.",
...
kQuestInstanceData.BlackfathomDeeps.Horde[2] = {
    ...
    Attain = 17,
    Aim =
    "Bring the Damp Note to Je'neu Sancrea in Ashenvale -> Kill Lorgus Jett in Blackfathom Deeps and then return to Je'neu Sancrea in Ashenvale.",
    Location = "Damp Note (drop - see note)",
    Note =
        "You get the Damp Note from Blackfathom Tide Priestess (5% drop rate). Then take it to Je'neu Sancrea (Ashenvale - Zoram'gar Outpost " ..
        yellow .. "11,33" .. white .. "). Lorgus Jett is at " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.BlackfathomDeeps.Horde[3] = {
    ...
    Location = "Je'neu Sancrea (Ashenvale - Zoram'gar Outpost " .. yellow .. "11,33" .. white .. ")",
    Note = "You find the Fathom Core at " ..
        yellow ..
        "[7]" ..
        white ..
        " in the water. When you get the core Baron Aquanis appears and attacks you. He drops a quest item which you have to take back to Je'neu Sancrea.",
}
kQuestInstanceData.BlackfathomDeeps.Horde[4] = {
    ...
    Note = "Twilight Lord Kelris is at " ..
        ...
        "[8]" ..
        white ..
        ". You find Bashana Runetotem in Thunder Bluff - The Elder Rise (" ..
        yellow ..
        "70,33" ..
        white .. "). \n\nATTENTION! If you turn on the flames beside Lord Kelris, enemies appear and attack you.",
...
kQuestInstanceData.BlackfathomDeeps.Horde[6] = {
    ...
    Note = "Using Fathom Stone " ..
        yellow ..
        "[7]" .. white .. " for the quest #3 summons Baron Aquanis. He drops Strange Water Globe that starts the quest.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[1] = {
    ...
    Note = "You find the tablets near " ..
        yellow ..
        "[7]" ..
        white ..
        " and " ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[4] = {
    ...
    Note = "Mother Smolderweb is at " ..
        yellow ..
        "[13]" ..
        white .. ". The poison effect snares nearby players as well. If it is removed or dispelled, you fail the quest.",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[6] = {
    ...
    Note = "To get Warosh's Mojo you have to evoke and kill Urok Doomhowl " ..
        yellow ..
        "[15]" ..
        white ..
        ". For his Evocation you need a Spear and Highlord Omokk's Head " ..
        yellow ..
        "[5]" ..
        white ..
        ". The Spear is at " ..
        ...
        "[3]" ..
        white ..
        ". During the Evocation a few waves of ogres appear before Urok Doomhowl attacks you. You can use the Spear during the fight to damage the ogres.",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[7] = {
    ...
    Note = "You find Bijou's Belongings on the way to Mother Smolderweb at " ..
        yellow .. "[13]" .. white .. ".\nMaxwell is at (Burning Steppes - Morgan's Vigil " .. yellow .. "84,58" ..
        white .. ").",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[8] = {
    ...
    Note = "You find War Master Voone at " ..
        yellow ..
        "[9]" ..
        white .. ", Highlord Omokk at " .. yellow .. "[5]" ..
        white .. " and Overlord Wyrmthalak at " .. yellow .. "[19]" .. white .. ".",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "You get the Gemstone of Spirestone from Highlord Omokk at " ..
        yellow ..
        "[5]" ..
        white ..
        ", the Gemstone of Smolderthorn from War Master Voone at " ..
        yellow ..
        "[9]" ..
        white ..
        " and the Gemstone of Bloodaxe from Overlord Wyrmthalak at " ..
        yellow ..
        "[19]" ..
        white ..
        ". The Unadorned Seal of Ascension can drop from near all enemys in Lower Blackrock Spire. You get the Key for Upper Blackrock Spire if you complete this questline.",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[11] = {
    ...
    Note =
        "Extra-Dimensional Ghost Revealer is needed to see Bodley. You get it from the 'In Search of Anthion' quest.\n\nMor Grayhoof is summoned at " ..
        yellow .. "[9]" .. white .. ".",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[14] = {
    ...
    Note = "Blacksmith quest. Be sure to pick up the Unfired Plate Gauntlets near the Human Remains at " ..
        yellow ..
        "[11]" ..
        white ..
        ". Turns in to Malyfous Darkhammer (Winterspring - Everlook " ..
        yellow .. "61,39" .. white .. "). Rewards listed are for the followup.",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[15] = {
    ...
    Attain = 55,
    Aim =
        "I require a Intricate Arcanite Barrel which can handle extreme heat. This can be found deep within Lower Blackrock Spire, near the Quartermaster " ..
        yellow .. "[16]" .. white .. " there.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[10] = {
    ...
    Note = "Onyxia Prequest.\nYou find Highlord Omokk at " ..
        yellow ..
        "[5]" .. white .. ", War Master Voone at " .. yellow .. "[9]" .. white .. " and Overlord Wyrmthalak at " ..
        yellow .. "[19]" .. white .. ". The Blackrock Documents could appear next to one of these 3 bosses.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[16] = {
    ...
    Note = "Kill War Master Voone " ..
        yellow ..
        "[9]" ..
        white ..
        " in Lower Blackrock Spire and bring his tusks back to Taskmaster Ok'gog at Karfang Hold in Burning Steppes.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[17] = {
    ...
    Level = 58,
    Attain = 50,
    Aim = "Slay Gizrul the Slavener " ..
        yellow .. "[17]" .. white .. " in Blackrock Spire, then report to Raider Fargosh in Karfang Hold.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[18] = {
    ...
    Note = "Slay Quartermaster Zigris " ..
        yellow .. "[16]" .. white .. " deep in the Blackrock Spire for Karfang at Karfang Hold in Burning Steppes.",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[1] = {
    ...
    Note = "You find Awbee in the room after the Arena at " ..
        yellow .. "[7]" .. white .. ". She stands on a jutty.\nHaleh is in Winterspring (" ..
        yellow .. "54,51" .. white .. "). Use the portal-sign in the end of the cave to get to her.",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[2] = {
    ...
    Note = "Finkle Einhorn spawns after skinning The Beast. You find Malyfous at (Winterspring - Everlook " ..
        yellow .. "61,38" .. white .. ").",
    Folgequest =
    "Leggings of Arcana, Cap of the Scarlet Savant, Breastplate of Bloodthirst and Shoulderguards of the Lightbringer",
}
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[6] = {
    ...
    Note = "You get the prequest from Count Remington Ridgewell (Stormwind - Stormwind Keep " ..
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[7] = {
    ...
    Note = "Last part of the Onyxia quest chain for the Alliance. You find General Drakkisath at " ..
        yellow .. "[9]" .. white .. ".",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[8] = {
    ...
    Location = "Blackhand's Command (drops from Scarshield Quartermaster " .. yellow .. "[7] on Entrance Map" ..
        white .. ")",
    Note =
        "Blackwing Lair attunement quest. Scarshield Quartermaster is found if you turn right before the LBRS/UBRS portal.\n\nGeneral Drakkisath is at " ..
        yellow .. "[9]" .. white .. ". The brand is behind him.",
}
kQuestInstanceData.BlackrockSpireUpper.Alliance[9] = {
    ...
    Location = "Bodley (Blackrock Mountain " .. yellow .. "[D] on Entrance Map" .. white .. ")",
    Note =
    "Extra-Dimensional Ghost Revealer is needed to see Bodley. You get it from the 'In Search of Anthion' quest. Blackrock Bracers drop off mobs with Blackhand in the name. Flask of Supreme Power is made by an Alchemist.",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[10] = {
    ...
    Location = "Bodley (Blackrock Mountain " .. yellow .. "[D] on Entrance Map" .. white .. ")",
    Note =
        "Extra-Dimensional Ghost Revealer is needed to see Bodley. You get it from the 'In Search of Anthion' quest. Lord Valthalak is summoned at " ..
        yellow .. "[8]" .. white .. ". Rewards listed are for Return to Bodley.",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[11] = {
    ...
    Attain = 55,
    Aim =
    "Travel to Blackrock Spire and find Goraluk Anvilcrack. Slay him and then use the Blood Stained Pike upon his corpse. After his soul has been siphoned, the pike will be Soul Stained. You must also find the Unforged Rune Covered Breastplate. Return both the Soul Stained Pike and the Unforged Rune Covered Breastplate to Lorax in Winterspring.",
...
kQuestInstanceData.BlackrockSpireUpper.Alliance[12] = {
    ...
    Level = 60,
    Attain = 55,
    Aim = "Gather a Dragonkin Charge from the Black Dragonkin(Solakar Flamewreath) " ..
        yellow .. "[2]" .. white .. " within Blackrock Spire for Parnabus in Gilneas.",
    Location = "Parnabus <Wandering Wizard> (Gilneas " ..
        yellow .. "[22.9,74.4]" .. white .. ", very south of Gilneas City, west of river. inside of a lonely house).",
    Note =
        "Highly recommend to take prequest 'The Binding of Xanthar' from Hanvar the Righteous (Deadwind Pass in the small church outside of Karazhan " ..
        yellow ..
        "[40.9,79.3]" ..
        white ..
    ...
    Folgequest = "The Upper Binding II -> The Upper Binding III " ..
        yellow .. "[Dire Maul West]" .. white .. " -> The Upper Binding IV",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillin is in Dire Maul " ..
        ...
        "[1]" ..
        white ..
        ". He runs when you talk to him, but stops and fights at " ..
        yellow .. "[2]" .. white .. ". He'll drop the Crescent Key which is used for Dire Maul North and West.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.DireMaulEast.Alliance[2] = {
    ...
    Note = "Lethtendris is in Dire Maul " ..
        yellow ..
        "East" ..
        white ..
        " at " ..
        yellow ..
        "[3]" .. white .. ". The prequest comes from Courier Hammerfall in Ironforge. He roams the entire city.",
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "You find Alliz the Wildshaper in the " ..
        yellow ..
        "East" ..
        white ..
        " part of Dire Maul at " ..
        yellow ..
        "[5]" ..
        white ..
        ". The relict is in Silithius at " .. yellow .. "62,54" .. white ..
        ". The prequest comes from Rabine Saturna as well.",
...
kQuestInstanceData.DireMaulEast.Alliance[5] = {
    ...
    Attain = 58,
    Aim =
    "Use the Brazier of Beckoning to summon forth the spirit of Isalien and slay him. Return to Bodley inside Blackrock Mountain with the recombined Lord Valthalak's Amulet and the Brazier of Beckoning.",
    Location = "Bodley (Blackrock Mountain " .. yellow .. "[D] on Entrance Map" .. white .. ")",
    Note =
        "Extra-Dimensional Ghost Revealer is needed to see Bodley. You get it from the 'In Search of Anthion' quest.\n\nIsalien is summoned at " ..
        yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.DireMaulEast.Alliance[6] = {
    ...
    Note = red ..
        "Warlock only" ..
        white ..
        ": This along with another quest given by Daio the Decrepit are Warlock only quests for the Ritual of Doom spell. The easiest way to get to the Wildspawn Satyr is to enter Dire Maul East through the 'back door' at the Lariss Pavilion (Feralas " ..
        yellow .. "77,37" .. white .. "). You'll need the Crescent Key, however.",
}
kQuestInstanceData.DireMaulEast.Alliance[7] = {
    ...
    Note = red ..
        "Mage Only" ..
        white .. ": Hydrospawn Essence drop from [3] Hydrospawn. Reward: you can use Conjured Crystal Water.",
...
kQuestInstanceData.DireMaulEast.Alliance[9] = {
    ...
    Note = red ..
        "Druid Only" ..
        white ..
        ": Blue Leaves drop from Treants.\nPrequest start [of Ancients and Treants] - (Tower of Karazhan " ..
        yellow .. "near [0]" .. white .. ")", --2020112",
...
kQuestInstanceData.DireMaulEast.Horde[2] = {
    ...
    Note = "Lethtendris is in Dire Maul " ..
        ...
        white ..
        " at " .. yellow ..
        "[3]" .. white .. ". The prequest comes from Warcaller Gorlach in Orgrimmar. He roams the entire city.",
...
kQuestInstanceData.DireMaulNorth.Alliance[4] = {
    ...
    Note = "Prince is in Dire Maul " ..
        ...
        "[7]" ..
        white ..
        ". The Gauntlet is near him in a chest. You can only get this quest after a Tribute run and have the 'King of the Gordok' buff.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.DireMaulWest.Alliance[1] = {
    ...
    Attain = 54,
    Aim =
    "Search Dire Maul for Kariel Winthalus. Report back to Scholar Runethorn at Feathermoon with whatever information that you may find.",
...
kQuestInstanceData.DireMaulWest.Alliance[2] = {
    ...
    Note = "The Pylons are marked as " ..
        blue ..
        "[B]" .. white .. ". Immol'thar is at " ..
        yellow .. "[6]" .. white .. ", Prince Tortheldrin at " .. yellow .. "[7]" .. white .. ".",
...
kQuestInstanceData.DireMaulWest.Alliance[4] = {
    ...
    Note = red ..
        "Warlock only" ..
        white ..
        ": Final Quest in the Warlock Epic mount questline. First you must shut down all Pylons marked with " ..
        blue ..
        "[B]" ..
        white ..
        " and then kill Immol'thar at " ..
        yellow ..
        "[6]" ..
        white ..
        ". After that, you can begin the Summoning Ritual. Be sure to have upwards of 20 Soul Shards ready and have one Warlock specifically assigned to keeping the Bell, Candle and Wheel up. The Doomguards that come can be enslaved. After completion, talk to the Dreadsteed ghost to complete the quest.",
...
kQuestInstanceData.DireMaulWest.Alliance[5] = {
    ...
    Note = red ..
        "Druid only" ..
        white .. ": You turn the book in to Lorekeeper Javon at the " .. yellow .. "1' Library" .. white ..
        ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[6] = {
    ...
    Note = red ..
        "Hunter only" .. white .. ": You turn the book in to Lorekeeper Mykos at the " .. yellow .. "1' Library" ..
        white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[7] = {
    ...
    Note = red ..
        "Mage only" .. white .. ": You turn the book in to Lorekeeper Kildrath at the " .. yellow .. "1' Library" ..
        white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[8] = {
    ...
    Note = red ..
        "Paladin only" .. white .. ": You turn the book in to Lorekeeper Mykos at the " .. yellow .. "1' Library" ..
        white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[9] = {
    ...
    Note = red ..
        "Priest only" .. white .. ": You turn the book in to Lorekeeper Javon at the " .. yellow .. "1' Library" ..
        white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[10] = {
    ...
    Note = red ..
        "Rogue only" .. white .. ": You turn the book in to Lorekeeper Kildrath at the " .. yellow ..
        "1' Library" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[11] = {
    ...
    Note = red ..
        "Shaman only" .. white .. ": You turn the book in to Lorekeeper Javon at the " .. yellow .. "1' Library" ..
        white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[12] = {
    ...
    Note = red ..
        "Warlock only" .. white .. ": You turn the book in to Lorekeeper Mykos at the " .. yellow .. "1' Library" ..
        white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[13] = {
    ...
    Note = red ..
        "Warrior only" .. white .. ": You turn the book in to Lorekeeper Kildrath at the " ..
        yellow .. "1' Library" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.DireMaulWest.Alliance[14] = {
    ...
    Location = "Lorekeeper Lydros (Dire Maul - West or North " .. yellow .. "[1] Library" .. white .. ")",
    Note =
        "It's not a prequest, but Elven Legends must be completed before this quest can be started.\nThe Libram is a random drop in Dire Maul and is tradeable, so it may be found on the Auction House. Skin of Shadow is Soulbound and can drop off some bosses, Risen Constructs and Risen Bonewarder in " ..
...
kQuestInstanceData.DireMaulWest.Alliance[15] = {
    ...
    Location = "Lorekeeper Lydros (Dire Maul - West or North " .. yellow .. "[1] Library" .. white .. ")",
    Note =
        "It's not a prequest, but Elven Legends must be completed before this quest can be started.\nThe Libram is a random drop in Dire Maul and is tradeable, so it may be found on the Auction House. Frayed Abomination Stitching is Soulbound and can drop off Ramstein the Gorger, Venom Belchers, Bile Spewer and Patchwork Horror in " ..
...
kQuestInstanceData.DireMaulWest.Alliance[17] = {
    ...
    Note = red ..
        "Warrior or Paladin quest." ..
        white ..
        " It turns in to Lorekeeper Lydros (Dire Maul - West or North " ..
        yellow .. "[1] Library" .. white .. "). Turning this in allows you to start the quest for Quel'Serrar.",
...
kQuestInstanceData.DireMaulWest.Alliance[18] = {
    ...
    Note = "Immol'thar " ..
        ...
        "[6]" ..
        white ..
        " drops Pure Ley Essence.\nQuestline starts with quest 'The Keepers Charge' at Keeper Iselus " ..
        yellow .. "89,8,33.8" .. white .. " Azshara, north-east coast corner.",
...
kQuestInstanceData.DireMaulWest.Alliance[19] = {
    ...
    Location = "Parnabus <Wandering Wizard> (Gilneas " ..
        yellow .. "[22.9,74.4]" .. white .. ", very south of Gilneas City, west of river. inside of a lonely hose).",
    Note =
        "Highly recommend to take prequest 'The Binding of Xanthar' from Hanvar the Righteous (Deadwind Pass in the small church outside of Karazhan " ..
        yellow ..
        "[40.9,79.3]" ..
        white ..
        ").\nReward for the last quest of The Upper Binding quest chain will be quest item 'The Upper Binding of Xanthar' for quest 'The Binding of Xanthar'.\nArcane Torrents big elementals in the circle around " ..
        yellow .. "[6]" .. white .. " drop Supercharged Arcane Resonation.",
    Prequest = "The Binding of Xanthar -> The Upper Binding I " ..
        yellow .. "[Upper Blackrock Spire]" .. white .. " -> The Upper Binding II", --41015, 41011, 41012",
...
kQuestInstanceData.DireMaulWest.Alliance[20] = {
    ...
    Attain = 58,
    Aim = "Slay Immol'thar " ..
        yellow .. "[6]" .. white .. " in Dire Maul West, retrieve Arcanized Gems from his skin, and return to Dolvan. ",
...
kQuestInstanceData.DireMaulWest.Alliance[21] = {
    ...
    Level = 60,
    Attain = 58,
    Aim = "Gather a Binding Fragment from Cliff Breakers in " ..
        yellow ..
        "[Azshara]" ..
        white ..
        ", Overloaded Arcane Prism from Arcane Torrents in " ..
        yellow ..
        "[Dire Maul West]" ..
        white ..
        ", Slumberer's Shard from Weaver in the " ..
        yellow ..
        "[Sunken Temple]" ..
        white .. " and an Arcanite Rod. Report to Itharius in the Swamp of Sorrows with the collected items.",
    Location = "Ralathius (Hyjal - Nordanaar " .. yellow .. "[81.6,27.7]" .. white .. " a green dragonkin)",
    Note = "Arcane Torrents big elementals in the circle around " ..
        yellow ..
        "[6]" ..
        white ..
        " drop Overloaded Arcane Prism.\nFinishing this questline you get the necklace and you will be able to enter Hyjal raid instance Emerald Sanctum.",
...
kQuestInstanceData.Maraudon.Alliance[1] = {
    ...
    Note =
    "You get the Shadowshard Fragments from 'Shadowshard Rumbler' or 'Shadowshard Smasher' outside the instance on the Purple side.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.Maraudon.Alliance[2] = {
    ...
    Note =
    "You can fill the Vial at any pool outside the instance on the Orange side. The plants are in the orange and purple areas inside the instance.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note =
        "You find Cavindra at the beginning  of the orange part before you enter the instance.\nYou get the Celebrian Rod from Noxxion at " ..
        yellow ..
        "[2]" ..
        white ..
        ", the Celebrian Diamond from Lord Vyletongue at  " ..
        yellow ..
        "[5]" .. white .. ". Celebras is at " .. yellow ..
        "[7]" .. white .. ". You have to defeat him to be able to talk to him.",
...
kQuestInstanceData.Maraudon.Alliance[8] = {
    ...
    Note = "Zaetars Ghost appears after killing Princess Theradras " ..
        yellow .. "[11]" ..
        white .. ". You find Keeper Remulos at (Moonglade - Shrine of Remulos " .. yellow .. "36,41" .. white .. ").",
...
kQuestInstanceData.Maraudon.Alliance[9] = {
    ...
    Location = "Velos Sharpstrike (Feralas - Chimaera Roost Vale " ..
        yellow .. "[82.0,62.3]" .. white .. " southeastern corner of Feralas)",
...
kQuestInstanceData.Maraudon.Alliance[11] = {
    ...
    Attain = 34,
    Aim =
    "Obtain a slab of Landslide's body from Maraudon and bring it to Thegren near the Ruins of Corthan in the Badlands.",
    Location = "Thegren <Artisan Gemologist> (Badlands - Ruins of Corthan " .. yellow .. "[29, 27]" .. white .. ").",
    Note = red ..
        "Jewelcrafting only." ..
        white .. " Quest line for Gemologist specialization.\nLandslide is at " .. yellow .. "[8]" .. white .. ".",
...
kQuestInstanceData.MoltenCore.Alliance[2] = {
    ...
    Note = "Lucifron is at " ..
        yellow .. "[2]" ..
        white ..
        ", Sulfuron is at " .. yellow .. "[8]" .. white .. " and Shazzrah is at " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.MoltenCore.Alliance[3] = {
    ...
    Note =
        "Part of the Thunderfury, Blessed Blade of the Windseeker questline. It starts after obtaining either the left or right Bindings of the Windseeker from Garr at " ..
        yellow ..
        "[4]" ..
        white ..
        " or Baron Geddon at " ..
        ...
        "[6]" ..
        white ..
        ". Then talk to Highlord Demitrian to start the questline. Essence of the Firelord drops from Ragnaros at " ..
        yellow ..
        "[10]" ..
        white ..
        ". After turning this part in, Prince Thunderaan is summoned and you must kill him. He's a 40-man raid boss.",
...
kQuestInstanceData.MoltenCore.Alliance[4] = {
    ...
    Note =
        "You need a Sulfuron Ingot to get the contract from Lokhtos. They drop from Golemagg the Incinerator in Molten Core at " ..
        yellow .. "[7]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.MoltenCore.Alliance[6] = {
    ...
    "Recover the 8 lost chapters of Draconic for Dummies and combine them with the Magical Book Binding and return the completed book of Draconic for Dummies: Volume II to Narain Soothfancy in Tanaris. ",
    Location = "Narain Soothfancy (Tanaris " .. yellow .. "65,18" .. white .. ")",
    Note = "Only one person can loot the Chapter. Draconic for Dummies VIII (drops from Ragnaros " ..
        yellow .. "[10]" .. white .. ")",
    Prequest = "Decoy!",
    Folgequest =
    "The Good News and The Bad News (Must complete Stewvul, Ex-B.F.F. and Never Ask Me About My Business quest chains)",
...
kQuestInstanceData.MoltenCore.Alliance[7] = {
    ...
    Folgequest =
    "The Good News and The Bad News (Must complete Draconic for Dummies and Never Ask Me About My Business quest chains)",
    Rewards = {
        Text = "Reward:",
        { id = 18253, quantity = 3 }, --Major Rejuvenation Potion Potion
    }
}
kQuestInstanceData.MoltenCore.Alliance[8] = {
    Title = "Purging Flames",
    Id = 41965,
    Level = 60,
    Attain = 60,
    Aim = "To craft the cleansing torch, Gorn One Eye in the Timbermaw Tunnels south of Moonglade needs a Purging Flame and Star Woods logs.",
    Location = "Gorn One Eye (Timbermaw Tunnels " .. yellow .. "30, 64" .. white .. ")",
    Note = "Prequest start at Nathok (Azshara " .. yellow .. "39, 20" .. white .. "). 'Purging Flame' drops from 'Ragnaros' " .. yellow .. "[12]" .. white .. ".",
    Prequest = "Not Alone ->> Buried in Ancient Ruins",
    Folgequest = "Peroth’arn, Nightmare’s Herald",
    Rewards = {
        Text = "Reward:",
        { id = 55469 }, --Torch of Purifying Embers
    }
}
for i = 1, 8 do
...
kQuestInstanceData.Naxxramas.Alliance[3] = {
    ...
    Location = "Commander Eligor Dawnbringer (Eastern Plaguelands - Light's Hope Chapel " .. yellow ..
        "82,58" .. white .. ")",
    Note =
    "The mobs for this quest are trash mobs at the beginning of each wing of Naxxramas. This quest is a pre-requisite for the Tier 3 armor quests.",
...
kQuestInstanceData.Naxxramas.Alliance[4] = {
    ...
    Location = "Korfax, Champion of the Light (Eastern Plaguelands - Light's Hope Chapel " .. yellow ..
        "82,58" .. white .. ")",
...
kQuestInstanceData.OnyxiasLair.Alliance[1] = {
    ...
    Location = "Lorekeeper Lydros (Dire Maul - West or North " .. yellow .. "[1] Library" .. white .. ")",
    Note =
    "Drop the Sword in front of Onyxia when she's at 10% to 15% health. She'll have to breathe on and heat it. When Onyxia dies, pick the sword back up, click her corpse and use the sword. Then you're ready to turn in the quest.",
...
kQuestInstanceData.OnyxiasLair.Alliance[2] = {
    ...
    Aim =
    "Recover the 8 lost chapters of Draconic for Dummies and combine them with the Magical Book Binding and return the completed book of Draconic for Dummies: Volume II to Narain Soothfancy in Tanaris. ",
    Location = "Narain Soothfancy (Tanaris " ..
        yellow ..
        "65, 18" .. white .. ")" .. "Draconic for Dummies (drops from Onyxia " .. yellow .. "[3]" .. white .. ")",
    Note = "Only one person can loot the Chapter. Draconic for Dummies VI (drops from Onyxia " ..
        yellow .. "[3]" .. white .. ")",
    Prequest = "Decoy!",
    Folgequest =
    "The Good News and The Bad News (Must complete Stewvul, Ex-B.F.F. and Never Ask Me About My Business quest chains)",
...
kQuestInstanceData.OnyxiasLair.Alliance[3] = {
    ...
    Note = "Highlord Bolvar Fordragon is at (Stormwind City - Stormwind Keep " ..
        ...
        "78,20" ..
        white ..
        "). Only one person in the raid can loot this item and the quest can only be done one time.\nRewards listed are for the followup.",
...
kQuestInstanceData.OnyxiasLair.Horde[3] = createInheritedQuest(
    kQuestInstanceData.OnyxiasLair.Alliance[3],
    {
        ...
        Note = "Thrall is at (Orgrimmar - Valley of Wisdom " ..
            yellow ..
            "31, 37" ..
            white ..
            "). Only one person in the raid can loot this item and the quest can only be done one time.\nRewards listed are for the followup.",
...
kQuestInstanceData.RazorfenDowns.Alliance[2] = {
    ...
    Attain = 32,
    Aim =
    "Escort Belnistrasz to the Quilboar's idol in Razorfen Downs. Protect Belnistrasz while he performs the ritual to shut down the idol.",
    Location = "Belnistrasz (Razorfen Downs " .. yellow .. "[2]" .. white .. ")",
    Note =
    "The prequest is just you agreeing to help him. Several mobs spawn and attack Belnistrasz as he attempts to shut down the idol. After completing the quest, you can turn the quest in at the brazier in front of the idol.",
...
kQuestInstanceData.RazorfenDowns.Alliance[3] = {
    ...
    Note = "Amnennar the Coldbringer is the last boss in Razorfen Downs. You can find him at " ..
        yellow .. "[6]" .. white .. ".",
    Rewards = {
        Text = "Rewards:",
...
kQuestInstanceData.RazorfenDowns.Horde[2] = {
    ...
    Location = "Varimathras (Undercity - Royal Quarter " .. yellow .. "56,92" .. white .. ")",
    Note =
        "The preceding quest can be obtained from the last Boss in Razorfen Kraul. You find Malcin outside (The Barrens " ..
        yellow .. "48,92" .. white .. ").",
...
kQuestInstanceData.RazorfenDowns.Horde[4] = {
    ...
    Note = "Amnennar the Coldbringer is the last Boss at Razorfen Downs. You can find him at " ..
        yellow .. "[6]" .. white .. ".",
    Rewards = {
        Text = "Rewards:",
        { id = 10823 }, --Vanquisher's Sword One-Hand, Sword
...
kQuestInstanceData.RazorfenDowns.Horde[5] = {
    ...
    Level = 44,
    Attain = 38,
    Aim = "Venture into Razorfen Downs, slay Amnennar the Coldbringer " ..
        yellow ..
        "[6]" .. white .. " and retrieve his phylactery for Dark Bishop Mordren at Stillward Church in Gilneas.",
...
kQuestInstanceData.RazorfenKraul.Alliance[1] = {
    ...
    Attain = 20,
    Aim =
    "In Razorfen Kraul, use the Crate with Holes to summon a Snufflenose Gopher, and use the Command Stick on the gopher to make it search for Tubers. Bring 6 Blueleaf Tubers, the Snufflenose Command Stick and the Crate with Holes to Mebok Mizzyrix in Ratchet.",
...
kQuestInstanceData.RazorfenKraul.Alliance[2] = {
    ...
    Note =
        "The pendant is a random drop. You musst bring back the pendant to Treshala Fallowbrook in Darnassus - Tradesmen Terrace (" ..
        yellow .. "69,67" .. white .. ").",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.RazorfenKraul.Alliance[3] = {
    ...
    Note =
    "Willix the Importer must be escorted to the entrance of the instance. The quest is turned in to him when completed.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.RazorfenKraul.Alliance[5] = {
    ...
    Note = red ..
        "Warrior only" ..
        white ..
        ": You get the Vial of Phlogiston from Roogug at " ..
        yellow ..
        "[1]" ..
        white ..
...
kQuestInstanceData.RazorfenKraul.Horde[4] = {
    ...
    Location = "Auld Stonespire (Thunder Bluff " .. yellow .. "36,59" .. white .. ")",
...
kQuestInstanceData.RazorfenKraul.Horde[6] = {
    ...
    Attain = 20,
    Aim =
    "Destroy the living embodiment of natural corruption within the depths of Razorfen Kraul, and bring the Tainted Brambleheart to Kym Wildmane in Thunder Bluff.",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[1] = {
    ...
    Note = "This quest line starts at Brother Crowley with quest 'Brother Anton' in Stormwind - Cathedral of Light (" ..
        yellow ..
        "42,24" ..
        white ..
        ").\nYou can find High Inquisitor Whitemane and Scarlet Commander Mograine at " ..
        yellow ..
        "SM: Cathedral [2]" ..
        white ..
        ", Herod at " ..
        yellow ..
        "SM: Armory [1]" .. white .. " and Houndmaster Loksey at " .. yellow .. "SM: Library [1]" .. white .. ".",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[2] = {
    ...
    Note = "The book is on the floor on the left side of one of the corridors leading to Arcanist Doan (" ..
        yellow .. "[2]" .. white .. ").",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.ScarletMonasteryLibrary.Alliance[3] = {
    ...
    Note = red ..
        "Mage only" ..
        white .. ": You can find the book in the last corridor leading to Arcanist Doan (" .. yellow .. "[2]" .. white ..
        ").",
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[2] = {
    ...
    Location = "Varimathras (Undercity - Royal Quarter " .. yellow .. "56,92" .. white .. ")",
    Note = "You can find High Inquisitor Whitemane and Scarlet Commander Mograine at " ..
        yellow ..
        "SM: Cathedral [2]" ..
        white ..
        ", Herod at " ..
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[3] = {
    ...
    Location = "Sage Truthseeker (Thunder Bluff " .. yellow .. "34,47" .. white .. ")",
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[4] = {
    ...
    Note = "Questline starts at Dorn Plainstalker with quest 'Test of Faith'  (Thousand Needles " ..
        yellow .. "53,41" .. white .. "). You can find the book in the Library of Scarlet Monastary.",
...
kQuestInstanceData.ScarletMonasteryCathedral.Alliance[2] = {
    ...
    Note = "Aged Wooden Chest contain the item. You can find Orb of Kaladus inside the second chamber, left from " ..
        yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.ScarletMonasteryCathedral.Alliance[3] = {
    ...
    Level = 44,
    Attain = 35,
    Aim = "Discover the truth about the fate of High Inquisitor Fairbanks " ..
        yellow .. "[1]" .. white .. " for Brother Elias at Shademore Tavern in Gilneas. Slain High Inquisitor Fairbanks",
    Location = "Brother Elias <Scarlet Crusade Emissary> (Gilneas - Ruins of Greyshire - Shademore Tavern " ..
...
kQuestInstanceData.ScarletMonasteryGraveyard.Horde[2] = {
    ...
    Note =
        "You can find Vorrel Sengutz at the beginning of the Graveyard section of the Scarlet Monastery. Nancy Vishas, who drops the ring needed for this quest, can be found in a house in the Alterac Mountains (" ..
        yellow .. "31,32" .. white .. ").",
    Rewards = {
        Text = "Reward: 1 and 2 or 3",
...
kQuestInstanceData.Scholomance.Alliance[2] = {
    ...
    Note =
        "Plagued Hatchlings drop the Healthy Dragon Scales (8% chance to drop). You can find Betina Bigglezink at Eastern Plaguelands - Light's Hope Chapel (" ..
        yellow .. "81,59" .. white .. ").",
...
kQuestInstanceData.Scholomance.Alliance[3] = {
    ...
    Note = "You find Doctor Theolen Krastinov, the remains of Eva Sarkhoff and the remains of Lucien Sarkhoff at " ..
        yellow .. "[9]" .. white .. ".",
...
kQuestInstanceData.Scholomance.Alliance[5] = {
    ...
    Attain = 55,
    Aim =
    "Return to the Scholomance with the Blood of Innocents. Find the porch and place the Blood of Innocents in the brazier. Kirtonos will come to feast upon your soul. Fight valiantly, do not give an inch! Destroy Kirtonos and return to Eva Sarkhoff.",
    Location = "Eva Sarkhoff (Western Plaguelands - Caer Darrow " .. yellow .. "70,73" .. white .. ")",
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Note = "You can find The Deed to Caer Darrow at " ..
        yellow ..
        "[12]" ..
        white ..
        ", The Deed to Brill at " ..
        yellow ..
        "[7]" ..
        white ..
        ", The Deed to Tarren Mill at " .. yellow ..
        "[4]" .. white .. " and The Deed to Southshore at " .. yellow .. "[1]" .. white .. ".",
...
kQuestInstanceData.Scholomance.Alliance[8] = {
    ...
    Location = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel " .. yellow .. "81,59" .. white .. ")",
    Note = "Broodling Essence begins at Tinkee Steamboil (Burning Steppes - Flame Crest " ..
        yellow .. "65,23" .. white .. "). The Viewing Room is at " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.Scholomance.Alliance[9] = {
    ...
    Attain = 60,
    Aim =
    "Bring the Imp in a Yesr to the alchemy lab in the Scholomance. After the parchment is created, return the jar to Gorzeeki Wildeyes.",
...
kQuestInstanceData.ShadowfangKeep.Alliance[1] = {
    ...
    Note = red ..
        "Paladin only" ..
        white .. ": To see the note click on  " .. yellow .. "[The Test of Righteousness Information]" .. white .. ".",
    Prequest = "The Tome of Valor -> The Test of Righteousness",
    Folgequest = "The Test of Righteousness",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.ShadowfangKeep.Alliance[3] = {
    ...
    Note = "High Sorcerer Andromath has tasked you with the death of Archmage Arugal " ..
        yellow .. "[12]" .. white .. ". Return to him when you're done.",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.ShadowfangKeep.Alliance[5] = {
    ...
    Note = "[Shadowfang Blood] drop from Worgens." ..
        white ..
        "\n[Scythe of the Goddess] prequest start at The Scythe of Elune drop from Lord Blackwood II " ..
        yellow .. "(Lower Karazhan Halls [5]).",
    Prequest = "Scythe of the Goddess",
...
kQuestInstanceData.ShadowfangKeep.Horde[1] = {
    ...
    Note = "You find Deathstalker Adamant at " ..
        yellow ..
        "[1]" ..
        white .. ". Deathstalker Vincent is on the right side when you go into the courtyard at " ..
        yellow .. "[2]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.ShadowfangKeep.Horde[6] = {
    ...
    Note =
        "You need to kill Prelate Ironmane [13].\nQuest chain start at Deathguard Podrig (Silverpine Forrest - The Sepulcher " ..
        yellow .. "43, 42" .. white .. ")",
...
kQuestInstanceData.Stratholme.Alliance[1] = {
    ...
    Location = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel " .. yellow .. "81,59" .. white .. ")",
    Note = "Most mobs in Stratholme can drop the Plagued Flesh Samples.",
...
kQuestInstanceData.Stratholme.Alliance[2] = {
    ...
    Location = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel " .. yellow .. "81,59" .. white .. ")",
    Note = "The Scourge Data is in one of the 3 Towers, you find near " ..
        yellow .. "[15]" .. white .. ", " .. yellow .. "[16]" .. white .. " and " .. yellow .. "[17]" .. white .. ".",
...
kQuestInstanceData.Stratholme.Alliance[3] = {
    ...
    Location = "Leonid Barthalomew the Revered (Eastern Plaguelands - Light's Hope Chapel " ..
        yellow .. "80,58" .. white .. ")",
    Note =
    "You can find the Holy Water in chests everywhere in Stratholme. But if you open a chest bugs can appear and attack you.",
    Rewards = {
        Text = "Reward: 1 and 2 and 3 or 4",
        { id = 3928, quantity = 5 }, --Superior Healing Potion Potion
        { id = 6149, quantity = 5 }, --Greater Mana Potion Potion
...
kQuestInstanceData.Stratholme.Alliance[5] = {
    ...
    Note = "You get the prequest from Caretaker Alen (Eastern Plaguelands - Light's Hope Chapel " ..
        yellow .. "79,63" .. white .. "). The spectral citizens walk through whole Stratholme.",
...
kQuestInstanceData.Stratholme.Alliance[6] = {
    ...
    Note = "You get the prequest from Tirion Fordring (Western Plaguelands " ..
        yellow .. "7,43" .. white .. "). You can find the picture near " .. yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Location = "Leonid Barthalomew the Revered (Eastern Plaguelands - Light's Hope Chapel " ..
        yellow .. "80,58" .. white .. ")",
    Note = "You get the prequest from Magistrate Marduke (Western Plaguelands - Caer Darrow " ..
        yellow ..
        "70,73" ..
        white ..
        "). You find the sign near " ..
        yellow .. "[19]" .. white .. ". See also: " .. yellow .. "[The Lich, Ras Frostwhisper]" .. white ..
        " in Scholomance.",
...
kQuestInstanceData.Stratholme.Alliance[8] = {
    ...
    Note =
        "To start the quest you have to give Aurius [The Medallion of Faith]. You get the Medallion from a chest (Malor's Strongbox " ..
        yellow ..
        "[7]" ..
        white ..
        ") in the first chamber of the bastion (before the ways split). After giving Aurius the Medallion he supports your group in the fight against the Baron " ..
        yellow .. "[19]" .. white .. ". After killing the Baron you have to talk to Aurius again to get the Rewards.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.Stratholme.Alliance[10] = {
    ...
    Note = "You find Duke Nicholas Zverenhoff in the Eastern Plaguelands - Light's Hope Chapel (" ..
        yellow .. "81,59" .. white .. ").",
...
kQuestInstanceData.Stratholme.Alliance[12] = {
    ...
    Note =
        "Anthion stands just outside the Stratholme portal. You need the Extra-Dimensional Ghost Revealer to see him. It comes from the pre-quest. The questline starts with Just Compensation. Deliana in Ironforge (" ..
        yellow ..
        "43,52" ..
        white ..
        ") for Alliance, Mokvar in Orgrimmar (" ..
        yellow .. "38,37" .. white .. ") for Horde.\nThis is the infamous '45 minute' Baron run.",
...
kQuestInstanceData.Stratholme.Alliance[13] = {
    ...
    Location = "Bodley (Blackrock Mountain " .. yellow .. "[D] on Entrance Map" .. white .. ")",
    Note =
        "Extra-Dimensional Ghost Revealer is needed to see Bodley. You get it from the 'In Search of Anthion' quest.\n\nJarien and Sothos are summoned at " ..
        yellow .. "[11]" .. white .. ".",
    Prequest = "Components of Importance",
    Folgequest = "I See Alcaz Island In Your Future...",
}
...
kQuestInstanceData.Stratholme.Alliance[16] = {
    ...
    Note = red .. "Blacksmith only" ..
        white .. ": The Black Guard Swordsmith is summoned near " .. yellow .. "[15]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.Stratholme.Alliance[17] = {
    ...
    Note = red .. "Blacksmith only" .. white .. ": The Crimson Hammersmith is summoned at " .. yellow ..
        "[8]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.Stratholme.Alliance[18] = {
    ...
    Attain = 30,
    Aim =
    "The last component I need is a high quality adamantite rod used for the endoskeleton. I believe Stratholme's forges used to make such rods in the past.",
    Location = "Oglethorpe Obnoticus <Master Gnome Engineer> (Stranglethorn Vale; Booty Bay " ..
        yellow .. "28.4,76.3" .. white .. ").",
    Note = red ..
        "(Engineers only)" ..
...
kQuestInstanceData.Stratholme.Alliance[19] = {
    ...
    Note = "Tabard of the Ashbringer drops from Grand Crusader Dathrohan " ..
        yellow ..
        "[11]" ..
        white ..
        ", Cape of Alexandros drops from Baron Rivendare" ..
        yellow .. "[19]" .. white ..
...
kQuestInstanceData.Stratholme.Alliance[20] = {
    ...
    Note = "Rothlen Family Brooch next to boss The Unforgiven " ..
        yellow ..
        "[4]" ..
        white ..
        " in the chest.\nQuest chain starts with epic item random drop 'Scribbled Cooking Notes' " ..
        yellow .. "[Karazhan]" .. white .. ".",
    Prequest = "Scribbled Cooking Notes " ..
        yellow .. "[Karazhan]" .. white .. " -> Lost and Found " .. yellow .. "[Karazhan]" .. white .. "", -- 40998, 40999",
...
kQuestInstanceData.Stratholme.Alliance[21] = {
    ...
    Attain = 58,
    Aim =
    "Find four Echoes of Medivh. They might be found in places of great significance for the mage. Then return to Vandol with the key.",
    Location = "Dolvan Bracewind (Dustwallow Marsh - Westhaven Hollow " .. yellow .. "[71.1,73.2]" .. white .. ")",
    Note = "Second Feather of Medivh on the ground in the place where Elder Farwhisper (Lunar Festival) " ..
        yellow ..
        "[5]" ..
        white ..
        " is.\nFirst Feather of Medivh " ..
        yellow ..
        "[Undercity]" ..
        white ..
        " behind the entrance throne.\nThird Feather of Medivh " ..
        yellow ..
        "[Alterac Mountain]" ..
        white ..
        " on the end of first(western) cliff " ..
        yellow ..
        "[30.8,87.4]" ..
        white ..
        ".\nFourth Feather of Medivh " ..
        yellow .. "[Hyjal]" .. white .. " on the end of the cliff " .. yellow .. "[31.8,70.5]" .. white .. ".",
...
kQuestInstanceData.Stratholme.Horde[18] = {
    ...
    Note = "You get the prequest from Nathanos Blightcaller, too. You can find Ramstein at " ..
        yellow .. "[18]" .. white .. ".",
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "Venoxis's Venom Sac drops from High priest Venoxis in " ..
        yellow ..
        "Zul'Gurub" ..
        white ..
        ". Kurinnaxx's Venom Sac drops in the " .. yellow .. "Ruins of Ahn'Qiraj" .. white ..
        " at " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.TheStockade.Alliance[5] = {
    ...
    Note = "The preceding quest can be obtained from Motley too. You can find Kam Deepfury at " ..
        yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.TheStockade.Alliance[6] = {
    ...
    Location = "Warden Thelwater (Stormwind - The Stockade " .. yellow .. "41,58" .. white .. ")",
    Note = "For more details about the preceding quest see " ..
        yellow .. "[Deadmines, The Defias Brotherhood]" ..
...
kQuestInstanceData.TheStockade.Alliance[7] = {
    ...
    Location = "Master Mathias Shaw <Leader of SI:7> (Stormwind - Old Town, Rogue district " ..
        yellow .. "75.8,59.8" .. white .. ")",
    Note = "You can find Martin Corinth's Information inside Sealed Documents Crate " ..
        yellow ..
        "[1]" ..
        white ..
        " in the room across the dungeon entrance.\nQuestline starts with quest 'Uncovering Mystery' at Lord Commander Ryke (Wetlands - Hawk's Vigil " ..
        yellow ..
        "36.4,67.3" .. white .. " under the tent)\nYou will get reward after you finish the last quest of the questline.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[2] = {
    ...
    Note = "The Prequest 'Muigin and Larion' starts at Muigin (Un'Goro Crater - Marshal's Refuge " ..
        yellow .. "42,9" .. white .. "). You get the Haze from Deep Lurkers, Murk Worms or Oozes in the Temple.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[3] = {
    ...
    Note = "The Altar is at " ..
        yellow ..
        "[1]" ..
        white ..
        ".\nAlliance questline starts at Angelas Moonbreeze (Feralas - Feathermoon Stronghold " ..
        yellow ..
        "31.8,45.6" ..
        white ..
        ") with quest 'The Sunken Temple'.\nHorde questline starts at Witch Doctor Uzer'i (Feralas - Camp Mojache " ..
        yellow .. "74.4,43.4" .. white .. ") with quest 'The Sunken Temple'.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[5] = {
    ...
    Note = "The Questline starts with 'Screecher Spirits' at the same NPC (See " ..
        yellow ..
        "[Zul'Farrak]" ..
        white ..
        ").\nYou have to use the Egg at " ..
        yellow ..
        "[3]" ..
        white ..
        " to start the Event. Once it starts enemies spawn and attack you. Some of them drop the blood of Hakkar. With this blood you can put out the torch around the circle. After this the Avatar of Hakkar spawns. You kill him and loot the 'Essence of Hakkar' which you use to fill the egg.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[7] = {
    ...
    Note = "You find the Essence Font next to where Shade of Eranikus is at " ..
        yellow ..
        "[6]" ..
        white ..
        ".\n" ..
        ...
        "Don't" ..
        white ..
        "  sell or throw away reward trinket Chained Essence of Eranikus. You will need it for next quest at Itharius (Swamp and Sorrows - Itharius's Cave " ..
        yellow .. "[13.6,71.7]" .. white .. ", after talking with him you will get an item that starts the quest.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[8] = {
    ...
    Note = red ..
        "Warlock only" ..
        white ..
        ": Feather drops from each of the named trolls on the ledges overlooking the big room with the hole in the center.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[9] = {
    ...
    Note = red ..
        "Warrior only" ..
        white ..
        ": Feather drops from each of the named trolls on the ledges overlooking the big room with the hole in the center.\nHorde questline starts in Orgrimar at warrior trainer Sorek " ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[10] = {
    ...
    Note = red ..
        "Druid only" ..
        white ..
        ": The Putrid Vine drops from Atal'alarion who is summoned at " ..
        yellow .. "[1]" .. white .. " by activating the statues in the order listed on the map.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[13] = {
    ...
    Note = red ..
        ...
        white ..
        ": Morphaz is at " ..
        yellow .. "[5]" .. white .. ". Greta Mosshoof is at Felwood - Emerald Sanctuary (" .. yellow .. "51,82" ..
        white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[14] = {
    ...
    Note = red ..
        "Rogue only" ..
        white ..
        ": The Azure Key drops from Morphaz at " ..
        yellow ..
        "[5]" .. white .. ". Lord Jorach Ravenholdt is at Alterac Mountains - Ravenholdt (" .. yellow .. "86,79" ..
        white .. ").",
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Attain = 58,
    Aim =
    "Gather a Binding Fragment from Cliff Breakers in Azshara, Overloaded Arcane Prism from Arcane Torrents in the Western wing of Dire Maul, Slumberer's Shard from Weaver in the Sunken Temple and an Arcanite Rod. Report to Itharius in the Swamp of Sorrows with the collected items.",
    Location = "Ralathius (Hyjal - Nordanaar " .. yellow .. "85,30" .. white .. ")",
    Note = "Weaver " ..
        yellow ..
        "[6]" ..
        white ..
        " 1 of 4 dragons  drop Slumberer's Shard, will appear after killing Jammal'an the Prophet " ..
        yellow ..
        "[4]" ..
        white ..
        ". Barrier to the Prophet will disappear after clearing 6 balcons " ..
        blue ..
        "[C]" ..
        white ..
        "\nFinishing this questline you get the necklace and you will be able to enter Hyjal raid instance Emerald Sanctum.",
...
kQuestInstanceData.TheSunkenTemple.Alliance[19] = {
    ...
    Note = "Quest line start from Sanv K'la (Swamp of Sorrows " ..
        yellow ..
        "25, 30" ..
        white ..
...
kQuestInstanceData.TheSunkenTemple.Horde[1] = {
    ...
    Note = "All Enemys in the Temple drop Fetishes.\nQuestline starts at Fel'Zerul (Swamp of Sorrows - Stonard " ..
        yellow .. "47,54" .. white .. ")",
...
kQuestInstanceData.TheSunkenTemple.Horde[2] = {
    ...
    Note = "The Prequest 'Larion and Muigin' starts at Larion (Un'Goro Crater " ..
        yellow .. "45,8" .. white .. "). You get the Haze from Deep Lurkers, Murk Worms or Oozes in the Temple.",
...
kQuestInstanceData.TheSunkenTemple.Horde[18] = {
    ...
    Location = "Insom'ni <The Great Hermit> (Kazon Island, north of Gillijim Isle " .. yellow .. "57.2,10.1" ..
        white .. ")",
    Note = "Atal'ai Rod from the little green wooden chest on the floor behind Jammal'an the Prophet " ..
        yellow ..
        "[4]" ..
        white ..
        ".\nQuestline starts at Haz'gorg the Great Seer (Stranglethorn Vale - Gillijim's Isle(west from Booty Bay) - Maul'Ogg Refuge, inside of the southeast cave " ..
...
kQuestInstanceData.ZulFarrak.Alliance[1] = {
    ...
    Note = "The Questline starts at Gryphon Master Talonaxe (The Hinterlands - Wildhammer Stronghold " ..
        yellow ..
        "9,44" ..
        white .. ").\nNekrum spawns at " .. yellow .. "[4]" .. white ..
        " with the final crowd you fight for the Temple event.",
...
kQuestInstanceData.ZulFarrak.Alliance[3] = {
    ...
    Note = "The prequest starts at Krazek (Stranglethorn Vale - Booty Bay " ..
        yellow .. "25,77" ..
...
kQuestInstanceData.ZulFarrak.Alliance[5] = {
    ...
    Location = "Yeh'kinya (Tanaris - Steamwheedle Port " .. yellow .. "66,22" .. white .. ")",
    Note = "You get the prequest from the same NPC.\nThe Tablets drop from Theka the Martyr at " ..
        yellow .. "[2]" .. white .. " and Hydromancer Velratha at " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.ZulFarrak.Alliance[6] = {
    ...
    Note = "You get the Rod from Sergeant Bly. You can find him at " .. yellow ..
        "[4]" .. white .. " after the Temple event.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.ZulFarrak.Alliance[7] = {
    ...
    Note = "You get the prequest from Klockmort Spannerspan (Dun Morogh - Gnomeregan Reclamation Facility " ..
        yellow ..
        "23.6,28" ..
        white ..
        "). It is not necessary to have the prequest to get the Gahz'rilla quest.\nYou summon Gahz'rilla at " ..
        yellow ..
        "[6]" ..
        white ..
        " with the Mallet of Zul'Farrak.\nThe Sacred Mallet comes from Qiaga the Keeper (The Hinterlands - The Altar of Zul " ..
        yellow ..
        "49,70" ..
        white ..
        ") and must be completed at the Altar in Jinta'Alor at " ..
        yellow .. "59,77" .. white .. " before it can be used in Zul'Farrak.",
...
kQuestInstanceData.ZulFarrak.Alliance[8] = {
    ...
    Note = "In the room with Witch Doctor Zum'Rah " ..
        yellow .. "[3]" .. white .. " Ancient Burial Container (little green wooden box).",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.ZulFarrak.Alliance[9] = {
    ...
    Note = "Zel'jeb the Ancient " ..
        yellow .. "[8]" .. white .. ". You need 'Flame of Farrak' " .. yellow .. "[6]" .. white .. " for kill him.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.ZulFarrak.Horde[1] = {
    ...
    Note =
        "The Questline starts at a Venom Bottle, which is found on tables in Troll Villages in The Hinterlands.\nYou find the Tablet at " ..
        yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.ZulFarrak.Horde[10] = {
    ...
    Level = 48,
    Attain = 40,
    Aim = "Slay Ukorz Sandscalp and Ruuzlu " ..
        yellow .. "[7]" .. white .. " within Zul'Farrak for Champion Taza'go at Sandmoon Village in Tanaris.",
    Location =
    "Champion Taza'go (Tanaris - Sandmoon Village; northeast corner of Tanaris, northwest from Steamwheedle Port)",
    Note = "The Questline starts with quest 'Sandfury Redemption I' at Seer Maz'ek in Sandmoon Village(Tanaris) " ..
...
kQuestInstanceData.ZulGurub.Alliance[3] = {
    ...
    Note = "Nat Pagle is at Dustwallow Marsh (" ..
        yellow ..
        "59,60" ..
        white ..
        "). Turning the quest in allows you to buy Mudskunk Lures from Nat Pagle to summon Gahz'ranka in Zul'Gurub.",
}
...
kQuestInstanceData.ZulGurub.Alliance[5] = {
    ...
    Level = 60,
    Attain = 60,
    Aim = "Infiltrate Zul’Gurub and return with High Speaker Jam’wahli’s Tusks to Insom’ni on Kazon Island near Gilijim’s Isle.",
    Location = "Insom'ni (Gillijim's Isle - Kazon Island " .. yellow .. "56,16" .. white .. ")",
    Note = "Prequest start at Nathok (Azshara " .. yellow .. "39, 20" .. white .. "). 'High Speaker Jam'wahli' (Zul'Gurub - " .. yellow .. "0, 0" .. white .. ") drop the 'Jam’wahli’s Tusks'.",
...
kQuestInstanceData.Gnomeregan.Alliance[1] = {
    ...
    Location = "Tinkmaster Overspark (Dun Morogh - Gnomeregan Reclamation Facility " .. yellow .. "24.4,29.8" ..
        white .. ")",
    Note = "You get the prequest from Brother Sarno (Stormwind - Cathedral Square " ..
        yellow ..
        "40,30" ..
        white ..
        ").\nYou find Techbot before you enter the instance near the backdoor, at " ..
        yellow .. "[4] on Entrance Map" .. white .. ".",
...
kQuestInstanceData.Gnomeregan.Alliance[2] = {
    ...
    Note = "You get the prequest from Gnoarn (Dun Morogh - Gnomeregan Reclamation Facility " ..
        yellow ..
        "24.5,30.4" ..
        white ..
        ").\nTo get fallout you musst use the Phial on " ..
        red .. "alive" .. white .. " Irradiated Invaders or Irradiated Pillagers.",
...
kQuestInstanceData.Gnomeregan.Alliance[5] = {
    ...
    Location = "Klockmort Spannerspan (Dun Morogh - Gnomeregan Reclamation Facility " .. yellow .. "23.6,28" ..
        white .. ")",
    Note = "You get the prequest from Mathiel (Darnassus - Warrior's Terrace " ..
        yellow ..
        "59,45" ..
        white ..
        "). The prequest is only a pointer quest and is not required to get this quest.\nThe Essential Artificials come from machines scattered around the instance.",
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Location = "Master Mechanic Castpipe (Dun Morogh - Gnomeregan Reclamation Facility " ..
        yellow .. "24.1,29.8" .. white .. ")",
    Note = "You get the prequest from Gaxim Rustfizzle (Stonetalon Mountains " ..
        yellow ..
        "59,67" ..
        white ..
        "). The prequest is only a pointer quest and is not required to get this quest.\nThe white card is a random drop. You find the first terminal next to the back entrance before you enter the instance at " ..
        yellow ..
        "[3] on Entrance Map" ..
        white ..
        ". The 3005-B is at " ..
        yellow .. "[3]" ..
        white ..
        ", the 3005-C at " .. yellow .. "[5]" .. white .. " and the 3005-D is at " .. yellow .. "[6]" .. white ..
        ".",
...
kQuestInstanceData.Gnomeregan.Alliance[8] = {
    ...
    Location = "High Tinker Mekkatorque (Dun Morogh - Gnomeregan Reclamation Facility " ..
        yellow .. "24.2,29.7" .. white .. ")",
    Note = "You find Thermaplugg at " ..
        yellow ..
        "[8]" ..
        white ..
        ". He is the last boss in Gnomeregan.\nDuring the fight you have to disable the columns through pushing the button on the side.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.Gnomeregan.Alliance[10] = {
    ...
    Note = "Turns in to Talvash del Kissel (Ironforge - Mystic Ward " ..
        yellow .. "36,3" .. white .. "). The followup to enhance the ring is optional.",
...
kQuestInstanceData.Gnomeregan.Alliance[11] = {
    ...
    Note = "Intact Pounder Mainframe that starts the quest can drop from Crowd Pummeler 9-60 " ..
        yellow .. "[6]" .. white .. " (low chance).\n" .. red .. "Available for ENGINEERS with 125+ skill.",
...
kQuestInstanceData.Gnomeregan.Alliance[12] = {
    ...
    Location = "Weezan Littlegear (Dun Morogh - Gnomeregan Reclamation Facility " .. yellow .. "[25.2,31.6]" ..
        white .. ")",
    Note = "Schematic: High Energy Regulator is on the table at " ..
        yellow .. "[3]" .. white .. " southeastern corner lower south chamber " .. yellow .. "[a]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.Gnomeregan.Alliance[13] = {
    ...
    Level = 33,
    Attain = 25,
    Aim = "Activate the Alpha Channel Valve " ..
        yellow ..
        "[6]" ..
        white ..
        " and the Reserve Pump Channel Lever " ..
        yellow .. "[b]" .. white .. " deep within Gnomeregan for Master Technician Wirespanner in Dun Morogh.",
    Location = "Master Technician Wirespanner (Dun Morogh - Gnomeregan Reclamation Facility " ..
        yellow .. "[26.8,31.1]" .. white .. ")",
    Note = "Alpha Channel Valve is at " ..
        yellow ..
        "[6]" ..
        white ..
        ", use elevetaor to go down. south side of the central mechanism.\nReserve Pump Channel Lever is at " ..
        yellow .. "[b]" .. white .. " on the floor.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.Gnomeregan.Horde[1] = {
    ...
    Note = "You get the prequest from Sovik (Orgrimmar - Valley of Honor " ..
...
kQuestInstanceData.Gnomeregan.Horde[5] = {
    ...
    Aim = "You may either keep the ring, or you may find the person responsible for the imprint and engravings on the inside of the band.",
    Location = "Brilliant Gold Ring (obtained from Grime-Encrusted Ring quest)",
    Note = "Turns in to Nogg (Orgrimmar - The Valley of Honor " ..
        yellow .. "75,25" .. white .. "). The followup to enhance the ring is optional.",
    Prequest = "Grime-Encrusted Ring",
...
kQuestInstanceData.Gnomeregan.Horde[7] = {
    ...
    Note = "Prequest 'A New Power Source' starts at Technician Spuzzle(Durotar - Sparkwater Port " ..
        yellow ..
        "57.4,25.8" ..
        white ..
        ") at level 7 .\nMegaflux Capacitor drops from Mekgineer Thermaplugg. You find Mekgineer Thermaplugg at " ..
        yellow ..
        "[8]" ..
        white ..
        ". He is the last boss in Gnomeregan.\nDuring the fight you have to disable the columns through pushing the button on the side.",
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[2] = {
    ...
    Attain = 51,
    Aim =
    "Travel to the Icewing Caverns located southwest of Dun Baldar in Alterac Valley and recover the Stormpike Banner. Return the Stormpike Banner to Lieutenant Haggerdin in the Alterac Mountains.",
    Location = "Lieutenant Haggerdin (Alterac Mountains " .. yellow .. "39,81" .. white .. ")",
    Note = "The Stormpike Banner is in the Icewing Cavern at " ..
        yellow ..
        "[11]" ..
        white ..
        " on the Alterac Valley - North map. Talk to the same NPC each time you gain a new Reputation level for an upgraded Insignia.\n\nThe prequest is not necessary to obtain this quest, but it does yield about 9550 experience.",
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[3] = {
    ...
    Location = "Prospector Stonehewer (Alterac Mountains " ..
        yellow .. "41,80" .. white .. ") and\n(Alterac Valley - North " .. yellow .. "[B]" .. white .. ")",
    Note = "Drek'thar is at (Alterac Valley - South " ..
        yellow ..
        "[B]" ..
        white ..
        "). He does not actually need to be killed to complete the quest. The battleground just has to be won by your side in any manner.\nAfter turning this quest in, talk to the NPC again for the reward.",
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[4] = {
    ...
    Note = "The Stormpike Quartermaster is at (Alterac Valley - North " ..
        yellow .. "[7]" .. white .. ") and provides more quests.",
}
kQuestInstanceData.BGAlteracValleyNorth.Alliance[5] = {
    ...
    Note = "The supplies can be found in the Coldtooth Mine at (Alterac Valley - South " .. yellow .. "[6]" ..
        white .. ").",
}
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[8] = {
    ...
    Attain = 51,
    Aim =
    "Capture a mine that the Stormpike does not control, then return to Sergeant Durgen Stormpike in the Alterac Mountains.",
    Location = "Sergeant Durgen Stormpike (Alterac Mountains " .. yellow .. "37,77" .. white .. ")",
    Note = "To complete the quest, you must kill either Morloch in the Irondeep Mine at (Alterac Valley - North " ..
        yellow ..
        "[1]" ..
        white ..
        ") or Taskmaster Snivvle in the Coldtooth Mine at (Alterac Valley - South " ..
        yellow .. "[6]" .. white .. ") while the Horde control it.",
}
kQuestInstanceData.BGAlteracValleyNorth.Alliance[9] = {
    ...
    Attain = 51,
    Aim =
    "Destroy the banner at an enemy tower or bunker, then return to Sergeant Durgen Stormpike in the Alterac Mountains.",
    Location = "Sergeant Durgen Stormpike (Alterac Mountains " .. yellow .. "37,77" .. white .. ")",
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[10] = {
    ...
    Location = "Sergeant Durgen Stormpike (Alterac Mountains " .. yellow .. "37,77" .. white .. ")",
    Note =
    "Reportedly you do not need to do anything but be near a graveyard when the Alliance assaults it. It does not need to be captured, just assaulted.",
}
kQuestInstanceData.BGAlteracValleyNorth.Alliance[11] = {
    ...
    Note =
    "You can find a Ram outside the base. The taming process is just like that of a Hunter taming a pet. The quest is repeatable up to a total of 25 times per battleground by the same player or players. After 25 Rams have been tamed, the Stormpike Cavalry will arrive to assist in the battle.",
}
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[13] = {
    ...
    Attain = 51,
    Aim =
    "There are times which you may be entrenched in battle for days or weeks on end. During those longer periods of activity you may end up collecting large clusters of the Frostwolf's storm crystals.\n\nThe Circle accepts such offerings.",
    Location = "Arch Druid Renferal (Alterac Valley - North " .. yellow .. "[2]" .. white .. ")",
    Note = "After turning in 200 or so crystals, Arch Druid Renferal will begin walking towards (Alterac Valley - North " ..
        yellow ..
        "[19]" ..
        white ..
        "). Once there, she will begin a summoning ritual which will require 10 people to assist. If successful, Ivus the Forest Lord will be summoned to help the battle.",
}
kQuestInstanceData.BGAlteracValleyNorth.Alliance[14] = {
    ...
    Attain = 51,
    Aim =
    "The Frostwolf Clan is protected by a taint of elemental energy. Their shaman meddle in powers that will surely destroy us all if left unchecked.\n\nThe Frostwolf soldiers carry elemental charms called storm crystals. We can use the charms to conjure Ivus. Venture forth and claim the crystals.",
    Location = "Arch Druid Renferal (Alterac Valley - North " .. yellow .. "[2]" .. white .. ")",
    Note = "After turning in 200 or so crystals, Arch Druid Renferal will begin walking towards (Alterac Valley - North " ..
        yellow ..
        "[19]" ..
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[16] = {
    ...
    Attain = 51,
    Aim =
    "The elite Frostwolf units that guard the lines must be dealt with, soldier! I'm tasking you with thinning out that herd of savages. Return to me with medals from their lieutenants and legionnaires. When I feel that enough of the riff-raff has been dealt with, I'll deploy the air strike.",
...
kQuestInstanceData.BGAlteracValleyNorth.Alliance[17] = {
    ...
    Attain = 51,
    Aim =
    "Return to the battlefield and strike at the heart of the Frostwolf's command. Take down their commanders and guardians. Return to me with as many of their medals as you can stuff in your pack! I promise you, when my gryphons see the bounty and smell the blood of our enemies, they will fly again! Go now!",
    Location = "Wing Commander Ichman (Alterac Valley - North " .. yellow .. "[8]" .. white .. ")",
    Note =
    "Kill Horde NPCs for the Frostwolf Commander's Medals. After turning in 50, Wing Commander Ichman will either send a gryphon to attack the Horde base or give you a beacon to plant in the Snowfall Graveyard. If the beacon is protected long enough a gryphon will come to defend it.",
}
kQuestInstanceData.BGAlteracValleyNorth.Horde[1] = {
    ...
    Attain = 51,
    Aim =
    "Venture to Alterac Valley, located in the Alterac Mountains. Find and speak with Warmaster Laggrond - who stands outside the tunnel entrance - to begin your career as a soldier of Frostwolf. You will find Alterac Valley north of Tarren Mill at the base of the Alterac Mountains.",
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[2] = {
    ...
    Attain = 51,
    Aim =
    "Travel to the Wildpaw cavern located southeast of the main base in Alterac Valley and find the Frostwolf Banner. Return the Frostwolf Banner to Warmaster Laggrond.",
    Location = "Warmaster Laggrond (Alterac Mountains " .. yellow .. "62,59" .. white .. ")",
    Note = "The Frostwolf Banner is in the Wildpaw Cavern at (Alterac Valley - South " ..
        yellow ..
        "[9]" ..
        white ..
        "). Talk to the same NPC each time you gain a new Reputation level for an upgraded Insignia.\n\nThe prequest is not necessary to obtain this quest, but it does yield about 9550 experience.",
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[3] = {
    ...
    Note = "Vanndar Stormpike is at (Alterac Valley - North " ..
        yellow ..
        "[B]" ..
        white ..
        "). He does not actually need to be killed to complete the quest. The battleground just has to be won by your side in any manner.\nAfter turning this quest in, talk to the NPC again for the reward.",
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[8] = {
    ...
    Note = "To complete the quest, you must kill either Morloch in the Irondeep Mine at (Alterac Valley - North " ..
        ...
        white ..
        ") or Taskmaster Snivvle in the Coldtooth Mine at (Alterac Valley - South " ..
        yellow .. "[6]" .. white .. ") while the Alliance control it.",
}
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[10] = {
    ...
    Location = "Corporal Teeka Bloodsnarl (Alterac Mountains " .. yellow .. "66,55" .. white .. ")",
    Note =
    "Reportedly you do not need to do anything but be near a graveyard when the Horde assaults it. It does not need to be captured, just assaulted.",
}
kQuestInstanceData.BGAlteracValleyNorth.Horde[11] = {
    ...
    Note =
    "You can find a Frostwolf outside the base. The taming process is just like that of a Hunter taming a pet. The quest is repeatable up to a total of 25 times per battleground by the same player or players. After 25 Rams have been tamed, the Frostwolf Cavalry will arrive to assist in the battle.",
}
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[13] = {
    ...
    Attain = 51,
    Aim =
    "You have the option of offering larger quantities of the blood taken from our enemies. I will be glad to accept gallon sized offerings.",
    Location = "Primalist Thurloga (Alterac Valley - South " .. yellow .. "[8]" .. white .. ")",
    Note = "After turning in 150 or so Blood, Primalist Thurloga will begin walking towards (Alterac Valley - South " ..
        yellow ..
        "[14]" ..
        white ..
        "). Once there, she will begin a summoning ritual which will require 10 people to assist. If successful, Lokholar the Ice Lord will be summoned to kill Alliance players.",
}
kQuestInstanceData.BGAlteracValleyNorth.Horde[14] = {
    ...
    Attain = 51,
    Aim =
    "You must strike down our enemies and bring to me their blood. Once enough blood has been gathered, the ritual of summoning may begin.\n\nVictory will be assured when the elemental lord is loosed upon the Stormpike army.",
    Location = "Primalist Thurloga (Alterac Valley - South " .. yellow .. "[8]" .. white .. ")",
    Note = "After turning in 150 or so Blood, Primalist Thurloga will begin walking towards (Alterac Valley - South " ..
        yellow ..
        "[14]" ..
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[15] = {
    ...
    Attain = 51,
    Aim =
    "My riders are set to make a strike on the central battlefield; but first, I must wet their appetites - preparing them for the assault.\n\nI need enough Stormpike Soldier Flesh to feed a fleet! Hundreds of pounds! Surely you can handle that, yes? Get going!",
    Location = "Wing Commander Guse (Alterac Valley - South " .. yellow .. "[13]" .. white .. ")",
    Note =
    "Kill Horde NPCs for the Stormpike Soldier's Flesh. Reportedly 90 flesh are needed to make the Wing Commander do whatever she does.",
}
...
kQuestInstanceData.BGAlteracValleyNorth.Horde[17] = {
    ...
    Attain = 51,
    Aim =
    "First, my war riders need targets to gun for - high priority targets. I'm going to need to feed them the flesh of Stormpike Commanders. Unfortunately, those little buggers are entrenched deep behind enemy lines! You've definitely got your work cut out for you.",
...
kQuestInstanceData.BGArathiBasin.Horde[1] = {
    ...
    Attain = 25,
    Aim =
    "Assault the Arathi Basin mine, lumber mill, blacksmith and stable, and then return to Deathmaster Dwire in Hammerfall.",
...
kQuestInstanceData.KarazhanCrypt = {
    Story =
    "Karazhan Crypt is an instance dungeon located in the Deadwind Pass. Something is twisting the dead back to life in the forlorn catacombs, find the source so the dead may rest again.",
...
kQuestInstanceData.KarazhanCrypt.Alliance[2] = {
    ...
    Note = "Drop from [Ravenous Strigoi].\nThe quest line starts [Recipes of Kezan] get in " ..
        yellow .. "[Tower of Karazhan]" .. white .. ".",
...
kQuestInstanceData.CavernsOfTimeBlackMorass = {
    Story =
    "In the Caverns of Time, in Tanaris, the Dark Portal re-enacts the history of its first opening. The Bronze Dragons, guardians of time, need your help to maintain the stability of the timeline and crush the conspiracy of the fallen.",
    Caption = "Caverns Of Time: The Black Morass",
    Alliance = {},
    Horde = {}
}
kQuestInstanceData.CavernsOfTimeBlackMorass.Alliance[1] = {
    ...
    Note = "Quest line start from Lizzarik <Weapon Dealer> (The Barrens - patrol from Crossroads to Ratchet " ..
        yellow .. "57,37" .. white .. "). Drop from [4].",
...
kQuestInstanceData.HateforgeQuarry = {
    Story =
    "Hateforge Quarry is an instance dungeon located in the Burning Steppes. Hidden away at the southeastern walls of the Burning Steppes, the Hateforge Quarry is the Dark Iron dwarves' newest effort to find of a new weapon to use against their adversaries. The innocent-looking quarry hides an insidious cavern, where the Shadowforge dwarves plot new schemes against all those that oppose them.",
...
kQuestInstanceData.HateforgeQuarry.Alliance[1] = {
    ...
    Location = "Overseer Oilfist <The Thorium Brotherhood> (Searing Gorge - Thorium Point " ..
...
kQuestInstanceData.HateforgeQuarry.Alliance[2] = {
    ...
    Note = "Questline starts at Radgan Deepblaze with quest 'Gaining Orvak's Trust' (Burning Steppes - Blackrock Pass " ..
...
kQuestInstanceData.HateforgeQuarry.Alliance[3] = {
    ...
    Level = 51,
    Attain = 45,
    Aim = "Slay Bargul Blackhammer " ..
        yellow ..
        "[1]" ..
        white .. " , and recover the Senate's Orders for Orvak Sternrock at the Blackrock Pass in Burning Steppes.",
...
kQuestInstanceData.HateforgeQuarry.Alliance[4] = {
    ...
    Note = red ..
        "(Jewelcrafting ONLY)" ..
        white ..
        " Find 'Glimmering Shard' and get the quest.\nYou will get the reward finishing last quest in the questline.",
    Folgequest = "Thunderforge Mastery",
    Rewards = {
        Text = "Reward: All",
...
kQuestInstanceData.HateforgeQuarry.Alliance[5] = {
    ...
    Note = "Hateforge Chemist mobs drop Dark Iron Vial for quest, Hateforge Chemistry Documents is in the box" ..
        yellow .. "[a]" .. white .. ".",
    Rewards = {
        Text = "Rewards:",
...
kQuestInstanceData.HateforgeQuarry.Alliance[6] = {
    ...
    Note = "Kill the last boss Har'gesh Doomcaller " ..
...
kQuestInstanceData.HateforgeQuarry.Horde[5] = {
    ...
    Level = 55,
    Attain = 48,
    Location = "Mistress Katalla (Burning Steppes - Karfang Hold " ..
        yellow .. "89.4,24.5" .. white .. " northeast corner of Burning Steppes).",
...
kQuestInstanceData.HateforgeQuarry.Horde[6] = {
    ...
    Location = "Karfang (Burning Steppes - Karfang Hold " ..
        yellow .. "90.1,22.5" .. white .. " northeast corner of Burning Steppes).",
    Note = "Kill the last boss Har'gesh Doomcaller " ..
        yellow ..
        "[5]" ..
        white ..
        ".\nQuestline starts at Councilor Vargek (Burning Steppes - Karfang Hold " ..
        yellow .. "90.0,22.7" .. white .. " northeast corner of Burning Steppes) with quest 'Of New and Old'.",
...
kQuestInstanceData.StormwindVault = {
    Story =
    "Stormwind Vault is an instance dungeon located in Stormwind. The Vault's runes of warding are weakening as the horrors within threaten Azeroth once again, you must venture down and stop these fiends once and for all.",
...
kQuestInstanceData.StormwindVault.Alliance[2] = {
    ...
    Attain = 55,
    Aim =
    "Venture deep within The Stormwind Vault, find Arc'tiras, and slay him for the good of Stormwind. When done, return to Pepin Ainsworth.",
...
kQuestInstanceData.StormwindVault.Alliance[3] = {
    ...
    Note = "You need to kill the last boss.\nQuest line start from Enchanted Amethyst drop in " ..
        yellow .. "Tower of Karazhan [2]" .. white .. " boss.\nReward from the last quest in chain.",
...
kQuestInstanceData.Ostarius.Alliance[1] = {
    ...
    Attain = 58,
    Aim =
    "Defeat Ostarius. Return to the Hall of Explorers and inform High Explorer Magellas about the events that occurred at the gate.",
    Location = "Uldum Pedestal (Tanaris " .. yellow .. "37,81" .. white .. ")",
    Note = "Prequest from High Explorer Magellas (Ironforge - Hall of Explorers " ..
        yellow .. "69.9,18.5" .. white .. ").You need to kill Ostarius.",
    Prequest = "Unusual Partnership -> Original Owner -> Gates of Uldum",
}
...
kQuestInstanceData.GilneasCity.Alliance[1] = {
    ...
    Level = 46,
    Attain = 35,
    Aim = "Slay Judge Sutherland " ..
        yellow .. "[3]" .. white .. " within Gilneas City for the Angered Phantom at the Glaymore Stead in Gilneas.",
...
kQuestInstanceData.GilneasCity.Alliance[2] = {
    ...
    Location = "Therum Deepforge <Expert Blacksmith> (Stormwind - Dwarven District" ..
        yellow .. "63.3,37" .. white .. ", can be walking around there)",
...
kQuestInstanceData.GilneasCity.Alliance[3] = {
    ...
    Location = "Baron Caliban Silverlaine (Gilneas - Ravenshire (main building) " .. yellow .. "58.4,67.8" .. white ..
        ")",
    Note =
        "the Deed to Ravenshire on the table behind Regent-Lady Celia Harlow and Regent-Lord Mortimer Harlow, next to the Harlow Family Chest" ..
        yellow .. "[7]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.GilneasCity.Alliance[4] = {
    ...
    Location =
        "Ethan Ravencroft (Gilneas - Hollow Web Cemetery - Crypt(southwest corner of Gilneas, east from the river)" ..
        yellow .. "33,76" .. white .. ")",
...
kQuestInstanceData.GilneasCity.Alliance[5] = {
    ...
    Level = 47,
    Attain = 35,
    Aim = "End the Draconic Influence over Gilneas by slaying Regent-Lady Celia Harlow and Regent-Lord Mortimer Harlow " ..
        yellow .. "[7]" .. white .. " for Magus Orelius at Ravenshire in Gilneas.",
...
kQuestInstanceData.GilneasCity.Alliance[6] = {
    ...
    Note =
        "Quest line starts with quest 'Wolf Amongst Sheep' at Baron Caliban Silverlaine (Gilneas - Ravenshire (main building) " ..
        yellow ..
        "58.4,67.8" ..
        white ..
        ")\nThe Greymane Crown drops from Genn Greymane " .. yellow .. "[8]" .. white ..
        ", last boss on the top of the tower.",
    Prequest =
    "Wolf Amongst Sheep -> One Chain at a Time -> On Legend's Trail -> Back to Ravenshire -> Dim Light in the Darkness -> Vilest of Men -> A Crossroads Deal -> Assaulting Freyshear Keep ",
    Rewards = {
...
kQuestInstanceData.GilneasCity.Alliance[7] = {
    ...
    Note = red ..
        "(Mage ONLY)" ..
        white ..
        " Mage Theramore teleport quest.\nthe Manuscript on Hydromancy II in the building " ..
        yellow .. "[b]" .. white .. ", go right, on the dresser (south side).",
...
kQuestInstanceData.GilneasCity.Alliance[8] = {
    ...
    Location = "Talvash del Kissel (Ironforge - The Mystic Ward " .. yellow .. "36,3" .. white .. ").",
    Note = red ..
        "(Jewelcrafter: Goldsmith ONLY)" ..
        white ..
        " Prequest from Mayva Togview (Ironforge - Hall of Explorers " ..
        yellow .. "60,24" .. white .. "). \nDustivan Blackcowl " ..
        yellow .. "[4]" .. white .. " drops the Tarnished Citrine Choker",
...
kQuestInstanceData.GilneasCity.Alliance[10] = {
    ...
    Note = "[Celia's Journal] placed near " ..
        yellow ..
        "[7]" ..
        white ..
        ".\n[Scythe of the Goddess] prequest start at The Scythe of Elune drop from Lord Blackwood II " ..
...
kQuestInstanceData.GilneasCity.Horde[2] = {
    ...
    Level = 45,
    Attain = 35,
    Aim = "Slay Dustivan Blackcowl " ..
        yellow .. "[4]" .. white .. " and recover the Ebonmere Deed for Joshua Ebonmere at Ebonmere Farm in Gilneas",
    Location = "Joshua Ebonmere (Gilneas - Ebonmere Farm " ..
        yellow ..
        "[49.5,31.1]" ..
        white ..
        "). Entering Gilneas gates follow the mountain on your left(east), in the field with windmills you will find Joshua Ebonmere.",
    Note = "Prequest 'Ebonmere Bat Infestation' and 'Ebonmere Worgen Infestation'.\nDustivan Blackcowl " ..
        yellow .. "[4]" .. white .. " drops the Ebonmere Deed",
...
kQuestInstanceData.GilneasCity.Horde[3] = {
    ...
    Location = "Luke Agamand (Gilneas - Blackthorn's Camp " ..
        yellow .. "[14.1,33.7]" .. white .. ", camp at northwest corner shore.)",
    Note = "The portrait of Mia Greymane in the building " ..
        yellow .. "[b]" .. white .. ", go left, on the wall (northwest corner).",
}
kQuestInstanceData.GilneasCity.Horde[4] = {
    ...
    Note = red ..
        "Questline starts at Deathstalker Alynna (Gilneas Stillward Church " ..
        yellow ..
        "[57.3,39.6]" ..
        white ..
        ", inside) with quest 'Dead Until Dark'.\n'On the Powers of Blood' book on the table behind Regent-Lady Celia Harlow and Regent-Lord Mortimer Harlow, next to the Harlow Family Chest" ..
...
kQuestInstanceData.GilneasCity.Horde[5] = {
    ...
    Level = 49,
    Attain = 40,
    Aim = "Enter Gilneas City and slay Genn Greymane " ..
        yellow .. "[8]" .. white .. ", then bring his head to Blackthorn at Blackthorn's Camp in Gilneas.",
    Location = "Blackthorn (Gilneas - Blackthorn's Camp " ..
        yellow .. "[14.1,33.7]" .. white .. ", camp at northwest corner shore.)",
    Note =
    "2 Questlines need to be finished to start this quest 'Report to Luke Agamand' and 'Report to Livia Strongarm' at Blackthorn.\n",
    Prequest =
    "'Report to Luke Agamand'-> Heist in Dryrock Mine -> Report to Livia Strongarm -> Rendezvous with the Infiltrator -> Quality Time with Blackthorn",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.GilneasCity.Horde[6] = {
    ...
    Location = "Dark Bishop Mordren (Gilneas - Stillward Church " .. yellow .. "57.7,39.6" .. white .. ")",
    Note =
        "Questline starts with quest 'Through Greater Magic' at Dark Bishop Mordren.\nShard of Midnight is behind the last boss Genn Greymane " ..
        yellow .. "[8]" .. white .. "\nYou will get the reward finishing the next quest.",
    Prequest = "Through Greater Magic -> The Ravenwood Scepter -> The Powers Beyond " ..
        yellow .. "[Razorfen Downs]" .. white .. ".", -- 40993, 40994, 40995",
...
kQuestInstanceData.GilneasCity.Horde[7] = {
    ...
    Note = red .. "(Jewelcrafter: Goldsmith only)" .. white .. " Prequest from Gulmire Fartower (Undercity - The Rogue Quarter " .. yellow .. "77,76" .. white .. 
     "). \n'Gilnean Jewelry: A Compendium' (where?) contain item.", --TODO: where?
    Prequest = "Mastering Goldsmithing",
    Rewards = {
        Text = "Reward:",
        { id = 70134 }, --Plans: Alluring Citrine Choker Pattern
...
kQuestInstanceData.LowerKarazhan = {
    Story =
    "Lower Karazhan Halls is an instance raid located in Deadwind Pass. Karazhan, once the towering stronghold of the former Guardian of Tirisfal, now hums with magical energy as it perches atop a powerful leyline. Its long-forgotten corridors, covered in dust, have become a haven for various creatures, though it appears that not all of its inhabitants have willingly departed. In the depths of the lower halls, Medivh's loyal castellan, Moroes, remains a vigilant guardian. If you manage to impress him, he may grant you access to the upper floors.",
...
kQuestInstanceData.LowerKarazhan.Alliance[6] = {
    ...
    Note = "Kill Moroes " ..
        ...
        "[6]" ..
        white ..
        " and retrieve the Key to the Upper Chambers. Moroes resides in Lower Karazhan Halls. Bring back the key to Lord Ebonlocke.",
...
kQuestInstanceData.LowerKarazhan.Alliance[7] = {
    ...
    Location = "The Cook near (" .. yellow .. "[Lower Karazhan Halls- e]" .. white .. ")",
    Note = "Turn in the quest to Archmage Ansirem Runeweaver <Kirin Tor> (Alterac Mountains - Dalaran " ..
...
kQuestInstanceData.LowerKarazhan.Alliance[8] = {
    ...
    Note = "Turn in the quest to Duke Rothlen " ..
        yellow ..
        "[Karazhan - f]" .. white .. " on the balkon next to Clawlord Howlfang " .. yellow .. "[4]" .. white .. ".",
...
kQuestInstanceData.LowerKarazhan.Alliance[10] = {
    ...
    Note = "Rothlen Family Brooch next to " ..
        yellow .. "[Stratholme]" .. white .. " boss The Unforgiven " .. yellow .. "[4]" .. white .. " in the chest.",
...
kQuestInstanceData.LowerKarazhan.Alliance[15] = {
    ...
    Level = 60,
    Attain = 60,
    Aim = "Slay Clawlord Howlfang " ..
        yellow .. "[4]" .. white .. " and report to Lord Ebonlocke " .. yellow .. "[Karazhan - d]" .. white .. ".",
    Location = "The Scythe of Elune " .. yellow .. "[5]" .. white .. ".",
    Note = red ..
        "Mage, Priest, Warlock, Druid only" ..
        white ..
        ":\nQuestline starts with legendary item 'The Scythe of Elune' that drops from Lord Blackwald II " ..
        yellow .. "[5]"
...
kQuestInstanceData.LowerKarazhan.Alliance[17] = {
    ...
    Note = red ..
        ...
        "[3]" ..
        white ..
        " drops 'Comically Large Candle'.\nThe quest line starts from Big Whiskers in " ..
        yellow .. "[Tower of Karazhan]" .. white .. ".",
...
kQuestInstanceData.LowerKarazhan.Horde[7] = createInheritedQuest(
    kQuestInstanceData.LowerKarazhan.Alliance[7],
    {
        ...
        Note = "Turn in the quest to Bethor Iceshard (Undercity - The Magic Quarter" ..
            yellow .. "[84.1,17.5]" .. white .. ", mage trainer zone.)"
    }
)
...
kQuestInstanceData.EmeraldSanctum = {
    Story =
    "Emerald Sanctum is an instance raid located in Hyjal. A fog of corruption has descended upon the Emerald Dream, twisting the morals and intentions of even the noblest and purest. The corrupted Wakener is preparing to send a premature call of awakening; if not stopped, his kin will arise and go on a frenzied rampage across Azeroth.",
...
kQuestInstanceData.EmeraldSanctum.Alliance[1] = {
    ...
    Note = red ..
        "Druid only" ..
        white ..
        ": Arch Druid Dreamwind is at (Hyjal - Nordanaar " ..
        yellow ..
        "85,30" ..
        white ..
        "). Only one person in the raid can loot this item and the quest can only be done one time.\n\nRewards listed are for the followup.",
...
kQuestInstanceData.EmeraldSanctum.Alliance[2] = {
    ...
    Note = "Ralathius is at (Hyjal - Nordanaar " ..
        yellow ..
        "85,30" .. white .. "). Only one person in the raid can loot this item and the quest can only be done one time.",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.TowerofKarazhan.Alliance[1] = {
    ...
    Note = "Obsidian Rod " ..
        yellow ..
        "Lower Karazhan Halls [e]." ..
        white ..
        " Cosmic Residue drop from " ..
        yellow ..
        "[3]." ..
        white ..
        "\nThe Binding of Xanthar prequest start at the Hanvar the Righteous (Deadwind Pass - Morgan's Plot " ..
        yellow ..
        "40.9, 79.3" .. white .. "), Wine for Kyleson prequest start at the The Cook " ..
        yellow .. "(Lower Karazhan Halls [e])",
...
kQuestInstanceData.TowerofKarazhan.Alliance[3] = {
    ...
    Location = "Big Whiskers (Tower of Karazhan " .. yellow .. "50, 50" .. white .. ")",
    Note = red ..
        "Mage only" ..
        white .. ": Doorman Montigue at Lower Karazhan Halls at the beginning of the dungeon in front of the stairs.",
...
kQuestInstanceData.TowerofKarazhan.Alliance[6] = {
    ...
    Note = red ..
        "Druid only" .. white .. ": Lorekeeper Lydros (Dire Maul - West or North " .. yellow .. "[1] Library" .. white
...
kQuestInstanceData.TowerofKarazhan.Alliance[8] = {
    ...
    Note = "Need to kill " ..
        yellow ..
        "Keeper Gnarlmoon [1].\n" ..
        white .. "[Scythe of the Goddess] prequest start at The Scythe of Elune drop from Lord Blackwood II " ..
        yellow .. "(Lower Karazhan Halls [5]).",
...
kQuestInstanceData.DragonmawRetreat.Alliance[1] = {
    ...
    Note = "Pedestal near " ..
        ...
        "[5]" ..
        white ..
        "\n'Fragment of Algoron' drops from " ..
...
kQuestInstanceData.DragonmawRetreat.Alliance[2] = {
    ...
    Attain = 20,
    Aim =
    "Avenge the Mosshide gnolls by slating their former leader Gowlfang in Dragonmaw Retreat. Return to Grimbit at their camp in The Green Belt in the Wetlands afterwards.",
...
kQuestInstanceData.DragonmawRetreat.Alliance[5] = {
    ...
    Note = "Drops from Zuluhed The Whacked " .. yellow .. "[10]",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.DragonmawRetreat.Alliance[6] = {
    ...
    Location = "Letter from Korlag Doomsong (Dragonmaw Retreat - Zuluhed the Whacked " .. yellow .. "[10]" .. white ..
        ")",
    Note = "Turn in to 'Magistrate Hurdam Toughhand' at 'Grim Reaches' " .. yellow .. "51, 58" .. white
        ..
        "\nYou will get the reward finishing the next quest. Need to kill 'Commander Korlag Doomsong' Grim Reaches - Zarm'Geth Stronghold " ..
        yellow .. "56, 11",
...
kQuestInstanceData.DragonmawRetreat.Horde[6] = createInheritedQuest(
    kQuestInstanceData.DragonmawRetreat.Alliance[6],
    {
        Note = "Turn in to 'Commander Aggnash' at Grim Reaches - Shatterblade Pose - " .. yellow .. "60, 30" .. white
            ..
            "\nYou will get the reward finishing the next quest.\nNeed to kill 'Commander Korlag Doomsong' Grim Reaches - Zarm'Geth Stronghold " ..
            yellow .. "56, 11"
    }
)
...
kQuestInstanceData.StormwroughtRuins = {
    Story =
    "Stormwrought Ruins is an instance dungeon located in Balor, within the ruins of Stormwrought Castle. An impregnable fortress, once Duke Balor's home and seat of power, Stormwrought Castle lies derelict atop the wave crashed cliffs of Balor. Seized during the First War, all its inhabitants were slaughtered viciously, and those less fortunate taken captive to be used in heinous rituals. Years later, this abandoned ruin has now been claimed again, by the orcish Stormreaver clan and their sinister overlords of the Shadow Council. The no longer pristine halls of the castle harbor a menagerie of horror and depravity, with lingering ghosts, hulking demons and murmuring cultists skulking along the pitchblack halls of this horrid place.",
    Caption = "Stormwrought Ruins",
    Alliance = {},
    Horde = {}
}
kQuestInstanceData.StormwroughtRuins.Alliance[1] = {
    ...
    Note = "'Key to Stormwrought Castle' is a reward from the quest chain starting at Drak’thul (Balor " .. yellow .. "55, 19" .. white .. ") unlocks access to boss 6+. 'Crown of Balor' drops from 'Duke Balor the IV' " .. yellow .. "[4]",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.StormwroughtRuins.Horde[6] = {
    ...
    Note = "You will get the reward finishing the next quest.\n'Heart of Mycellakos' drops from 'Mycellakos' " ..
        yellow .. "[8]",
...
kQuestInstanceData.StormwroughtRuins.Horde[7] = {
    ...
    Note = "You will get the reward finishing the next quest.\n'The Pendant of Uth'okk' drops from 'Oronok Torn-Heart' " ..
        yellow .. "[1]",
...
kQuestInstanceData.WindhornCanyon.Alliance[1] = { --TODO translate
    ...
    Level = 27,
    Attain = 20,
    Aim = "Gather 8 Windhorn Relics for Tarwegg Dustbrow within Windhorn Canyon and return to him in Ironforge.",
...
kQuestInstanceData.WindhornCanyon.Horde[1] = { --TODO translate
    ...
    Level = 27,
    Attain = 20,
    Aim = "Travel into the Windhorn Canyon and recover 8 Windhorn Relics for Sagh at Sagh's Refuge in Thousand Needles.",
    Location = "Sagh (Thousand Needles " .. yellow .. "31, 45" .. white .. ")",
    Note = "'Windhorn Relics' can be found throughout the entire dungeon.",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.WindhornCanyon.Horde[2] = { --TODO translate
    ...
    Level = 28,
    Attain = 24,
    Aim = "Slay Prophet Stormhoof, the leader of the Deathtotem within Windhorn Canyon, and return to Cairne Bloodhoof in Thunderbluff.",
    Location = "Cairne Bloodhoof (Thunder Bluff " .. yellow .. "60, 52" .. white .. ")",
    Note = "Prequest start at 'Brave Moonhorn' (Thousand Needles - The Great Lift " .. yellow .. "32, 22" .. white .. "). 'Prophet Stormhoof' is at " .. yellow .. "[6]" .. white .. ".",
    Prequest = "Message to Freewind Post -> Pacify the Centaur -> Grimtotem Spying -> Rumors of the Deathtotem -> Information for Cairne",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.WindhornCanyon.Horde[3] = { --TODO translate
    ...
    Level = 26,
    Attain = 20,
    Aim = "Banish the elemental figurehead inside Windhorn Canyon and report back to Shovu at the Earthen Ring in the Stonetalon Mountains.",
    Location = "Shovu (Stonetalon Mountains - Earthen Ring " .. yellow .. "47, 72" .. white .. ")",
    Note = red .. "Shaman only! " .. white .. "Prequest start from 'Windtorn Crest Stone', which drops from Razorgust in Stonetalon Mountains (" .. yellow .. "30, 19" .. white .. "). 'Ambassador Vortalus' is at " .. yellow .. "[3]" .. white .. ".",
    Prequest = "Windtorn Crest Stone",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.FrostmaneHollow.Alliance[1] = { --TODO translate
    ...
    Level = 13,
    Attain = 8,
    Aim = "Recover the Tablet of Kaz'gan for Ranix Crackbolt within Frostmane Hollow.",
    Location = "Ranix Crackbolt (Frostmane Hollow " .. yellow .. "[1']" .. white .. ")",
    Note = "'Tablet of Kaz'gan' is at " .. yellow .. "[3']" .. white .. ".",
}
kQuestInstanceData.FrostmaneHollow.Alliance[2] = { --TODO translate
    ...
    Level = 14,
    Attain = 10,
    Aim = "Search for Archeologist Evenpike inside Frostmane Hollow in Dun Morogh.",
    Location = "Brohann Caskbelly (Stormwind City - The Dwarven District " .. yellow .. "70, 40" .. white .. ")",
    Note = "'Archaeologist Evenpike' is at " .. green .. "[2']" .. white .. ".",
    Folgequest = "The Shattered Disc"
}
kQuestInstanceData.FrostmaneHollow.Alliance[3] = { --TODO translate
    ...
    Level = 14,
    Attain = 10,
    Aim = "Return to Brohann Caskbelly in the Dwarven District of Stormwind.",
    Location = "Archaeologist Evenpike (Frostmane Hollow " .. yellow .. "29, 62" .. white .. ")",
    Note = "'Brohann Caskbelly' (Stormwind City - The Dwarven District " .. yellow .. "70, 40" .. white .. ")",
...
kQuestInstanceData.FrostmaneHollow.Alliance[4] = { --TODO translate
    ...
    Level = 16,
    Attain = 10,
    Aim = "Enter Frostmane Hollow in Dun Morogh and acquire a flawless leopard pelt for Shandlar Thethis in Alah’thalas in the Thalassian Highlands. You can find the entrance to Frostmane Hollow near the Ironforge Airfields.",
    Location = "Shandlar Thethis (Thalassian Highlands - Alah'thalas " .. yellow .. "45, 46" .. white .. ")",
    Note = "'Tan'sha The Sleek' is at " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.FrostmaneHollow.Alliance[5] = { --TODO translate
    ...
    Level = 16,
    Attain = 8,
    Aim = "Slay Battlemaster Ubukaz deep within Frostmane Hollow for Mountaineer Granitebeard at the Ironforge Airfield in Dun Morogh.",
    Location = "Mountaineer Granitebeard (Dun Morogh - Ironforge Airfield " .. yellow .. "71, 36" .. white .. ")",
    Note = "'Battlemaster Ubukaz' is at " .. yellow .. "[2]" .. white .. ".",
...
kQuestInstanceData.TimbermawHold = {
    ...
    Caption = "Timbermaw Hold",
    Alliance = {},
    Horde = {}
}
kQuestInstanceData.TimbermawHold.Alliance[1] = { --TODO translate
    Title = "Draenethyst Recovery",
    Id = 41953,
    Level = 60,
    Attain = 50,
    Aim = "Enter Timbermaw Hold and retrieve the corrupted draenethyst. Bring them to Riftmaster Ral’pekta in Moro’gai Village of Moonwhisper Coast if you are successful.",
    Location = "Riftmaster Ral’pekta (Moonwhisper Coast - Moro’gai Village " .. yellow .. "65, 63" .. white .. ")",
    Note = "Prequest start at '' (" .. yellow .. "0, 0" .. white .. "). 'Selenaxx Foulheart' is at " .. yellow .. "[7]" .. white .. ".",
...
kQuestInstanceData.TimbermawHold.Alliance[2] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Present Narkogg the Dark in the Maw of Ursoc in Azshara with proof of slaying Karrsh the Sentinel in Timbermaw Hold.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "'Pendant of the Sentinel' drops from 'Karrsh the Sentinel' (" .. yellow .. "[1]" .. white .. ").",
    Folgequest = "The Corruption of Timbermaw Hold",
}
kQuestInstanceData.TimbermawHold.Alliance[3] = { --TODO translate
    Title = "The Corruption of Timbermaw Hold",
    Id = 41931,
    Level = 60,
    Attain = 60,
    Aim = "Collect Withermaw Totems from Withermaw Shaman inside Timbermaw Hold and bring them to Narkogg the Dark in the Maw of Ursoc in Azshara.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "'Withermaw Shaman' can be found inside Timbermaw Hold.",
    Prequest = "Proof of Conviction",
    Folgequest = "Ancient Furbolg Remedies",
}
kQuestInstanceData.TimbermawHold.Alliance[4] = { --TODO translate
    Title = "Ancient Furbolg Remedies",
    Id = 41932,
    Level = 60,
    Attain = 60,
    Aim = "Narkogg the Dark in the Maw of Ursoc in Azshara requires specific materials for the purification salve. Bring them to him.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "'Heart of Nemasra' drop from 'Nemasra' in Ungoro Crater (" .. yellow .. "35, 25" .. white .. "), 'Grammon’s Tongue' from 'Grammon the Ageless' Feralas (" .. yellow .. "28, 95" .. white ..
     "), 'Vial of Purification' from 'Tidelord Rrurgaz' (Dustwallow Marsh - " .. yellow .. "76, 20" .. white .. ")",
    Prequest = "The Corruption of Timbermaw Hold",
    Folgequest = "Unbridled Darkness",
}
kQuestInstanceData.TimbermawHold.Alliance[5] = { --TODO translate
    Title = "Unbridled Darkness",
    Id = 41933,
    Level = 60,
    Attain = 60,
...
kQuestInstanceData.TimbermawHold.Alliance[6] = { --TODO translate
    Title = "Essence of Purification",
    Id = 42021,
    Level = 60,
    Attain = 60,
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "You need to bring 1x 'Timbermaw Sap', 2x 'Essence of Earth' and 2x 'Living Essence' to Narkogg the Dark.",
...
kQuestInstanceData.TimbermawHold.Alliance[7] = { --TODO translate
    ...
    Level = 60,
    Attain = 60,
    Aim = "Slay Ursol in Timbermaw Hold. Report to Narkogg the Dark in the Maw of Ursoc in Azshara afterwards.",
    Location = "Narkogg the Dark (Azshara - Maw of Ursoc " .. yellow .. "39, 21" .. white .. ")",
    Note = "'Ursol' is at " .. yellow .. "[9]" .. white .. ".",
    Prequest = "Unbridled Darkness",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.TimbermawHold.Alliance[9] = { --TODO translate
    Title = "Peroth’arn, Nightmare’s Herald",
    Id = 41966,
    Level = 60,
    Attain = 60,
...
kQuestInstanceData.TimbermawHold.Horde[10] = { --TODO translate
    ...
    Note = "'Loktanag the Vile' is at " .. yellow .. "[4]" .. white .. ".",
}
