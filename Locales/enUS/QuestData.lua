...
kQuestInstanceData.WailingCaverns.Horde[6] = {
    ...
    Note = "The Questline starts at Hamuul Runetotem (Thunder Bluff - Elder Rise " .. yellow .. "78,28" .. white .. ")\nThe 4 druids drop the gems " .. yellow .. "[2]" .. white .. ", " .. yellow ..
...
kQuestInstanceData.WailingCaverns.Horde[8] = {
    ...
    Note = red .. "Mage ONLY." .. white .. " The Questline starts at Ureda <Mage Trainer> (Orgrimar) with quest 'Mastering the Arcane'.\nMoontouched Wood you get from " .. yellow .. "trash" .. white .. ", a Crystal of the Serpent from Lord Serpentis <Fanglord>" ..
        yellow .. "[7]" .. white .. ", and an Everchanging Essence from Lord Pythas <Fanglord> " .. yellow .. "[5]" .. white .. ".",
...
kQuestInstanceData.Uldaman.Alliance[8] = {
    ...
    Note = "The Hidden Chamber is at " .. yellow .. "[4]" .. white .. ". To open the Hidden Chamber you need The Shaft of Tsol from Revelosh " .. yellow .. "[3]" .. white .. " and the Gni'kiv Medallion from Baelog's Chest " .. yellow .. "[1]" .. white ..
        ". Combine these two items to form Staff of Prehistoria. The Staff is used in the Map Room between " .. yellow .. "[3] and [4]" .. white .. " to summon Ironaya. After killing her, run inside the room she came from to get quest credit.",
...
kQuestInstanceData.Uldaman.Alliance[11] = {
    ...
    Note = "The gems are at " .. yellow .. "[1]" .. white .. " in a Conspicous Urn, " .. yellow .. "[8]" .. white .. " from the Shadowforge Cache, and " .. yellow .. "[9]" .. white ..
...
kQuestInstanceData.Uldaman.Horde[6] = {
    ...
    Note = "The gems are at " .. yellow .. "[1]" .. white .. " in a Conspicous Urn, " .. yellow .. "[8]" .. white .. " from the Shadowforge Cache, and " .. yellow .. "[9]" .. white ..
        " off Grimlok. Note that when openning the Shadowforge Cache, a few mobs will spawn an aggro you. The Shattered Necklace Power Source drops from Archaedas " .. yellow .. "[10]" .. white .. ".",
...
kQuestInstanceData.BlackrockDepths.Alliance[11] = {
    ...
    Location = "Marshal Windsor (Blackrock Depths " .. yellow .. "[4]" .. white .. ")",
    Note = "This is part of the Onyxia attunement questline. Marshal Windsor is at " .. yellow .. "[4]" .. white .. ".\nThe quest is easier if you clean the Ring of Law (" .. yellow .. "[6]" .. white .. ") and the path to the entrance before you start the event. You find Marshal Maxwell at Burning Steppes - Morgan's Vigil (" ..
        yellow .. "84,68" .. white .. ")",
...
kQuestInstanceData.BlackrockDepths.Horde[7] = {
    ...
    Location = "Sign Post (Badlands - Kargath " .. yellow .. "3,47" .. white .. ")",
    Note = "You find the dwarves near Bael'Gar " .. yellow .. "[11]" .. white .. ". You find Warlord Goretooth in Kargath at the top of the tower (Badlands, " .. yellow .. "5,47" .. white .. ").\n The followup quest starts at Lexlort (Badlands - Kargath " .. yellow .. "5,47" ..
        white .. "). You find Grark Lorkrub in the Burning Steppes (" .. yellow .. "38,35" .. white .. "). You have to reduce his life below 50% to bind him and start a Escort quest.",
...
kQuestInstanceData.BlackrockDepths.Horde[13] = {
    ...
    Note = "You get the prequest from Thunderheart (Badlands - Kargath " .. yellow .. "3,48" .. white .. ").\nYou find Commander Gor'shak at " .. yellow .. "[3]" .. white .. ". The key to open the prison drops from High Interrogator Gerstahn " ..
...
kQuestInstanceData.BlackfathomDeeps.Horde[4] = {
    ...
    Location = "Argent guard Thaelrid (Blackfathom Deeps " .. yellow .. "[4]" .. white .. ")",
    Note = "Twilight Lord Kelris is at " .. yellow .. "[8]" .. white .. ". You find Bashana Runetotem in Thunder Bluff - The Elder Rise (" .. yellow .. "70,33" .. white .. "). \n\nATTENTION! If you turn on the flames beside Lord Kelris, enemies appear and attack you.",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[6] = {
    ...
    Note = "To get Warosh's Mojo you have to evoke and kill Urok Doomhowl " .. yellow .. "[15]" .. white .. ". For his Evocation you need a Spear and Highlord Omokk's Head " .. yellow .. "[5]" .. white .. ". The Spear is at " .. yellow .. "[3]" ..
        white .. ". During the Evocation a few waves of ogres appear before Urok Doomhowl attacks you. You can use the Spear during the fight to damage the ogres.",
    Rewards = {
        Text = "Reward:",
...
kQuestInstanceData.BlackrockSpireLower.Alliance[8] = {
    ...
    Note = "You find War Master Voone at " .. yellow .. "[9]" .. white .. ", Highlord Omokk at " .. yellow .. "[5]" ..
...
kQuestInstanceData.BlackrockSpireLower.Alliance[9] = {
    ...
    Note = "You get the Gemstone of Spirestone from Highlord Omokk at " .. yellow .. "[5]" .. white .. ", the Gemstone of Smolderthorn from War Master Voone at " .. yellow .. "[9]" .. white .. " and the Gemstone of Bloodaxe from Overlord Wyrmthalak at " .. yellow .. "[19]" ..
        white .. ". The Unadorned Seal of Ascension can drop from near all enemys in Lower Blackrock Spire. You get the Key for Upper Blackrock Spire if you complete this questline.",
...
kQuestInstanceData.BlackrockSpireLower.Horde[10] = {
    ...
    Note = "Onyxia Prequest.\nYou find Highlord Omokk at " .. yellow .. "[5]" .. white .. ", War Master Voone at " .. yellow .. "[9]" .. white .. " and Overlord Wyrmthalak at " ..
...
kQuestInstanceData.DireMaulEast.Alliance[1] = {
    ...
    Note = "Pusillin is in Dire Maul " .. yellow .. "East" .. white .. " at " .. yellow .. "[1]" .. white .. ". He runs when you talk to him, but stops and fights at " ..
...
kQuestInstanceData.DireMaulEast.Alliance[3] = {
    ...
    Note = "You find Alliz the Wildshaper in the " .. yellow .. "East" .. white .. " part of Dire Maul at " .. yellow .. "[5]" .. white ..
        ". The relict is in Silithius at " .. yellow .. "62,54" .. white .. ". The prequest comes from Rabine Saturna as well.",
...
kQuestInstanceData.DireMaulWest.Alliance[2] = {
    ...
    Note = "The Pylons are marked as " .. blue .. "[B]" .. white .. ". Immol'thar is at " ..
...
kQuestInstanceData.DireMaulWest.Alliance[21] = {
    ...
    Level = 60,
    Attain = 58,
    Aim = "Gather a Binding Fragment from Cliff Breakers in " .. yellow .. "[Azshara]" .. white .. ", Overloaded Arcane Prism from Arcane Torrents in " .. yellow .. "[Dire Maul West]" .. white .. ", Slumberer's Shard from Weaver in the " .. yellow .. "[Sunken Temple]" ..
...
kQuestInstanceData.Maraudon.Alliance[5] = {
    ...
    Note = "You find Cavindra at the beginning of the orange part before you enter the instance.\nYou get the Celebrian Rod from Noxxion at " .. yellow .. "[2]" .. white .. ", the Celebrian Diamond from Lord Vyletongue at " .. yellow .. "[5]" .. white .. ". Celebras is at " .. yellow ..
...
kQuestInstanceData.MoltenCore.Alliance[2] = {
    ...
    Location = "Duke Hydraxis (Azshara " .. yellow .. "79,73" .. white .. ")",
    Note = "Lucifron is at " .. yellow .. "[2]" .. white ..
...
kQuestInstanceData.MoltenCore.Alliance[3] = {
    ...
    Note = "Part of the Thunderfury, Blessed Blade of the Windseeker questline. It starts after obtaining either the left or right Bindings of the Windseeker from Garr at " .. yellow .. "[4]" .. white .. " or Baron Geddon at " .. yellow .. "[6]" .. white .. ". Then talk to Highlord Demitrian to start the questline. Essence of the Firelord drops from Ragnaros at " .. yellow .. "[10]" ..
        white .. ". After turning this part in, Prince Thunderaan is summoned and you must kill him. He's a 40-man raid boss.",
...
kQuestInstanceData.RazorfenKraul.Horde[6] = {
    ...
    Level = 30,
    Attain = 20,
    Aim = "Destroy the living embodiment of natural corruption within the depths of Razorfen Kraul, and bring the Tainted Brambleheart to Kym Wildmane in Thunder Bluff.",
...
kQuestInstanceData.ScarletMonasteryLibrary.Horde[2] = {
    ...
    Location = "Varimathras (Undercity - Royal Quarter " .. yellow .. "56,92" .. white .. ")",
    Note = "You can find High Inquisitor Whitemane and Scarlet Commander Mograine at " .. yellow .. "SM: Cathedral [2]" .. white .. ", Herod at " .. yellow ..
        "SM: Armory [1]" .. white .. " and Houndmaster Loksey at " .. yellow .. "SM: Library [1]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.Scholomance.Alliance[7] = {
    ...
    Note = "You can find The Deed to Caer Darrow at " .. yellow .. "[12]" .. white .. ", The Deed to Brill at " .. yellow .. "[7]" .. white .. ", The Deed to Tarren Mill at " .. yellow ..
...
kQuestInstanceData.Stratholme.Alliance[7] = {
    ...
    Location = "Leonid Barthalomew the Revered (Eastern Plaguelands - Light's Hope Chapel " .. yellow .. "80,58" .. white .. ")",
    Note = "You get the prequest from Magistrate Marduke (Western Plaguelands - Caer Darrow " .. yellow .. "70,73" .. white .. "). You find the sign near " ..
        yellow .. "[19]" .. white .. ". See also: " .. yellow .. "[The Lich, Ras Frostwhisper]" .. white .. " in Scholomance.",
...
kQuestInstanceData.TheRuinsofAhnQiraj.Alliance[2] = {
    ...
    Note = "Venoxis's Venom Sac drops from High priest Venoxis in " .. yellow .. "Zul'Gurub" .. white .. ". Kurinnaxx's Venom Sac drops in the " .. yellow .. "Ruins of Ahn'Qiraj" .. white ..
        " at " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
...
kQuestInstanceData.TheSunkenTemple.Alliance[7] = {
    ...
    Note = "You find the Essence Font next to where Shade of Eranikus is at " .. yellow .. "[6]" .. white .. ".\n" .. red .. "Don't" .. white .. " sell or throw away reward trinket Chained Essence of Eranikus. You will need it for next quest at Itharius (Swamp and Sorrows - Itharius's Cave " ..
...
kQuestInstanceData.TheSunkenTemple.Alliance[18] = {
    ...
    Note = "Weaver " .. yellow .. "[6]" .. white .. " 1 of 4 dragons drop Slumberer's Shard, will appear after killing Jammal'an the Prophet " .. yellow .. "[4]" .. white .. ". Barrier to the Prophet will disappear after clearing 6 balcons " .. blue .. "[C]" ..
        white .. "\nFinishing this questline you get the necklace and you will be able to enter Hyjal raid instance Emerald Sanctum.",
    Prequest = "Into the Dream I -> Into the Dream II",
...
kQuestInstanceData.ZulGurub.Alliance[4] = {
    ...
    Aim = "Dirk Thunderwood at Cenarion Hold wants you to bring him Venoxis's Venom Sac and Kurinnaxx's Venom Sac.",
    Location = "Dirk Thunderwood (Silithus - Cenarion Hold " .. yellow .. "52,39" .. white .. ")",
    Note = "Venoxis's Venom Sac drops from High priest Venoxis in " .. yellow .. "Zul'Gurub" .. white .. " at " .. yellow .. "[2]" .. white ..
        ". Kurinnaxx's Venom Sac drops in the " .. yellow .. "Ruins of Ahn'Qiraj" .. white .. " at " .. yellow .. "[1]" .. white .. ".",
    Rewards = {
        Text = "Reward: Pick One",
        { id = 22378 }, --Ravenholdt Slicer One-Hand, Sword
        { id = 22379 }, --Shivsprocket's Shiv Main Hand, Dagger
...
kQuestInstanceData.Gnomeregan.Alliance[6] = {
    ...
    Note = "You get the prequest from Gaxim Rustfizzle (Stonetalon Mountains " .. yellow .. "59,67" .. white .. "). The prequest is only a pointer quest and is not required to get this quest.\nThe white card is a random drop. You find the first terminal next to the back entrance before you enter the instance at " .. yellow .. "[3] on Entrance Map" .. white .. ". The 3005-B is at " .. yellow .. "[3]" ..
        white .. ", the 3005-C at " .. yellow .. "[5]" .. white .. " and the 3005-D is at " .. yellow .. "[6]" .. white .. ".",
...
kQuestInstanceData.Clackora = {
    Story = "Cla'ckora is an ancient, terror-inducing crustacean that has haunted the shifting tides of the Great Sea since the world was young. Woken from a centuries-long slumber by the encroaching Naga, this behemoth now guards the submerged ruins with crushing claws and a shell as hard as enchanted adamant. Those who venture too deep find not just a beast, but a living relic of the ocean's primal fury.",
    Caption = "Cla'ckora",
    Alliance = {},
    Horde = {}
}
...
kQuestInstanceData.CavernsOfTimeBlackMorass = {
    Story = "In the Caverns of Time, in Tanaris, the Dark Portal re-enacts the history of its first opening. The Bronze Dragons, guardians of time, need your help to maintain the stability of the timeline and crush the conspiracy of the fallen.",
...
kQuestInstanceData.Ostarius = {
    Story = "Ostarius stands as a colossal titanic watcher, a silent sentinel forged from celestial stone and imbued with the raw essence of the stars. Tasked with guarding the most sacred vaults of Uldum, he has stood motionless for eons, his cosmic consciousness linked to the world-shaping machinery of the Pantheon. Unlike those corrupted by the Old Gods, Ostarius remains a relentless executor of Titan logic, ready to incinerate any 'organic anomalies' that threaten the sanctity of his ancient charge.",
    Caption = "Ostarius",
    Alliance = {},
    Horde = {}
}
...
kQuestInstanceData.TowerofKarazhan.Alliance[1] = {
    ...
    Note = "Obsidian Rod " .. yellow .. "Lower Karazhan Halls [e]." .. white .. " Cosmic Residue drop from " .. yellow .. "[3]." .. white .. "\nThe Binding of Xanthar prequest start at the Hanvar the Righteous (Deadwind Pass - Morgan's Plot " .. yellow ..
        "40.9, 79.3" .. white .. "), Wine for Kyleson prequest start at the The Cook " .. yellow .. "(Lower Karazhan Halls [e])",
