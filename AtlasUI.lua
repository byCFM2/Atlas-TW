...
do
    ...
    damageTypeText:SetPoint("TOPLEFT", zoneText, "TOPLEFT", 0, -66)
    ...
    entrance1Text:SetPoint("TOPLEFT", zoneText, "TOPLEFT", 190, -19)
    ...
    entrance2Text:SetPoint("TOPLEFT", zoneText, "TOPLEFT", 190, -30)
    ...
    entrance3Text:SetPoint("TOPLEFT", zoneText, "TOPLEFT", 190, -42)
    ...
    entrance4Text:SetPoint("TOPLEFT", zoneText, "TOPLEFT", 190, -54)
    ...
    entrance5Text:SetPoint("TOPLEFT", zoneText, "TOPLEFT", 190, -66)
